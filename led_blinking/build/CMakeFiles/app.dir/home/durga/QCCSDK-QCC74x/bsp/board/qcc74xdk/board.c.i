# 1 "/home/durga/QCCSDK-QCC74x/bsp/board/qcc74xdk/board.c"
# 1 "/home/durga/QCCSDK-QCC74x/examples/peripherals/gpio/gpio_input_output/build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/durga/QCCSDK-QCC74x/bsp/board/qcc74xdk/board.c"
# 9 "/home/durga/QCCSDK-QCC74x/bsp/board/qcc74xdk/board.c"
...
# 10 "/home/durga/QCCSDK-QCC74x/bsp/board/qcc74xdk/board.c" 2
...
# 12 "/home/durga/QCCSDK-QCC74x/bsp/board/qcc74xdk/board.c" 2
...
# 13 "/home/durga/QCCSDK-QCC74x/bsp/board/qcc74xdk/board.c" 2
...
# 14 "/home/durga/QCCSDK-QCC74x/bsp/board/qcc74xdk/board.c" 2
...
# 15 "/home/durga/QCCSDK-QCC74x/bsp/board/qcc74xdk/board.c" 2
...
# 16 "/home/durga/QCCSDK-QCC74x/bsp/board/qcc74xdk/board.c" 2
...
# 17 "/home/durga/QCCSDK-QCC74x/bsp/board/qcc74xdk/board.c" 2
# 1 "/home/durga/QCCSDK-QCC74x/bsp/board/qcc74xdk/board.h" 1
...
# 18 "/home/durga/QCCSDK-QCC74x/bsp/board/qcc74xdk/board.c" 2
...
# 5 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/include/hardware/tzc_sec_reg.h" 2
...
# 6 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/include/qcc743_tzc_sec.h" 2
...
# 19 "/home/durga/QCCSDK-QCC74x/bsp/board/qcc74xdk/board.c" 2
...
# 21 "/home/durga/QCCSDK-QCC74x/bsp/board/qcc74xdk/board.c" 2

# 1 "/home/durga/QCCSDK-QCC74x/bsp/board/qcc74xdk/board_flash_psram.h" 1
# 11 "/home/durga/QCCSDK-QCC74x/bsp/board/qcc74xdk/board_flash_psram.h"
uint32_t board_psram_x8_init(void);
# 23 "/home/durga/QCCSDK-QCC74x/bsp/board/qcc74xdk/board.c" 2
# 1 "/home/durga/QCCSDK-QCC74x/drivers/sys/qcc743/qcc743_sys.h" 1
...
# 24 "/home/durga/QCCSDK-QCC74x/bsp/board/qcc74xdk/board.c" 2

# 1 "/home/durga/QCCSDK-QCC74x/components/mm/./mem.h" 1
# 28 "/home/durga/QCCSDK-QCC74x/components/mm/./mem.h"
# 1 "/usr/bin/linux_x86_64/lib/gcc/riscv64-unknown-elf/10.4.0/include/stddef.h" 1 3 4
# 29 "/home/durga/QCCSDK-QCC74x/components/mm/./mem.h" 2
# 81 "/home/durga/QCCSDK-QCC74x/components/mm/./mem.h"
struct mem_heap_s {
    void *priv;
    void *heapstart;
    size_t heapsize;
...
# 101 "/home/durga/QCCSDK-QCC74x/components/mm/./mem.h"
...
# 130 "/home/durga/QCCSDK-QCC74x/components/mm/./mem.h"
void *kmalloc(size_t size, int flag);
# 145 "/home/durga/QCCSDK-QCC74x/components/mm/./mem.h"
void *kcalloc(size_t size, size_t len);
# 156 "/home/durga/QCCSDK-QCC74x/components/mm/./mem.h"
void kfree(void *addr);
# 165 "/home/durga/QCCSDK-QCC74x/components/mm/./mem.h"
...
# 26 "/home/durga/QCCSDK-QCC74x/bsp/board/qcc74xdk/board.c" 2
...
static void __attribute__((section(".sclock_rlt_code." "./bsp/board/qcc74xdk/board.c" "53"))) __attribute__((noinline)) system_clock_init(void)
{


    GLB_Power_On_XTAL_And_PLL_CLK((4), (1) | (2));
...
# 102 "/home/durga/QCCSDK-QCC74x/bsp/board/qcc74xdk/board.c"
static void peripheral_clock_init(void)
{
    do { volatile uint32_t regval = (*(volatile uint32_t *)(uintptr_t)((0x20000000 + 0x584))); regval |= (1 << 2); (*(volatile uint32_t *)(uintptr_t)((0x20000000 + 0x584)) = (regval)); } while (0);
    do { volatile uint32_t regval = (*(volatile uint32_t *)(uintptr_t)((0x20000000 + 0x584))); regval |= (1 << 3); regval |= (1 << 4); (*(volatile uint32_t *)(uintptr_t)((0x20000000 + 0x584)) = (regval)); } while (0);
    do { volatile uint32_t regval = (*(volatile uint32_t *)(uintptr_t)((0x20000000 + 0x584))); regval |= (1 << 12); (*(volatile uint32_t *)(uintptr_t)((0x20000000 + 0x584)) = (regval)); } while (0);
    do { volatile uint32_t regval = (*(volatile uint32_t *)(uintptr_t)((0x20000000 + 0x584))); regval |= (1 << 16); (*(volatile uint32_t *)(uintptr_t)((0x20000000 + 0x584)) = (regval)); } while (0);
    do { volatile uint32_t regval = (*(volatile uint32_t *)(uintptr_t)((0x20000000 + 0x584))); regval |= (1 << 17); (*(volatile uint32_t *)(uintptr_t)((0x20000000 + 0x584)) = (regval)); } while (0);
    do { volatile uint32_t regval = (*(volatile uint32_t *)(uintptr_t)((0x20000000 + 0x584))); regval |= (1 << 18); (*(volatile uint32_t *)(uintptr_t)((0x20000000 + 0x584)) = (regval)); } while (0);
    do { volatile uint32_t regval = (*(volatile uint32_t *)(uintptr_t)((0x20000000 + 0x584))); regval |= (1 << 19); (*(volatile uint32_t *)(uintptr_t)((0x20000000 + 0x584)) = (regval)); } while (0);
    do { volatile uint32_t regval = (*(volatile uint32_t *)(uintptr_t)((0x20000000 + 0x584))); regval |= (1 << 20); (*(volatile uint32_t *)(uintptr_t)((0x20000000 + 0x584)) = (regval)); } while (0);
    do { volatile uint32_t regval = (*(volatile uint32_t *)(uintptr_t)((0x20000000 + 0x584))); regval |= (1 << 21); (*(volatile uint32_t *)(uintptr_t)((0x20000000 + 0x584)) = (regval)); } while (0);
    do { volatile uint32_t regval = (*(volatile uint32_t *)(uintptr_t)((0x20000000 + 0x584))); regval |= (1 << 22); (*(volatile uint32_t *)(uintptr_t)((0x20000000 + 0x584)) = (regval)); } while (0);
    do { volatile uint32_t regval = (*(volatile uint32_t *)(uintptr_t)((0x20000000 + 0x584))); regval |= (1 << 27); (*(volatile uint32_t *)(uintptr_t)((0x20000000 + 0x584)) = (regval)); } while (0);
    do { volatile uint32_t regval = (*(volatile uint32_t *)(uintptr_t)((0x20000000 + 0x584))); regval |= (1 << 13); (*(volatile uint32_t *)(uintptr_t)((0x20000000 + 0x584)) = (regval)); } while (0);
    do { volatile uint32_t regval = (*(volatile uint32_t *)(uintptr_t)((0x20000000 + 0x584))); regval |= (1 << 26); (*(volatile uint32_t *)(uintptr_t)((0x20000000 + 0x584)) = (regval)); } while (0);
    do { volatile uint32_t regval = (*(volatile uint32_t *)(uintptr_t)((0x20000000 + 0x588))); regval |= (1 << 21); (*(volatile uint32_t *)(uintptr_t)((0x20000000 + 0x588)) = (regval)); } while (0);
    do { volatile uint32_t regval = (*(volatile uint32_t *)(uintptr_t)((0x20000000 + 0x584))); regval |= (1 << 23); (*(volatile uint32_t *)(uintptr_t)((0x20000000 + 0x584)) = (regval)); } while (0);

    GLB_Set_UART_CLK(ENABLE, (2), 0);
    GLB_Set_SPI_CLK(ENABLE, (0), 0);
    GLB_Set_DBI_CLK(ENABLE, (0), 0);
    GLB_Set_I2C_CLK(ENABLE, (1), 0);
    GLB_Set_ADC_CLK(ENABLE, (1), 1);
    GLB_Set_DIG_CLK_Sel((1));
    GLB_Set_DIG_512K_CLK(ENABLE, ENABLE, 0x4E);
    GLB_Set_PWM1_IO_Sel((0));
    GLB_Set_IR_CLK(ENABLE, (0), 19);
    GLB_Set_CAM_CLK(ENABLE, (1), 3);

    GLB_Set_PKA_CLK_Sel((1));
...
# 262 "/home/durga/QCCSDK-QCC74x/bsp/board/qcc74xdk/board.c"
void qcc74x_show_log(void)
{
    printf("\r\n");
    printf("\r\n");
    printf("Build:%s,%s\r\n", "12:19:36", "Jan 26 2026");
}
...
const char* qcc74x_sys_version(const char ***ctx)
{
    ...
    if (
# 278 "/home/durga/QCCSDK-QCC74x/bsp/board/qcc74xdk/board.c" 3 4
       ((void *)0) 
# 278 "/home/durga/QCCSDK-QCC74x/bsp/board/qcc74xdk/board.c"
            == (*ctx)) {
    ...
    if (version_section_end == (*ctx)) {
        return 
# 283 "/home/durga/QCCSDK-QCC74x/bsp/board/qcc74xdk/board.c" 3 4
              ((void *)0)
# 283 "/home/durga/QCCSDK-QCC74x/bsp/board/qcc74xdk/board.c"
                  ;
    }
    version_str = (**ctx);
    *ctx = (*ctx) + 1;
...
{
    const char **ctx = 
# 292 "/home/durga/QCCSDK-QCC74x/bsp/board/qcc74xdk/board.c" 3 4
                      ((void *)0)
# 292 "/home/durga/QCCSDK-QCC74x/bsp/board/qcc74xdk/board.c"
                          ;
    const char *version_str;
...
static void console_init()
{
    ...
    qcc74x_gpio_uart_init(gpio, 21, 2);
    qcc74x_gpio_uart_init(gpio, 22, 3);
...
# 365 "/home/durga/QCCSDK-QCC74x/bsp/board/qcc74xdk/board.c"
void board_init(void)
{
    int ret = -1;
    uintptr_t flag;
...
# 419 "/home/durga/QCCSDK-QCC74x/bsp/board/qcc74xdk/board.c"
    ...
    printf("uart  sig1:%08x, sig2:%08x\r\n", (*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x20000000) + (0x154))), (*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x20000000) + (0x158))));
    printf("clock gen1:%08x, gen2:%08x\r\n", (*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x20000000) + (0x584))), (*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x20000000) + (0x588))));

    HBN_Get_Xtal_Value(&xtal_value);
    printf("xtal:%dHz(%s)\r\n", xtal_value, (((*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x2000f000) + (0x884))) >> 3) & 0x01) ? "oscillator" : "crystal");

    log_start();
# 452 "/home/durga/QCCSDK-QCC74x/bsp/board/qcc74xdk/board.c"
    qcc74x_irq_restore(flag);

    printf("board init done\r\n");
    printf("===========================\r\n");
}
# 777 "/home/durga/QCCSDK-QCC74x/bsp/board/qcc74xdk/board.c"
int board_device_info_version()
{
