# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/arch/risc-v/t-head/rv_hart.c"
...
# 15 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/arch/risc-v/t-head/Core/Include/csi_core.h"
...
# 16 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/arch/risc-v/t-head/Core/Include/csi_core.h" 2
...
# 2 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/arch/risc-v/t-head/rv_hart.c" 2
...
# 3 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/arch/risc-v/t-head/rv_hart.c" 2
# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/arch/risc-v/csr.h" 1
# 4 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/arch/risc-v/t-head/rv_hart.c" 2
# 13 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/arch/risc-v/t-head/rv_hart.c"
void __attribute__((noreturn)) rv_hart_hang(void)
{
    while (1) {
        __WFI();
...
int rv_hart_misa_ext_chk(char ext)
{
    unsigned long misa = ({ unsigned long tmp; asm volatile("csrr %0, " "misa" : "=r"(tmp)); tmp; });
                           ...
                           uintptr_t next_addr, uintptr_t next_mode)
{
    ...
    val = ({ unsigned long tmp; asm volatile("csrr %0, " "mstatus" : "=r"(tmp)); tmp; });
    val = (((val) & ~((0x3 << 11))) | ((next_mode) * (((0x3 << 11)) & ~(((0x3 << 11))-1))));
    val = (((val) & ~((0x1 << 7))) | ((0) * (((0x1 << 7)) & ~(((0x1 << 7))-1))));

    ({ asm volatile("csrw " "mstatus" ", %0" :: "rK"(val)); });
    ({ asm volatile("csrw " "mepc" ", %0" :: "rK"(next_addr)); });

    if (next_mode == 1) {
        ({ asm volatile("csrw " "stvec" ", %0" :: "rK"(next_addr)); });
        ({ asm volatile("csrw " "sscratch" ", %0" :: "rK"(0)); });
        ({ asm volatile("csrw " "sie" ", %0" :: "rK"(0)); });
        ({ asm volatile("csrw " "satp" ", %0" :: "rK"(0)); });
    } else if (next_mode == 0) {
