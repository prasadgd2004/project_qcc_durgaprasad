# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_i2s.c"
# 1 "/home/durga/QCCSDK-QCC74x/examples/peripherals/gpio/gpio_input_output/build/build_out/drivers/lhal//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_i2s.c"
# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_i2s.h" 1
...
# 5 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_i2s.h" 2
# 125 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_i2s.h"
struct qcc74x_i2s_config_s {
...
# 148 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_i2s.h"
void qcc74x_i2s_init(struct qcc74x_device_s *dev, const struct qcc74x_i2s_config_s *config);
...
void qcc74x_i2s_deinit(struct qcc74x_device_s *dev);
...
void qcc74x_i2s_link_txdma(struct qcc74x_device_s *dev, 
# 163 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_i2s.h" 3 4
                                                       _Bool 
# 163 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_i2s.h"
                                                            enable);
...
void qcc74x_i2s_link_rxdma(struct qcc74x_device_s *dev, 
# 171 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_i2s.h" 3 4
                                                       _Bool 
# 171 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_i2s.h"
                                                            enable);
...
void qcc74x_i2s_txint_mask(struct qcc74x_device_s *dev, 
# 179 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_i2s.h" 3 4
                                                       _Bool 
# 179 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_i2s.h"
                                                            mask);
...
void qcc74x_i2s_rxint_mask(struct qcc74x_device_s *dev, 
# 187 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_i2s.h" 3 4
                                                       _Bool 
# 187 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_i2s.h"
                                                            mask);
...
void qcc74x_i2s_errint_mask(struct qcc74x_device_s *dev, 
# 195 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_i2s.h" 3 4
                                                        _Bool 
# 195 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_i2s.h"
                                                             mask);
...
uint32_t qcc74x_i2s_get_intstatus(struct qcc74x_device_s *dev);
# 213 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_i2s.h"
int qcc74x_i2s_feature_control(struct qcc74x_device_s *dev, int cmd, size_t arg);
# 2 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_i2s.c" 2
...
# 3 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_i2s.c" 2
# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/hardware/i2s_reg.h" 1
# 4 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_i2s.c" 2
...
void qcc74x_i2s_init(struct qcc74x_device_s *dev, const struct qcc74x_i2s_config_s *config)
{
    ...
    if (config->channel_mode == 0) {
        ...
        regval &= ~(1 << 4U);
        regval &= ~(0x3 << (7U));
        regval |= (config->channel_mode - 1) << (7U);
    }


    regval &= ~(1 << 5U);

    if (config->format_mode == 2) {
    ...
    regval &= ~(0x3 << (12U));
    regval &= ~(0x3 << (14U));
    regval |= config->frame_width << (12U);
    regval |= config->data_width << (14U);

    if (config->format_mode == 0) {

        regval &= ~(0x3 << (16U));
    } else if (config->format_mode == 1) {
    ...
    if (config->fs_offset_cycle) {
        regval |= (1 << 25U);
        regval &= ~(0x1f << (20U));
        regval |= ((config->fs_offset_cycle - 1) << (20U)) & (0x1f << (20U));
    } else {
        regval &= ~(1 << 25U);
    }
    ...
    div = (qcc74x_clk_get_peripheral_clock(9, dev->idx) / 2 * 10 / config->bclk_freq_hz + 5) / 10;
    div = (div) ? (div - 1) : 0;
    ...
    regval &= ~(0xf << (16U));
    regval &= ~(0xf << (24U));
    regval |= (config->tx_fifo_threshold << (16U)) & (0xf << (16U));
    regval |= (config->tx_fifo_threshold << (24U)) & (0xf << (24U));
    ...
    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0xFC)));
    ...
    regval &= ~(1 << 1U);
    regval &= ~(1 << 0U);
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0xFC)) = (regval));
...
void qcc74x_i2s_link_txdma(struct qcc74x_device_s *dev, 
# 164 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_i2s.c" 3 4
                                                       _Bool 
# 164 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_i2s.c"
                                                            enable)
{
...
void qcc74x_i2s_link_rxdma(struct qcc74x_device_s *dev, 
# 183 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_i2s.c" 3 4
                                                       _Bool 
# 183 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_i2s.c"
                                                            enable)
{
...
void qcc74x_i2s_txint_mask(struct qcc74x_device_s *dev, 
# 202 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_i2s.c" 3 4
                                                       _Bool 
# 202 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_i2s.c"
                                                            mask)
{
...
void qcc74x_i2s_rxint_mask(struct qcc74x_device_s *dev, 
# 220 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_i2s.c" 3 4
                                                       _Bool 
# 220 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_i2s.c"
                                                            mask)
{
...
void qcc74x_i2s_errint_mask(struct qcc74x_device_s *dev, 
# 238 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_i2s.c" 3 4
                                                        _Bool 
# 238 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_i2s.c"
                                                             mask)
{
...
int qcc74x_i2s_feature_control(struct qcc74x_device_s *dev, int cmd, size_t arg)
{
    ...
    switch (cmd) {
        ...
        case (0x03):
            ...
            regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x84)));
            ret = (regval & (0x1f << (0U))) >> (0U);
            break;

        case (0x04):

            regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x84)));
            ret = (regval & (0x1f << (8U))) >> (8U);
            break;
        ...
        default:
            ret = -
# 393 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_i2s.c" 3
                  1
# 393 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_i2s.c"
                       ;
            break;
    }
