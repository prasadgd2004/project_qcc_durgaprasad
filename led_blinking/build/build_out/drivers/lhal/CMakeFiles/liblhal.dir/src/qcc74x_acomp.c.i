# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_acomp.c"
...
# 5 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_acomp.h" 2
...
# 2 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_acomp.c" 2
# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_core.h" 1
# 3 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_acomp.c" 2
...
# 4 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_acomp.c" 2
# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/hardware/acomp_reg.h" 1
# 5 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_acomp.c" 2
# 14 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_acomp.c"
void qcc74x_acomp_init(uint8_t acomp_id, const struct qcc74x_acomp_config_s *config)
{
    ...
    if (0 == acomp_id) {
        reg_base = ((uint32_t)0x2000f000) + (0x900);
    } else {
        reg_base = ((uint32_t)0x2000f000) + (0x904);
    }


    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base));
    regval &= ~(1 << 0U);
    ...
    regval &= ~(0xf << (22U));
    regval |= (config->pos_chan_sel << (22U));
    regval &= ~(0xf << (18U));
    regval |= (config->neg_chan_sel << (18U));
    regval &= ~(0x3f << (12U));
    regval |= (config->scaling_factor << (12U));
    regval &= ~(0x3 << (10U));
    regval |= (config->bias_prog << (10U));
    regval &= ~(0x7 << (7U));
    regval |= (config->hysteresis_pos_volt << (7U));
    regval &= ~(0x7 << (4U));
    regval |= (config->hysteresis_neg_volt << (4U));
    (*(volatile uint32_t *)(uintptr_t)(reg_base) = (regval));

    reg_base = ((uint32_t)0x2000f000) + (0x908);
    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base));
    regval &= ~(0x3f << (24U));
    regval |= (config->vio_sel << (24U));
    (*(volatile uint32_t *)(uintptr_t)(reg_base) = (regval));
...
uint32_t qcc74x_acomp_get_result(uint8_t acomp_id)
{
    ...
    if (0 == acomp_id) {
        return (regval & (0x1 << (19U))) >> (19U);
    } else {
        return (regval & (0x1 << (17U))) >> (17U);
    }
...
uint32_t qcc74x_acomp_get_postive_input(uint8_t acomp_id)
{
    ...
    return (regval & (0xf << (22U))) >> (22U);
}

int qcc74x_acomp_gpio_2_chanid(uint32_t pin, uint32_t *channel)
{
# 203 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_acomp.c"
    if (pin == 20) {
        *channel = 0;
    } else if (pin == 19) {
        *channel = 1;
...
# 245 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_acomp.c"
    return 0;
...
int qcc74x_acomp_chanid_2_gpio(uint32_t channel, uint32_t *pin)
{
# 315 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_acomp.c"
    if (channel == 0) {
        *pin = 20;
    } else if (channel == 1) {
        *pin = 19;
...
# 357 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_acomp.c"
    return 0;
