# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_dac.c"
# 1 "/home/durga/QCCSDK-QCC74x/examples/peripherals/gpio/gpio_input_output/build/build_out/drivers/lhal//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_dac.c"
# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_dac.h" 1
...
# 5 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_dac.h" 2
# 84 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_dac.h"
...
void qcc74x_dac_link_txdma(struct qcc74x_device_s *dev, 
# 99 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_dac.h" 3 4
                                                       _Bool 
# 99 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_dac.h"
                                                            enable);
...
# 132 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_dac.h"
void qcc74x_dac_set_value(struct qcc74x_device_s *dev, uint8_t ch, uint16_t value);
# 2 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_dac.c" 2
# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/hardware/dac_reg.h" 1
# 3 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_dac.c" 2
...
void qcc74x_dac_init(struct qcc74x_device_s *dev, uint8_t clk_div)
{
    ...
    regval |= (clk_div << (8U));
    (*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x20002000) + (0x40)) = (regval));

    regval = (*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x20002000) + (0x44)));
    regval &= ~(1 << 0U);
    (*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x20002000) + (0x44)) = (regval));
...
void qcc74x_dac_link_txdma(struct qcc74x_device_s *dev, 
# 117 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_dac.c" 3 4
                                                       _Bool 
# 117 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_dac.c"
                                                            enable)
{
    ...
    regval1 = (*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x20002000) + (0x40)));
    regval1 &= ~(0xf << (16U));
    regval1 &= ~(0xf << (20U));

    regval2 = (*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x20002000) + (0x44)));
    regval2 &= ~(0x3 << (4U));
    if (enable) {
        if ((*(volatile uint32_t *)(uintptr_t)(reg_base + (0x124))) & ((1 << 0U) | (1 << 1U))) {
            regval1 |= (1 << (16U));
            flag++;
        }

        if ((*(volatile uint32_t *)(uintptr_t)(reg_base + (0x128))) & ((1 << 0U) | (1 << 1U))) {
            regval1 |= (1 << (20U));
            flag++;
        }
    ...
    (*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x20002000) + (0x44)) = (regval2));
    (*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x20002000) + (0x40)) = (regval1));
...
void qcc74x_dac_set_value(struct qcc74x_device_s *dev, uint8_t ch, uint16_t value)
{
    ...
    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x12C)));
    ...
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x12C)) = (regval));
