# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_spi.c"
...
# 5 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_spi.h" 2
...
# 2 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_spi.c" 2
...
# 3 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_spi.c" 2
# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/hardware/spi_reg.h" 1
# 4 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_spi.c" 2
...
void qcc74x_spi_init(struct qcc74x_device_s *dev, const struct qcc74x_spi_config_s *config)
{
    ...
    regval = (*(volatile uint32_t *)(uintptr_t)(0x20000510));
    if (config->role == 0) {
        regval |= 1 << 12;
    } else {
        regval &= ~(1 << 12);
    }
    (*(volatile uint32_t *)(uintptr_t)(0x20000510) = (regval));

    reg_base = dev->reg_base;

    div = (qcc74x_clk_get_peripheral_clock(6, dev->idx) / 2 * 10 / config->freq + 5) / 10;
    div = (div) ? (div - 1) : 0;
    ...
    if (config->byte_order == 0) {
        regval &= ~(1 << 7U);
    } else {
        regval |= (1 << 7U);
    }
    if (config->bit_order == 1) {
        regval |= (1 << 6U);
    } else {
        regval &= ~(1 << 6U);
    }
...
void qcc74x_spi_deinit(struct qcc74x_device_s *dev)
{
    ...
    regval = (*(volatile uint32_t *)(uintptr_t)(dev->reg_base + (0x0)));
    regval &= ~(1 << 1U);
    regval &= ~(1 << 0U);
    (*(volatile uint32_t *)(uintptr_t)(dev->reg_base + (0x0)) = (regval));

}

void qcc74x_spi_link_txdma(struct qcc74x_device_s *dev, 
# 159 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_spi.c" 3 4
                                                       _Bool 
# 159 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_spi.c"
                                                            enable)
{
...
void qcc74x_spi_link_rxdma(struct qcc74x_device_s *dev, 
# 178 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_spi.c" 3 4
                                                       _Bool 
# 178 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_spi.c"
                                                            enable)
{
...
__attribute__((section(".tcm_code." "./drivers/lhal/src/qcc74x_spi.c" "198"))) uint32_t qcc74x_spi_poll_send(struct qcc74x_device_s *dev, uint32_t data)
{
    ...
    uint32_t regval;
    uint8_t fifo_cnt;
# 235 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_spi.c"
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x88)) = (data));




    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x0)));
    uint8_t frame_size = ((regval & (0x3 << (2U))) >> (2U)) + 1;
    if (frame_size == 3) {
        frame_size = 4;
    }
    ...
    do {
        regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x84)));
        fifo_cnt = (regval & (0x3f << (8U))) >> (8U);
    } while (fifo_cnt < frame_size);
# 260 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_spi.c"
    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x8C)));
...
__attribute__((section(".tcm_code." "./drivers/lhal/src/qcc74x_spi.c" "267"))) int qcc74x_spi_poll_exchange(struct qcc74x_device_s *dev, const void *txbuffer, void *rxbuffer, size_t nbytes)
{
    ...
    nbytes /= frame_size;
    tx_cnt = nbytes;
# 315 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_spi.c"
    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x80)));
    regval |= (1 << 2U);
    regval |= (1 << 3U);
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x80)) = (regval));
    ...
    fifo_cnt = ((regval & (0x3f << (0U))) >> (0U)) / frame_size;
    ...
    tx_cnt -= fifo_cnt;
    if (txbuffer != 
# 331 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_spi.c" 3 4
                   ((void *)0)
# 331 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_spi.c"
                       ) {
        ...
        for (; fifo_cnt > 0; fifo_cnt--) {
            (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x88)) = (0xFFFFFFFF));
        }
    }
    ...
    for (; nbytes > 0;) {
        ...
        fifo_cnt = ((regval & (0x3f << (8U))) >> (8U)) / frame_size;
...
void qcc74x_spi_txint_mask(struct qcc74x_device_s *dev, 
# 438 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_spi.c" 3 4
                                                       _Bool 
# 438 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_spi.c"
                                                            mask)
{
...
void qcc74x_spi_rxint_mask(struct qcc74x_device_s *dev, 
# 456 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_spi.c" 3 4
                                                       _Bool 
# 456 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_spi.c"
                                                            mask)
{
...
void qcc74x_spi_tcint_mask(struct qcc74x_device_s *dev, 
# 474 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_spi.c" 3 4
                                                       _Bool 
# 474 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_spi.c"
                                                            mask)
{
...
void qcc74x_spi_errint_mask(struct qcc74x_device_s *dev, 
# 492 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_spi.c" 3 4
                                                        _Bool 
# 492 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_spi.c"
                                                             mask)
{
...
uint32_t qcc74x_spi_get_intstatus(struct qcc74x_device_s *dev)
{
    ...
    reg_base = dev->reg_base;
    int_status = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x4))) & 0x1f;
    int_mask = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x4))) >> 8 & 0x1f;
...
# 545 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_spi.c" 3 4
_Bool 
# 545 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_spi.c"
    qcc74x_spi_isbusy(struct qcc74x_device_s *dev)
{
    ...
    if ((regval & (0x3f << (0U))) >> (0U) < 32) {
        return 
# 559 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_spi.c" 3 4
              1
# 559 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_spi.c"
                  ;
    }
    ...
    if (regval) {
        return 
# 570 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_spi.c" 3 4
              1
# 570 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_spi.c"
                  ;
    }

    return 
# 573 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_spi.c" 3 4
          0
# 573 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_spi.c"
               ;
...
int qcc74x_spi_feature_control(struct qcc74x_device_s *dev, int cmd, size_t arg)
{
    ...
    switch (cmd) {
        ...
        case (0x09):
            ...
            div = (qcc74x_clk_get_peripheral_clock(6, dev->idx) / 2 * 10 / arg + 5) / 10;
            div = (div) ? (div - 1) : 0;
            div = (div > 0xff) ? 0xff : div;
        ...
        case (0x0A):
            ...
            div = (regval & (0xff << (16U))) >> (16U);
            div += (regval & (0xff << (24U))) >> (24U);

            ret = qcc74x_clk_get_peripheral_clock(6, dev->idx) / div;
            break;
        ...
        case (0x11):
            ...
            (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x0)) = (regval));
            break;
# 816 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_spi.c"
        case (0x17):
        ...
        default:
            ret = -
# 847 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_spi.c" 3
                  1
# 847 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_spi.c"
                       ;
            break;
    }
