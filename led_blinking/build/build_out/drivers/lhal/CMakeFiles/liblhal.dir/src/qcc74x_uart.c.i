# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_uart.c"
...
# 2 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_uart.c" 2
...
# 3 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_uart.c" 2
# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/hardware/uart_reg.h" 1
# 4 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_uart.c" 2
...
void qcc74x_uart_init(struct qcc74x_device_s *dev, const struct qcc74x_uart_config_s *config)
{
    ...
    div = (qcc74x_clk_get_peripheral_clock(5, dev->idx) * 10 / config->baudrate + 5) / 10;

    ((void)0U);

    tx_cfg = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x0)));
    rx_cfg = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x4)));
    tx_cfg &= ~(1 << 0U);
    rx_cfg &= ~(1 << 0U);
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x0)) = (tx_cfg));
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x4)) = (rx_cfg));

    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x8)) = (((div - 1) << 0x10) | ((div - 1) & 0xFFFF)));
    ...
    tx_cfg &= ~(0x7 << (8U));
    tx_cfg |= (config->data_bits + 4) << (8U);
    rx_cfg &= ~(0x7 << (8U));
    rx_cfg |= (config->data_bits + 4) << (8U);


    tx_cfg &= ~(0x3 << (11U));
    tx_cfg |= config->stop_bits << (11U);


    if (config->flow_ctrl & (1 << 1)) {
        tx_cfg |= (1 << 1U);
    } else {
        tx_cfg &= ~(1 << 1U);
    }
    ...
    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x1C)));
    regval &= ~(1 << 2U);
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x1C)) = (regval));

    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0xC)));



    regval &= ~(1 << 0U);
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0xC)) = (regval));
    ...
    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x84)));
    regval &= ~(0x1f << (16U));
    regval &= ~(0x1f << (24U));
    regval |= (config->tx_fifo_threshold << (16U)) & (0x1f << (16U));
    regval |= (config->rx_fifo_threshold << (24U)) & (0x1f << (24U));
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x84)) = (regval));


    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x80)));
    regval |= (1 << 2U);
    regval |= (1 << 3U);
    regval &= ~(1 << 0U);
    regval &= ~(1 << 1U);
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x80)) = (regval));

    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x24)) = (0xFFFFFFFF));
...
void qcc74x_uart_link_txdma(struct qcc74x_device_s *dev, 
# 198 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_uart.c" 3 4
                                                        _Bool 
# 198 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_uart.c"
                                                             enable)
{
...
void qcc74x_uart_link_rxdma(struct qcc74x_device_s *dev, 
# 217 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_uart.c" 3 4
                                                        _Bool 
# 217 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_uart.c"
                                                             enable)
{
...
__attribute__((section(".tcm_code." "./drivers/lhal/src/qcc74x_uart.c" "236"))) int qcc74x_uart_putchar(struct qcc74x_device_s *dev, int ch)
{
    ...
    while (((*(volatile uint32_t *)(uintptr_t)(reg_base + (0x84))) & (0x3f << (0U))) == 0) {
        if ((qcc74x_mtimer_get_time_ms() - start_time) > 100) {
            return -
# 248 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_uart.c" 3
                   116
# 248 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_uart.c"
                            ;
        }
    }
    (*(volatile uint8_t *)(uintptr_t)(reg_base + (0x88)) = (ch));
    return 0;

}

__attribute__((section(".tcm_code." "./drivers/lhal/src/qcc74x_uart.c" "256"))) int qcc74x_uart_getchar(struct qcc74x_device_s *dev)
{
    ...
    reg_base = dev->reg_base;
    if (((*(volatile uint32_t *)(uintptr_t)(reg_base + (0x84))) & (0x3f << (8U))) != 0) {
        ch = (*(volatile uint8_t *)(uintptr_t)(reg_base + (0x8C)));
    }
...
__attribute__((section(".tcm_code." "./drivers/lhal/src/qcc74x_uart.c" "273"))) int qcc74x_uart_put(struct qcc74x_device_s *dev, uint8_t *data, uint32_t len)
{
    ...
    for (uint32_t i = 0; i < len; i++) {
        ret = qcc74x_uart_putchar(dev, data[i]);
        if (ret < 0) {
            return ret;
        }
    }
...
__attribute__((section(".tcm_code." "./drivers/lhal/src/qcc74x_uart.c" "289"))) int qcc74x_uart_put_block(struct qcc74x_device_s *dev, uint8_t *data, uint32_t len)
{
    ...
    while ((*(volatile uint32_t *)(uintptr_t)(dev->reg_base + (0x30))) & (1 << 0U)) {
        timeoutCnt--;

        if (timeoutCnt == 0) {
            return -
# 306 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_uart.c" 3
                   116
# 306 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_uart.c"
                            ;
        }
    }
    return 0;
...
__attribute__((section(".tcm_code." "./drivers/lhal/src/qcc74x_uart.c" "313"))) int qcc74x_uart_get(struct qcc74x_device_s *dev, uint8_t *data, uint32_t len)
{
    ...
    while (count < len) {
        if ((ch = qcc74x_uart_getchar(dev)) < 0) {
            break;
        }
        data[count] = ch;
        count++;
...
int qcc74x_uart_wait_tx_done(struct qcc74x_device_s *dev)
{
    ...
    start_time = qcc74x_mtimer_get_time_ms();
    while (!qcc74x_uart_txempty(dev)) {
        if ((qcc74x_mtimer_get_time_ms() - start_time) > 1000) {
            return -
# 342 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_uart.c" 3
                   116
# 342 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_uart.c"
                            ;
        }
    }
    ...
    while ((*(volatile uint32_t *)(uintptr_t)(dev->reg_base + (0x30))) & (1 << 0U)) {
        if ((qcc74x_mtimer_get_time_ms() - start_time) > 1000) {
            return -
# 349 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_uart.c" 3
                   116
# 349 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_uart.c"
                            ;
        }
    }
    return 0;
...
# 356 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_uart.c" 3 4
_Bool 
# 356 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_uart.c"
    qcc74x_uart_txready(struct qcc74x_device_s *dev)
{
    ...
    reg_base = dev->reg_base;
    if (((*(volatile uint32_t *)(uintptr_t)(reg_base + (0x84))) & (0x3f << (0U))) != 0) {
        return 
# 365 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_uart.c" 3 4
              1
# 365 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_uart.c"
                  ;
    } else {
        return 
# 367 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_uart.c" 3 4
              0
# 367 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_uart.c"
                   ;
    }
...
# 372 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_uart.c" 3 4
_Bool 
# 372 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_uart.c"
    qcc74x_uart_txempty(struct qcc74x_device_s *dev)
{
    ...
    reg_base = dev->reg_base;
    if (((*(volatile uint32_t *)(uintptr_t)(reg_base + (0x84))) & (0x3f << (0U))) == ((0x3f << (0U)) >> 1) + 1) {
        return 
# 381 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_uart.c" 3 4
              1
# 381 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_uart.c"
                  ;
    } else {
        return 
# 383 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_uart.c" 3 4
              0
# 383 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_uart.c"
                   ;
    }
...
# 388 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_uart.c" 3 4
_Bool 
# 388 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_uart.c"
    qcc74x_uart_rxavailable(struct qcc74x_device_s *dev)
{
    ...
    reg_base = dev->reg_base;
    return (((*(volatile uint32_t *)(uintptr_t)(reg_base + (0x84))) & (0x3f << (8U))) != 0);

}

void qcc74x_uart_txint_mask(struct qcc74x_device_s *dev, 
# 400 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_uart.c" 3 4
                                                        _Bool 
# 400 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_uart.c"
                                                             mask)
{
    ...
    reg_base = dev->reg_base;
    int_mask = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x24)));
    if (mask) {
        int_mask |= (1 << 2U);
    } else {
        int_mask &= ~(1 << 2U);
    }
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x24)) = (int_mask));

}

void qcc74x_uart_rxint_mask(struct qcc74x_device_s *dev, 
# 419 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_uart.c" 3 4
                                                        _Bool 
# 419 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_uart.c"
                                                             mask)
{
...
void qcc74x_uart_errint_mask(struct qcc74x_device_s *dev, 
# 440 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_uart.c" 3 4
                                                         _Bool 
# 440 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_uart.c"
                                                              mask)
{
...
uint32_t qcc74x_uart_get_intstatus(struct qcc74x_device_s *dev)
{
    ...
    reg_base = dev->reg_base;
    int_status = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x20)));
    int_mask = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x24)));
...
void qcc74x_uart_int_clear(struct qcc74x_device_s *dev, uint32_t int_clear)
{
    ...
    reg_base = dev->reg_base;
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x28)) = (int_clear));
...
int qcc74x_uart_feature_control(struct qcc74x_device_s *dev, int cmd, size_t arg)
{
    ...
    switch (cmd) {
        case (0x01):
            qcc74x_uart_disable(dev);


            tmp = (qcc74x_clk_get_peripheral_clock(5, dev->idx) * 10 / arg + 5) / 10;

            (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x8)) = (((tmp - 1) << 0x10) | ((tmp - 1) & 0xFFFF)));
            qcc74x_uart_enable(dev);
            break;
        ...
        case (0x02):
            ...
            tx_tmp = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x0)));
            rx_tmp = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x4)));
            ...
            (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x0)) = (tx_tmp));
            (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x4)) = (rx_tmp));
            qcc74x_uart_enable(dev);
            break;
        ...
        case (0x05):
            ...
            tmp = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x80)));
            tmp |= (1 << 2U);
            (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x80)) = (tmp));
            break;
        ...
        case (0x07):
            ...
            (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x18)) = (arg));
        ...
        case (0x08):
            ...
            tmp = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x1C)));
            tmp &= ~(1 << 3U);
            if (arg) {
                tmp |= (1 << 3U);
            }
            (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x1C)) = (tmp));

            break;

        case (0x09):

            ret = ((*(volatile uint32_t *)(uintptr_t)(reg_base + (0x84))) & (0x3f << (0U))) >> (0U);
            break;
        case (0x0a):

            ret = ((*(volatile uint32_t *)(uintptr_t)(reg_base + (0x84))) & (0x3f << (8U))) >> (8U);
            break;
        case (0x0b):

            tmp = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x4)));
            rx_tmp = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x24)));
            tmp &= ~(1 << 1U);
            if (arg == 1) {
                tmp |= (1 << 1U);
            ...
            (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x4)) = (tmp));
            (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x24)) = (rx_tmp));
            break;

        case (0x0c):

            tmp = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x34)));
            if (arg == 0) {
                ret = (tmp & (0xffff << (0U)));
            } else {
                ret = ((tmp & (0xffff << (16U))) >> (16U));
            }
            break;
        ...
        case (0x11):
            ...
            tx_tmp = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x54)));
            tx_tmp &= ~(1 << 0U);
            ...
            (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x54)) = (tx_tmp));
            break;
        ...
        case (0x13):
            ...
            rx_tmp = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x48)));
            rx_tmp &= ~(0xff << (0U));
            rx_tmp |= arg << (0U);

            (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x48)) = (rx_tmp));
            break;

        case (0x14):
# 757 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_uart.c"
            if (arg) {
                rx_tmp = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x1C)));
                rx_tmp |= (1 << 2U);
                (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x1C)) = (rx_tmp));
        ...
        case (0x15): {
            ...
            (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x10)) = ((ir_config->tx_pluse_stop << 16) | ir_config->tx_pluse_start));

            (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x14)) = (ir_config->rx_pluse_start));
        } break;
        ...
        case (0x22):
            ...
            rx_tmp = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x50)));
            rx_tmp &= ~(0xffff << (0U));
            rx_tmp |= (arg << (0U));
            (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x50)) = (rx_tmp));
            break;
        case (0x23):

            rx_tmp = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x50)));
            ret = ((rx_tmp & (0xffff << (16U))) >> (16U));
            break;
        ...
        case (0x24):
            ...
            break;
        case (0x25):
            tx_tmp = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x84)));
            tx_tmp &= ~(0x1f << (16U));
            tx_tmp |= (arg << (16U)) & (0x1f << (16U));
            (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x84)) = (tx_tmp));
            break;
        case (0x26):
            rx_tmp = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x84)));
            rx_tmp &= ~(0x1f << (24U));
            rx_tmp |= (arg << (24U)) & (0x1f << (24U));
            (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x84)) = (rx_tmp));
            break;
# 918 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_uart.c"
        default:
            ret = -
# 919 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_uart.c" 3
                  1
# 919 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_uart.c"
                       ;
            break;
    }
