# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_auadc.c"
# 1 "/home/durga/QCCSDK-QCC74x/examples/peripherals/gpio/gpio_input_output/build/build_out/drivers/lhal//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_auadc.c"
# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_auadc.h" 1
...
# 5 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_auadc.h" 2
# 196 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_auadc.h"
struct qcc74x_auadc_init_config_s {
    uint8_t sampling_rate;
    uint8_t input_mode;
    uint8_t data_format;
    uint8_t fifo_threshold;
};
# 215 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_auadc.h"
struct qcc74x_auadc_adc_init_config_s {
...
int qcc74x_auadc_link_rxdma(struct qcc74x_device_s *dev, 
# 236 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_auadc.h" 3 4
                                                        _Bool 
# 236 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_auadc.h"
                                                             enable);
...
int qcc74x_auadc_get_intstatus(struct qcc74x_device_s *dev);

int qcc74x_auadc_feature_control(struct qcc74x_device_s *dev, int cmd, size_t arg);
# 2 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_auadc.c" 2
# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/hardware/auadc_reg.h" 1
# 3 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_auadc.c" 2
...
int qcc74x_auadc_init(struct qcc74x_device_s *dev, const struct qcc74x_auadc_init_config_s *config)
{
    ...
    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x00)));

    regval |= (1 << 0U);

    regval &= ~(0xf << (28U));
    regval |= config->sampling_rate << (28U);
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x00)) = (regval));


    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x04)));
    regval &= ~(1 << 0U);
    regval |= (1 << 30U);
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x04)) = (regval));
    ...
    if (config->input_mode == 1 || config->input_mode == 2) {
    ...
    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x68)));

    if ((config->input_mode == 1 || config->input_mode == 2) &&
        (config->sampling_rate == 3 || config->sampling_rate == 4)) {
    ...
    regval &= ~(0xf << (16U));
    regval |= config->fifo_threshold << (16U);
    regval &= ~(0x3 << (14U));
...
int qcc74x_auadc_adc_init(struct qcc74x_device_s *dev, const struct qcc74x_auadc_adc_init_config_s *adc_analog_cfg)
{
    ...
    if (adc_analog_cfg->auadc_analog_en == 
# 133 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_auadc.c" 3 4
                                          0
# 133 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_auadc.c"
                                               ) {
    ...
    regval &= ~(0x7 << (20U));
    regval &= ~(0x7 << (16U));
    regval |= adc_analog_cfg->adc_pga_posi_ch << (20U);
    regval |= adc_analog_cfg->adc_pga_nega_ch << (16U);


    regval &= ~(0x3 << (12U));
    regval |= adc_analog_cfg->adc_pga_mode << (12U);


    regval &= ~(0xf << (8U));
    regval |= (adc_analog_cfg->adc_pga_gain / 3) << (8U);


    if (adc_analog_cfg->adc_mode == 0) {
        regval &= ~(1 << 5U);
    } else {
        regval |= (1 << 5U);
    }
    ...
    regval &= ~(0xf << (0U));
    regval |= adc_analog_cfg->adc_measure_rate << (0U);


    regval &= ~(0x3 << (24U));
    if (adc_analog_cfg->adc_pga_mode == 0 || adc_analog_cfg->adc_pga_mode == 2) {
        regval |= 0x03 << (24U);
    } else {
        regval |= 0x02 << (24U);
    }
...
int qcc74x_auadc_link_rxdma(struct qcc74x_device_s *dev, 
# 193 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_auadc.c" 3 4
                                                        _Bool 
# 193 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_auadc.c"
                                                             enable)
{
