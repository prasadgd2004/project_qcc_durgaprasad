# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_wo.c"
# 1 "/home/durga/QCCSDK-QCC74x/examples/peripherals/gpio/gpio_input_output/build/build_out/drivers/lhal//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_wo.c"
# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_wo.h" 1
...
# 5 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_wo.h" 2
# 45 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_wo.h"
...
# 70 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_wo.h"
void qcc74x_wo_pin_init(struct qcc74x_device_s *dev, uint8_t pin, uint8_t mode);
...
void qcc74x_wo_init(struct qcc74x_device_s *dev, struct qcc74x_wo_cfg_s *cfg);
...
void qcc74x_wo_enable(struct qcc74x_device_s *dev);
...
void qcc74x_wo_disable(struct qcc74x_device_s *dev);
...
uint32_t qcc74x_wo_get_fifo_available_cnt(struct qcc74x_device_s *dev);
# 110 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_wo.h"
uint32_t qcc74x_wo_push_fifo(struct qcc74x_device_s *dev, uint16_t *data, uint32_t len);
...
void qcc74x_wo_clear_fifo(struct qcc74x_device_s *dev);
...
void qcc74x_wo_enable_dma(struct qcc74x_device_s *dev);
...
void qcc74x_wo_disable_dma(struct qcc74x_device_s *dev);
...
uint32_t qcc74x_wo_get_int_status(struct qcc74x_device_s *dev);
...
void qcc74x_wo_int_mask(struct qcc74x_device_s *dev, uint32_t int_type);
...
void qcc74x_wo_int_unmask(struct qcc74x_device_s *dev, uint32_t int_type);
...
void qcc74x_wo_int_clear(struct qcc74x_device_s *dev, uint32_t int_type);
# 172 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_wo.h"
void qcc74x_wo_uart_init(struct qcc74x_device_s *dev, uint32_t baudrate, uint8_t pin);
...
void qcc74x_wo_uart_putchar(struct qcc74x_device_s *dev, uint8_t ch);
# 189 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_wo.h"
void qcc74x_wo_uart_put(struct qcc74x_device_s *dev, uint8_t *data, uint32_t len);
# 2 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_wo.c" 2
...
# 3 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_wo.c" 2
# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/hardware/wo_reg.h" 1
# 4 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_wo.c" 2
...
void qcc74x_wo_pin_init(struct qcc74x_device_s *dev, uint8_t pin, uint8_t mode)
{
    ...
    reg_base = dev->reg_base + (0x8C4);
    reg_base += pin * 4;
    regval = (1<<22U) | (1<<6U) | (0x3<<(2U)) | (1<<1U);
    regval |= (1 << (2U));
    regval |= (0xB << (8U));
    if (mode == 0) {
        regval |= (2 << (30U));
    ...
    (*(volatile uint32_t *)(uintptr_t)(reg_base) = (regval));
...
void qcc74x_wo_init(struct qcc74x_device_s *dev, struct qcc74x_wo_cfg_s *cfg)
{
    ...
    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0xAFC)));
    regval &= ~(1<<0U);
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0xAFC)) = (regval));
# 55 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_wo.c"
    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0xAFC)));
    regval &= ~(0x1ff<<(7U));
    regval &= ~(0xff<<(16U));
    regval &= ~(0xff<<(24U));
    regval |= (cfg->code_total_cnt << (7U));
    regval |= (cfg->code0_first_cnt << (16U));
    regval |= (cfg->code1_first_cnt << (24U));
    ...
    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0xB00)));
    regval &= ~(0x7f<<(16U));
    regval |= (cfg->fifo_threshold << (16U));
    if (cfg->idle_level) {
        regval |= (1<<7U);
    } else {
        regval &= ~(1<<7U);
    ...
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0xB00)) = (regval));
...
uint32_t qcc74x_wo_get_fifo_available_cnt(struct qcc74x_device_s *dev)
{
    ...
    regval = (*(volatile uint32_t *)(uintptr_t)(dev->reg_base + (0xB00)));
    regval &= (0xff<<(8U));
    regval >>= (8U);
    return regval;
...
uint32_t qcc74x_wo_push_fifo(struct qcc74x_device_s *dev, uint16_t *data, uint32_t len)
{
    ...
    uint32_t idx = 0;
    uint32_t fclk = qcc74x_clk_get_system_clock(1);
    uint32_t xclk = qcc74x_clk_get_system_clock(3);
    uint32_t to_max = fclk / xclk * 512;
    uint32_t to = to_max;

    while (idx < len) {
        if (qcc74x_wo_get_fifo_available_cnt(dev) > 0) {
            (*(volatile uint32_t *)(uintptr_t)(dev->reg_base + (0xB04)) = ((uint32_t)data[idx++]));
            to = to_max;
        } else {
            to--;
            if (to == 0) {
...
void qcc74x_wo_uart_init(struct qcc74x_device_s *dev, uint32_t baudrate, uint8_t pin)
{
    ...
    baudrate = qcc74x_clk_get_system_clock(3) / baudrate;
...
void qcc74x_wo_uart_putchar(struct qcc74x_device_s *dev, uint8_t ch)
{
    ...
    qcc74x_wo_push_fifo(dev, wo_uart_buff16, 10);
}

void qcc74x_wo_uart_put(struct qcc74x_device_s *dev, uint8_t *data, uint32_t len)
{
    for (uint32_t i = 0; i < len; i++) {
        qcc74x_wo_uart_putchar(dev, data[i]);
    }
}
