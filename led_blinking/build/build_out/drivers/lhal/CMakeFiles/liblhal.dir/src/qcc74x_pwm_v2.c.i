# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_pwm_v2.c"
# 1 "/home/durga/QCCSDK-QCC74x/examples/peripherals/gpio/gpio_input_output/build/build_out/drivers/lhal//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_pwm_v2.c"
# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_pwm_v2.h" 1
...
# 5 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_pwm_v2.h" 2
# 174 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_pwm_v2.h"
struct qcc74x_pwm_v2_channel_config_s {
...
# 191 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_pwm_v2.h"
...
# 210 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_pwm_v2.h"
void qcc74x_pwm_v2_init(struct qcc74x_device_s *dev, const struct qcc74x_pwm_v2_config_s *config);
...
void qcc74x_pwm_v2_deinit(struct qcc74x_device_s *dev);
...
void qcc74x_pwm_v2_start(struct qcc74x_device_s *dev);
...
void qcc74x_pwm_v2_stop(struct qcc74x_device_s *dev);
...
void qcc74x_pwm_v2_set_period(struct qcc74x_device_s *dev, uint16_t period);
...
float qcc74x_pwm_v2_get_frequency(struct qcc74x_device_s *dev);
# 256 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_pwm_v2.h"
void qcc74x_pwm_v2_channel_init(struct qcc74x_device_s *dev, uint8_t ch, struct qcc74x_pwm_v2_channel_config_s *config);
# 266 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_pwm_v2.h"
void qcc74x_pwm_v2_channel_set_threshold(struct qcc74x_device_s *dev, uint8_t ch, uint16_t low_threhold, uint16_t high_threhold);
...
void qcc74x_pwm_v2_channel_positive_start(struct qcc74x_device_s *dev, uint8_t ch);
...
void qcc74x_pwm_v2_channel_negative_start(struct qcc74x_device_s *dev, uint8_t ch);
...
void qcc74x_pwm_v2_channel_positive_stop(struct qcc74x_device_s *dev, uint8_t ch);
...
void qcc74x_pwm_v2_channel_negative_stop(struct qcc74x_device_s *dev, uint8_t ch);
# 307 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_pwm_v2.h"
void qcc74x_pwm_v2_int_enable(struct qcc74x_device_s *dev, uint32_t int_en, 
# 307 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_pwm_v2.h" 3 4
                                                                           _Bool 
# 307 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_pwm_v2.h"
                                                                                enable);
...
uint32_t qcc74x_pwm_v2_get_intstatus(struct qcc74x_device_s *dev);
...
void qcc74x_pwm_v2_int_clear(struct qcc74x_device_s *dev, uint32_t int_clear);
# 333 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_pwm_v2.h"
int qcc74x_pwm_v2_feature_control(struct qcc74x_device_s *dev, int cmd, size_t arg);
# 2 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_pwm_v2.c" 2
...
# 3 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_pwm_v2.c" 2
# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/hardware/pwm_v2_reg.h" 1
# 4 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_pwm_v2.c" 2
...
void qcc74x_pwm_v2_init(struct qcc74x_device_s *dev, const struct qcc74x_pwm_v2_config_s *config)
{
    ...
    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x40)));
    regval &= ~(0x3 << (30U));
    if (config->clk_source == 3) {
        regval |= (0 << (30U));
    } else if (config->clk_source == 2) {
        regval |= (1 << (30U));
    } else if (config->clk_source == 4) {
        regval |= (2 << (30U));
    } else {
    }
# 53 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_pwm_v2.c"
    regval &= ~(0xffff << (0U));
    regval |= (uint32_t)config->clk_div << (0U);
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x40)) = (regval));


    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x48)));
    regval &= ~(0xffff << (0U));
    regval |= (uint32_t)config->period << (0U);
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x48)) = (regval));
...
void qcc74x_pwm_v2_deinit(struct qcc74x_device_s *dev)
{
    ...
    regval = (1 << 29U) | (1 << 28U) | (1 << 27U) | (0xf << (20U));
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x40)) = (regval));


    regval = (1 << 23U) | (1 << 22U) | (1 << 21U) | (1 << 20U);
    regval |= (1 << 19U) | (1 << 18U) | (1 << 17U) | (1 << 16U);
    regval |= (1 << 15U) | (1 << 11U) | (1 << 7U) | (1 << 3U);
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x44)) = (regval));


    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x48)) = (0));


    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x4C)) = (0));


    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x50)) = (0));
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x54)) = (1));
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x58)) = (2));
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x5C)) = (3));


    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x64)) = (0xFFFFFFFF));

    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x68)) = (0xFFFFFFFF));

    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x6C)) = (0xFFFFFFFF));
...
float qcc74x_pwm_v2_get_frequency(struct qcc74x_device_s *dev)
{
    ...
    tmp = (regval & (0x3 << (30U))) >> (30U);
    switch (tmp) {
        case 0:
            src = (float)qcc74x_clk_get_system_clock(3);
            break;
        case 1:
            src = (float)qcc74x_clk_get_system_clock(2);
            break;
        default:
            src = (float)qcc74x_clk_get_system_clock(4);
            break;
    }

    tmp = (regval & (0xffff << (0U))) >> (0U);
...
void qcc74x_pwm_v2_channel_init(struct qcc74x_device_s *dev, uint8_t ch, struct qcc74x_pwm_v2_channel_config_s *config)
{
    ...
    if (config->positive_polarity == 0) {
        regval &= ~((1 << 16U) << ch * 2);
    } else {
        regval |= ((1 << 16U) << ch * 2);
    }
    if (config->negative_polarity == 0) {
        regval &= ~((1 << 17U) << ch * 2);
    } else {
        regval |= ((1 << 17U) << ch * 2);
    }
    if (config->positive_stop_state == 1) {
        regval |= ((1 << 1U) << ch * 4);
    } else {
        regval &= ~((1 << 1U) << ch * 4);
    }
    if (config->negative_stop_state == 0) {
        regval &= ~((1 << 3U) << ch * 4);
    } else {
        regval |= ((1 << 3U) << ch * 4);
    }
    if (config->positive_brake_state == 1) {
        regval |= ((1 << 24U) << ch * 2);
    } else {
        regval &= ~((1 << 24U) << ch * 2);
    }
    if (config->negative_brake_state == 1) {
        regval |= ((1 << 25U) << ch * 2);
    } else {
        regval &= ~((1 << 25U) << ch * 2);
    }
    ...
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x4C)) = (regval));
...
void qcc74x_pwm_v2_channel_set_threshold(struct qcc74x_device_s *dev, uint8_t ch, uint16_t low_threhold, uint16_t high_threhold)
{
    ...
    (*(volatile uint32_t *)(uintptr_t)(dev->reg_base + (0x50) + ch * 4) = (regval));
...
void qcc74x_pwm_v2_int_enable(struct qcc74x_device_s *dev, uint32_t int_en, 
# 343 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_pwm_v2.c" 3 4
                                                                           _Bool 
# 343 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_pwm_v2.c"
                                                                                enable)
{
    ...
    reg_base = dev->reg_base;
    regval_mask = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x64)));
    regval_en = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x6C)));
    if (enable) {
        regval_mask &= ~int_en;
        regval_en |= int_en;
    } else {
    ...
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x64)) = (regval_mask));
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x6C)) = (regval_en));
...
void qcc74x_pwm_v2_int_clear(struct qcc74x_device_s *dev, uint32_t int_clear)
{
    ...
    (*(volatile uint32_t *)(uintptr_t)(dev->reg_base + (0x68)) = (int_clear));
...
uint32_t qcc74x_pwm_v2_get_intstatus(struct qcc74x_device_s *dev)
{
    ...
    reg_base = dev->reg_base;
    regval_sts = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x60)));
    regval_mask = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x64)));
    regval_en = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x6C)));
...
int qcc74x_pwm_v2_feature_control(struct qcc74x_device_s *dev, int cmd, size_t arg)
{
    ...
    switch (cmd) {
        ...
        case (0x03):
            regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x40)));
            if (arg == 
# 414 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_pwm_v2.c" 3 4
                      1
# 414 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_pwm_v2.c"
                          ) {
                regval |= (1 << 25U);
            } else {
                regval &= ~(1 << 25U);
        ...
        case (0x04):
            regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x40)));
            if (arg == 
# 424 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_pwm_v2.c" 3 4
                      1
# 424 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_pwm_v2.c"
                          ) {
                regval |= (1 << 24U);
            } else {
                regval &= ~(1 << 24U);
        ...
        case (0x05):
            regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x40)));
            if (arg == 
# 434 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_pwm_v2.c" 3 4
                      1
# 434 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_pwm_v2.c"
                          ) {
                regval |= (1 << 19U);
            } else {
                regval &= ~(1 << 19U);
        ...
        case (0x01):
            ...
            (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x40)) = (regval));
            break;
# 493 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_pwm_v2.c"
        default:
            ret = -
# 494 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_pwm_v2.c" 3
                  1
# 494 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_pwm_v2.c"
                       ;
            break;
    }
    return ret;
