# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_adc.c"
...
# 5 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_adc.h" 2
...
# 2 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_adc.c" 2
...
# 3 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_adc.c" 2
# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/hardware/adc_reg.h" 1
# 4 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_adc.c" 2
...
void qcc74x_adc_init(struct qcc74x_device_s *dev, const struct qcc74x_adc_config_s *config)
{
    ...
    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x90C)));
    regval &= ~(1 << 0U);
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x90C)) = (regval));
    ...
    regval |= (2 << (29U));
    regval |= (1 << (27U));
    regval |= (config->clk_div << (18U));
    regval |= (config->resolution << (2U));
    ...
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x910)) = (regval));
    ...
    __asm volatile("nop");
    __asm volatile("nop");
# 97 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_adc.c"
    regval = 0;
    regval |= (2 << (28U));
    regval |= (2 << (15U));
    regval |= (1 << (25U));
    ...
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x914)) = (regval));
    ...
    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x938)));
    regval &= ~(0xffff << (0U));
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x938)) = (regval));


    regval = (*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x20002000) + (0x0)));
    regval |= ((1 << 14U) | (1 << 13U) | (1 << 12U) |
               (1 << 10U) | (1 << 9U) | (1 << 8U));
    ...
    regval &= ~(0x3 << (22U));
    regval &= ~(1 << 0U);
    (*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x20002000) + (0x0)) = (regval));
    ...
    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x92C)));
    regval |= (1 << 8U);
    regval |= (1 << 9U);
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x92C)) = (regval));


    if (adc_cali_complete == 0) {
        coe = qcc74x_efuse_get_adc_trim();
        qcc74x_update_adc_trim(dev, config);
        tsen_offset = qcc74x_efuse_get_adc_tsen_trim();
        adc_cali_complete = 1;
    }
}
...
void qcc74x_update_adc_trim(struct qcc74x_device_s *dev, const struct qcc74x_adc_config_s *config)
{
    ...
    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x910)));
    regval |= (1 << 1U);
    regval &= ~(1 << 25U);
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x910)) = (regval));

    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x914)));
    regval |= (1 << 2U);
    regval |= (1 << 4U);
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x914)) = (regval));
    ...
    for (uint16_t i = 0; i < 10; i++) {
        ...
        regval = qcc74x_adc_read_raw(dev);
        if (i > 4) {
            if (regval & 0x8000) {
                regval = ~regval;
                regval += 1;
...
void qcc74x_adc_deinit(struct qcc74x_device_s *dev)
{
    ...
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x90C)) = (0xF78));
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x910)) = (0xC0002));
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x914)) = (0x19100));
}

void qcc74x_adc_link_rxdma(struct qcc74x_device_s *dev, 
# 309 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_adc.c" 3 4
                                                       _Bool 
# 309 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_adc.c"
                                                            enable)
{
    uint32_t regval;
...
int qcc74x_adc_channel_config(struct qcc74x_device_s *dev, struct qcc74x_adc_channel_s *chan, uint8_t channels)
{
    ...
    if (!((*(volatile uint32_t *)(uintptr_t)(reg_base + (0x910))) & (1 << 25U))) {
        if (channels > 1) {
            return -
# 341 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_adc.c" 3
                   22
# 341 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_adc.c"
                         ;
        }
        ...
        regval &= ~(0x1f << (8U));
        regval &= ~(0x1f << (3U));
        regval |= (chan->pos_chan << (8U));
        regval |= (chan->neg_chan << (3U));
        (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x90C)) = (regval));
    } else {
        if (channels < 6) {
            regval = 0;
            ...
            (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x918)) = (regval));
            (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x920)) = (regval2));
        } else {
            regval = 0;
            regval2 = 0;
            ...
            (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x91C)) = (regval));
            (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x924)) = (regval2));
        }

        regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x910)));
        regval &= ~(0xf << (21U));
        regval |= ((channels - 1) << (21U));
        (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x910)) = (regval));
    }
    return 0;
}
...
uint8_t qcc74x_adc_get_count(struct qcc74x_device_s *dev)
{
    return (((*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x20002000) + (0x0))) & (0x3f << (16U))) >> (16U));
}

uint32_t qcc74x_adc_read_raw(struct qcc74x_device_s *dev)
{
    return (*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x20002000) + (0x4))) & (0x3ffffff << (0U));
}

void qcc74x_adc_rxint_mask(struct qcc74x_device_s *dev, 
# 427 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_adc.c" 3 4
                                                       _Bool 
# 427 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_adc.c"
                                                            mask)
{
    uint32_t regval;
...
void qcc74x_adc_errint_mask(struct qcc74x_device_s *dev, 
# 440 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_adc.c" 3 4
                                                        _Bool 
# 440 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_adc.c"
                                                             mask)
{
    uint32_t regval;
    uint32_t regval2;
    ...
    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x92C)));
    regval2 = (*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x20002000) + (0x0)));
    ...
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x92C)) = (regval));
    (*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x20002000) + (0x0)) = (regval2));
}
...
uint32_t qcc74x_adc_get_intstatus(struct qcc74x_device_s *dev)
{
    ...
    if ((*(volatile uint32_t *)(uintptr_t)(reg_base + (0x92C))) & (1 << 0U)) {
        regval |= (1 << 0);
    }
    if ((*(volatile uint32_t *)(uintptr_t)(reg_base + (0x92C))) & (1 << 1U)) {
        regval |= (1 << 1);
    }
    if ((*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x20002000) + (0x0))) & (1 << 6U)) {
        regval |= (1 << 2);
    }
    if ((*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x20002000) + (0x0))) & (1 << 5U)) {
        regval |= (1 << 3);
    }
    if ((*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x20002000) + (0x0))) & (1 << 4U)) {
        regval |= (1 << 4);
    }
    return regval;
}
...
void qcc74x_adc_parse_result(struct qcc74x_device_s *dev, uint32_t *buffer, struct qcc74x_adc_result_s *result, uint16_t count)
{
    ...
    resolution = ((*(volatile uint32_t *)(uintptr_t)(reg_base + (0x910))) & (0x7 << (2U))) >> (2U);
    diff_mode = ((*(volatile uint32_t *)(uintptr_t)(reg_base + (0x914))) & (1 << 2U)) >> 2;
    vref = ((*(volatile uint32_t *)(uintptr_t)(reg_base + (0x914))) & (1 << 3U)) >> 3;
    ...
    for (uint32_t i = 0; i < 8; i++) {
        ...
        while (qcc74x_adc_get_count(dev) == 0) {
            if ((qcc74x_mtimer_get_time_ms() - start_time) > 100) {
                return -
# 787 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_adc.c" 3
                       116
# 787 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_adc.c"
                                ;
            }
        }
    ...
    for (uint32_t i = 0; i < 16; i++) {
        ...
        while (qcc74x_adc_get_count(dev) == 0) {
            if ((qcc74x_mtimer_get_time_ms() - start_time) > 100) {
                return -
# 796 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_adc.c" 3
                       116
# 796 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_adc.c"
                                ;
            }
        }
    ...
    for (uint32_t i = 0; i < 8; i++) {
        ...
        while (qcc74x_adc_get_count(dev) == 0) {
            if ((qcc74x_mtimer_get_time_ms() - start_time) > 100) {
                return -
# 819 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_adc.c" 3
                       116
# 819 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_adc.c"
                                ;
            }
        }
        qcc74x_adc_read_raw(dev);
    ...
    for (uint32_t i = 0; i < 16; i++) {
        ...
        while (qcc74x_adc_get_count(dev) == 0) {
            if ((qcc74x_mtimer_get_time_ms() - start_time) > 100) {
                return -
# 828 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_adc.c" 3
                       116
# 828 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_adc.c"
                                ;
            }
        }
        raw_data = qcc74x_adc_read_raw(dev);
...
# 878 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_adc.c" 3 4
   _Bool 
# 878 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_adc.c"
        dma_en;
    ...
    switch (cmd) {
        case 0x00:
            ...
            if (regval & (1 << 0U)) {
                dma_en = 
# 887 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_adc.c" 3 4
                        1
# 887 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_adc.c"
                            ;
            } else {
                dma_en = 
# 889 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_adc.c" 3 4
                        0
# 889 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_adc.c"
                             ;
            }
            regval &= ~(1 << 0U);
            (*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x20002000) + (0x0)) = (regval));
        ...
        default:
            ret = -
# 917 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_adc.c" 3
                  1
# 917 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_adc.c"
                       ;
            break;
    }
    return ret;
