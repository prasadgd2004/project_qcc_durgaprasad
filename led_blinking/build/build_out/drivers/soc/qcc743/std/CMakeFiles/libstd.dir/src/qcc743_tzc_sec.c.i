# 1 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_tzc_sec.c"
...
# 2 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_tzc_sec.c" 2
...
# 13 "/usr/bin/linux_x86_64/riscv64-unknown-elf/include/stdint.h" 3 4
...
# 3 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_tzc_sec.c" 2
...
# 4 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_tzc_sec.c" 2
# 61 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_tzc_sec.c"
void Tzc_Sec_Set_Sboot_Done(void)
{
    uint32_t tmpVal;

    tmpVal = (*((volatile uint32_t *)(uintptr_t)(((uint32_t)0x20005000) + (0x40))));
    tmpVal = (((tmpVal)&(~(((1U<<(4U))-1)<<(28U)))) | ((uint32_t)(0xf) << (28U)));
    ((*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x20005000) + (0x40))) = (tmpVal));
}
...
void Tzc_Sec_Set_Master_Group(TZC_SEC_Master_Type masterType, uint8_t group)
{
    ...
    tmpVal = (*((volatile uint32_t *)(uintptr_t)(((uint32_t)0x20005000) + (0x100))));
    tmpVal2 = (*((volatile uint32_t *)(uintptr_t)(((uint32_t)0x20005000) + (0x104))));
    ...
    ((*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x20005000) + (0x100))) = (tmpVal));
    ((*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x20005000) + (0x104))) = (tmpVal2));
}
...
void Tzc_Sec_Set_Slave_Group(TZC_SEC_Slave_Type slaveType, uint8_t group)
{
    ...
    if (group > 3 || slaveType >= TZC_SEC_SLAVE_MAX) {
        return;
    }
    group = 1 << (group);

    if (slaveType < TZC_SEC_SLAVE_S1_GLB) {
        tmpVal = (*((volatile uint32_t *)(uintptr_t)(((uint32_t)0x20005000) + (0x108))));

        tmpVal &= (~(3 << (slaveType * 2)));
        tmpVal |= (group << (slaveType * 2));

        tmpVal |= (1 << (slaveType + 16));
        ((*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x20005000) + (0x108))) = (tmpVal));
    } else if ((slaveType >= TZC_SEC_SLAVE_S1_GLB) && (slaveType < TZC_SEC_SLAVE_S2_EMI_MISC)) {
        slaveType -= TZC_SEC_SLAVE_S1_GLB;
        tmpVal = (*((volatile uint32_t *)(uintptr_t)(((uint32_t)0x20005000) + (0x10C))));

        tmpVal &= (~(3 << (slaveType * 2)));
        tmpVal |= (group << (slaveType * 2));
        ((*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x20005000) + (0x10C))) = (tmpVal));

        tmpVal = (*((volatile uint32_t *)(uintptr_t)(((uint32_t)0x20005000) + (0x114))));

        tmpVal |= (1 << slaveType);
        ((*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x20005000) + (0x114))) = (tmpVal));
    } else if ((slaveType >= TZC_SEC_SLAVE_S2_EMI_MISC) && (slaveType < TZC_SEC_SLAVE_S1A_UART0)) {
        slaveType -= TZC_SEC_SLAVE_S2_EMI_MISC;

        tmpVal = (*((volatile uint32_t *)(uintptr_t)(((uint32_t)0x20005000) + (0x110))));

        tmpVal &= (~(3 << (slaveType * 2)));
        tmpVal |= (group << (slaveType * 2));
        ((*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x20005000) + (0x110))) = (tmpVal));
        ...
        tmpVal = (*((volatile uint32_t *)(uintptr_t)(((uint32_t)0x20005000) + (0x118))));

        tmpVal &= (~(3 << (slaveType * 2)));
        tmpVal |= (group << (slaveType * 2));
        ((*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x20005000) + (0x118))) = (tmpVal));

        tmpVal = (*((volatile uint32_t *)(uintptr_t)(((uint32_t)0x20005000) + (0x11C))));

        tmpVal |= (1 << slaveType);
        ((*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x20005000) + (0x11C))) = (tmpVal));
    }
}
...
void Tzc_Sec_Set_Codec_Group(uint8_t group)
{
    ...
    tmpVal = (*((volatile uint32_t *)(uintptr_t)(((uint32_t)0x20005000) + (0x300))));
    tmpVal2 = (*((volatile uint32_t *)(uintptr_t)(((uint32_t)0x20005000) + (0x304))));
    ...
    ((*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x20005000) + (0x300))) = (tmpVal));
    ((*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x20005000) + (0x304))) = (tmpVal2));
}
...
void Tzc_Sec_Set_Glb_Ctrl_Group(TZC_SEC_GLB_Ctrl_Type slaveType, uint8_t group)
{
    ...
    if (slaveType >= TZC_SEC_GLB_CTRL_MAX || group > 3) {
        return;
    }
    group = 1 << (group);

    tmpVal = (*((volatile uint32_t *)(uintptr_t)(((uint32_t)0x20005000) + (0xF00))));

    tmpVal &= (~(3 << (slaveType * 2)));
    tmpVal |= (group << (slaveType * 2));
    ((*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x20005000) + (0xF00))) = (tmpVal));

    tmpVal = (*((volatile uint32_t *)(uintptr_t)(((uint32_t)0x20005000) + (0xF08))));

    tmpVal |= (1 << slaveType);
    ((*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x20005000) + (0xF08))) = (tmpVal));
}
...
void Tzc_Sec_Set_CPU_Group(uint8_t cpu, uint8_t group)
{
    ...
    if (cpu == (0)) {
        ...
        tmpVal = (((tmpVal)&(~(((1U<<(1U))-1)<<(7U)))) | ((uint32_t)(group) << (7U)));
        tmpVal2 = (((tmpVal2)&(~(((1U<<(1U))-1)<<(7U)))) | ((uint32_t)(1) << (7U)));

        ((*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x20005000) + (0x100))) = (tmpVal));
        ((*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x20005000) + (0x104))) = (tmpVal2));
    }
}
# 236 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_tzc_sec.c"
void Tzc_Sec_ROM_Access_Set(uint8_t region, uint32_t startAddr, uint32_t length, uint8_t group)
{
    uint32_t tmpVal = 0;
    ...
    ((*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x20005000) + (0x48) + region * 4)) = (tmpVal));
...
# 274 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_tzc_sec.c"
void Tzc_Sec_ROM_Access_Set_Advance(uint8_t region, uint32_t startAddr, uint32_t length, uint8_t group)
{
    uint32_t tmpVal = 0;
    uint32_t alignEnd = (startAddr + length + 1023) & ~0x3FF;
...
# 312 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_tzc_sec.c"
void Tzc_Sec_OCRAM_Access_Set_Advance(uint8_t region, uint32_t startAddr, uint32_t length, uint8_t group)
{
    uint32_t tmpVal = 0;
    uint32_t alignEnd = (startAddr + length + 1023) & ~0x3FF;
    ...
    tmpVal = (*((volatile uint32_t *)(uintptr_t)(((uint32_t)0x20005000) + (0x140))));
    tmpVal &= (~(0xf << (region * 4)));
    tmpVal |= (group << (region * 4));
    ((*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x20005000) + (0x140))) = (tmpVal));

    tmpVal = (((alignEnd >> 10) & 0xffff) - 1) | (((startAddr >> 10) & 0xffff) << 16);
    ((*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x20005000) + (0x148) + region * 4)) = (tmpVal));
...
# 347 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_tzc_sec.c"
void Tzc_Sec_OCRAM_Access_Set_Regionx(uint8_t group)
{
    uint32_t tmpVal = 0;
    uint8_t region = 3;
...
# 382 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_tzc_sec.c"
void Tzc_Sec_WRAM_Access_Set_Advance(uint8_t region, uint32_t startAddr, uint32_t length, uint8_t group)
{
    uint32_t tmpVal = 0;
    uint32_t alignEnd = (startAddr + length + 1023) & ~0x3FF;
    ...
    tmpVal = (*((volatile uint32_t *)(uintptr_t)(((uint32_t)0x20005000) + (0x180))));
    tmpVal &= (~(0xf << (region * 4)));
    tmpVal |= (group << (region * 4));
    ((*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x20005000) + (0x180))) = (tmpVal));

    tmpVal = (((alignEnd >> 10) & 0xffff) - 1) | (((startAddr >> 10) & 0xffff) << 16);
    ((*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x20005000) + (0x188) + region * 4)) = (tmpVal));
...
# 417 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_tzc_sec.c"
void Tzc_Sec_WRAM_Access_Set_Regionx(uint8_t group)
{
    uint32_t tmpVal = 0;
    uint8_t region = 3;
...
# 450 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_tzc_sec.c"
void Tzc_Sec_HBNRAM_Access_Set(uint32_t startAddr, uint32_t length)
{
    uint32_t tmpVal = 0;
    uint32_t alignEnd = (startAddr + length + 3) & ~0x3;

    tmpVal = (*((volatile uint32_t *)(uintptr_t)(((uint32_t)0x2000f000) + (0xF04))));
    tmpVal = (((tmpVal)&(~(((1U << (11U)) - 1) << (16U)))) | ((uint32_t)(((startAddr >> 2) & 0xffff)) << (16U)));
    tmpVal = (((tmpVal)&(~(((1U << (11U)) - 1) << (0U)))) | ((uint32_t)((((alignEnd >> 2) & 0xffff) - 1)) << (0U)));
    ((*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x2000f000) + (0xF04))) = (tmpVal));


    tmpVal = (*((volatile uint32_t *)(uintptr_t)(((uint32_t)0x2000f000) + (0xF00))));
    tmpVal = (((tmpVal)&(~(((1U << (1U)) - 1) << (16U)))) | ((uint32_t)(1) << (16U)));
    tmpVal = (((tmpVal)&(~(((1U << (1U)) - 1) << (24U)))) | ((uint32_t)(1) << (24U)));
    ((*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x2000f000) + (0xF00))) = (tmpVal));
}
# 478 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_tzc_sec.c"
void Tzc_Sec_Flash_Access_Set(uint8_t region, uint32_t startAddr, uint32_t length, uint8_t group)
{
    uint32_t tmpVal = 0;
    uint32_t tmpVal2 = 0;
    ...
    tmpVal = (*((volatile uint32_t *)(uintptr_t)(((uint32_t)0x20005000) + (0x280))));
    tmpVal &= (~(0xf << (region * 4)));
    tmpVal |= (group << (region * 4));
    ((*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x20005000) + (0x280))) = (tmpVal));


    tmpVal = (((alignEnd >> 10) & 0xffff) - 1) | (((startAddr >> 10) & 0xffff) << 16);
    ((*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x20005000) + (0x288) + region * 4)) = (tmpVal));


    tmpVal = (*((volatile uint32_t *)(uintptr_t)(((uint32_t)0x20005000) + (0x298))));
    tmpVal = tmpVal & (0xff << (8 * region));
    tmpVal2 = ((alignEnd >> 26) & 0x7) | (((startAddr >> 26) & 0x7) << 3);
    tmpVal2 = tmpVal2 << (8 * region);
    ((*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x20005000) + (0x298))) = (tmpVal | tmpVal2));
...
# 522 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_tzc_sec.c"
void Tzc_Sec_Flash_Access_Set_Regionx(uint8_t group)
{
    uint32_t tmpVal = 0;
    uint8_t region = 4;
...
# 557 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_tzc_sec.c"
void Tzc_Sec_Flash_Access_Set_Advance(uint8_t region, uint32_t startAddr, uint32_t length, uint8_t group)
{
    uint32_t tmpVal = 0;
    uint32_t tmpVal2 = 0;
...
# 604 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_tzc_sec.c"
void Tzc_Sec_PSRAMB_Access_Set(uint8_t region, uint32_t startAddr, uint32_t length, uint8_t group)
{
    uint32_t tmpVal = 0;
    uint32_t alignEnd = (startAddr + length + 1023) & ~0x3FF;
    ...
    tmpVal = (*((volatile uint32_t *)(uintptr_t)(((uint32_t)0x20005000) + (0x3A0))));
    tmpVal &= (~(0xf << (region * 4)));
    tmpVal |= (group << (region * 4));
    ((*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x20005000) + (0x3A0))) = (tmpVal));

    tmpVal = (((alignEnd >> 10) & 0xffff) - 1) | (((startAddr >> 10) & 0xffff) << 16);
    ((*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x20005000) + (0x3A8) + region * 4)) = (tmpVal));
...
# 656 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_tzc_sec.c"
void Tzc_Sec_PSRAMB_Access_Set_Advance(uint8_t region, uint32_t startAddr, uint32_t length, uint8_t group)
{
    uint32_t tmpVal = 0;
    uint32_t alignEnd = (startAddr + length + 1023) & ~0x3FF;
...
# 691 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_tzc_sec.c"
void Tzc_Sec_Set_Se_Ctrl_Mode(TZC_SEC_SE_Ctrl_Mode mode)
{
    uint32_t tmpVal = 0;

    tmpVal = (*((volatile uint32_t *)(uintptr_t)(((uint32_t)0x20005000) + (0xF40))));
    tmpVal = (((tmpVal)&(~(((1U<<(1U))-1)<<(12U)))) | ((uint32_t)(mode) << (12U)));
    ((*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x20005000) + (0xF40))) = (tmpVal));

    tmpVal = (*((volatile uint32_t *)(uintptr_t)(((uint32_t)0x20005000) + (0xF48))));

    tmpVal = (((tmpVal)&(~(((1U<<(1U))-1)<<(6U)))) | ((uint32_t)(1) << (6U)));
    ((*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x20005000) + (0xF48))) = (tmpVal));
}
# 713 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_tzc_sec.c"
void Tzc_Sec_Set_Sf_Ctrl_Mode(TZC_SEC_SF_Ctrl_Mode mode)
{
    uint32_t tmpVal = 0;

    tmpVal = (*((volatile uint32_t *)(uintptr_t)(((uint32_t)0x20005000) + (0xF44))));
    tmpVal = (((tmpVal)&(~(((1U<<(1U))-1)<<(4U)))) | ((uint32_t)(mode) << (4U)));
    ((*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x20005000) + (0xF44))) = (tmpVal));
...
void Tzc_Sec_Set_Se_Group(TZC_SEC_SE_Ctrl_Type slaveType, uint8_t group)
{
    ...
    if (group > 3 || slaveType >= TZC_SEC_SE_CTRL_MAX) {
        return;
    }
    group = 1 << (group);
...
void Tzc_Sec_Set_Sf_Group(TZC_SEC_SF_Ctrl_Type slaveType, uint8_t group)
{
    ...
    if (group > 3 || slaveType >= TZC_SEC_SF_CTRL_MAX) {
        return;
    }
    group = 1 << (group);
...
# 777 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_tzc_sec.c"
void Tzc_Sec_Set_WTD_Rst_Delay(uint16_t delayValue)
{
    uint32_t tmpVal = 0;

    tmpVal = (*((volatile uint32_t *)(uintptr_t)(((uint32_t)0x20005000) + (0xF40))));
    tmpVal = (((tmpVal)&(~(((1U<<(16U))-1)<<(16U)))) | ((uint32_t)(delayValue) << (16U)));
    ((*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x20005000) + (0xF40))) = (tmpVal));
}
