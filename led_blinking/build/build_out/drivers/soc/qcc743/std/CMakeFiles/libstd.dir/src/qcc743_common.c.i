# 1 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_common.c"
...
# 2 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_common.c" 2
...
# 3 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_common.c" 2
# 1 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/include/qcc743_clock.h" 1
# 4 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_common.c" 2
# 65 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_common.c"
__attribute__((weak))
void __attribute__((section(".tcm_code." "./drivers/soc/qcc743/std/src/qcc743_common.c" "66"))) ASM_Delay_Us(uint32_t core, uint32_t cnt, uint32_t loopT)
{
...
# 126 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_common.c"
__attribute__((weak))
void __attribute__((section(".tcm_code." "./drivers/soc/qcc743/std/src/qcc743_common.c" "127"))) arch_delay_us(uint32_t cnt)
{
    uint32_t coreFreq;
    uint32_t loopTick = 3;
    ...
    iCacheEn = (__get_MHCR() & (0x1UL << 0U)) >> 0U;
    dCacheEn = (__get_MHCR() & (0x1UL << 1U)) >> 1U;
...
# 159 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_common.c"
            coreFreq = Clock_System_Clock_Get(QCC74x_SYSTEM_CLOCK_MCU_CLK);
# 168 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_common.c"
    coreFreq = coreFreq ? coreFreq : (32 * 1000 * 1000);

    ASM_Delay_Us(coreFreq, cnt, loopTick);
}
# 181 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_common.c"
__attribute__((weak))
void __attribute__((section(".tcm_code." "./drivers/soc/qcc743/std/src/qcc743_common.c" "182"))) arch_delay_ms(uint32_t cnt)
{
    uint32_t i = 0;
    uint32_t count = 0;
