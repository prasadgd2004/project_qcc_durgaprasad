# 1 "/home/durga/QCCSDK-QCC74x/components/utils/getopt/utils_getopt.c"
# 1 "/home/durga/QCCSDK-QCC74x/examples/peripherals/gpio/gpio_input_output/build/build_out/components/utils//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/durga/QCCSDK-QCC74x/components/utils/getopt/utils_getopt.c"
# 24 "/home/durga/QCCSDK-QCC74x/components/utils/getopt/utils_getopt.c"
...
# 25 "/home/durga/QCCSDK-QCC74x/components/utils/getopt/utils_getopt.c" 2
...
typedef int wchar_t;
# 26 "/home/durga/QCCSDK-QCC74x/components/utils/getopt/utils_getopt.c" 2
...
# 27 "/home/durga/QCCSDK-QCC74x/components/utils/getopt/utils_getopt.c" 2
...
# 28 "/home/durga/QCCSDK-QCC74x/components/utils/getopt/utils_getopt.c" 2
...
# 29 "/home/durga/QCCSDK-QCC74x/components/utils/getopt/utils_getopt.c" 2
# 1 "/home/durga/QCCSDK-QCC74x/components/utils/getopt/utils_getopt.h" 1
# 12 "/home/durga/QCCSDK-QCC74x/components/utils/getopt/utils_getopt.h"
...
# 30 "/home/durga/QCCSDK-QCC74x/components/utils/getopt/utils_getopt.h"
int utils_getopt_init(getopt_env_t *env, int opterr);
# 84 "/home/durga/QCCSDK-QCC74x/components/utils/getopt/utils_getopt.h"
...
# 30 "/home/durga/QCCSDK-QCC74x/components/utils/getopt/utils_getopt.c" 2
...
int utils_getopt_init(getopt_env_t *env, int opterr)
{
    ...
    env->optarg = 
# 36 "/home/durga/QCCSDK-QCC74x/components/utils/getopt/utils_getopt.c" 3 4
                 ((void *)0)
# 36 "/home/durga/QCCSDK-QCC74x/components/utils/getopt/utils_getopt.c"
                     ;
    env->optind = 1;
    env->opterr = opterr;
    env->optopt = 0;
...
# 162 "/home/durga/QCCSDK-QCC74x/components/utils/getopt/utils_getopt.c" 3 4
                                ((void *)0)
# 162 "/home/durga/QCCSDK-QCC74x/components/utils/getopt/utils_getopt.c"
                                    , 16);
        *params = *params + 2;
    }
}
...
void utils_parse_number(const char *str, char sep, uint8_t *buf, int buflen, int base)
{
    int i;
    for (i = 0; i < buflen; i++) {
        buf[i] = (uint8_t)strtol(str, 
# 207 "/home/durga/QCCSDK-QCC74x/components/utils/getopt/utils_getopt.c" 3 4
                                     ((void *)0)
# 207 "/home/durga/QCCSDK-QCC74x/components/utils/getopt/utils_getopt.c"
                                         , base);
        str = strchr(str, sep);
        if (str == 
# 209 "/home/durga/QCCSDK-QCC74x/components/utils/getopt/utils_getopt.c" 3 4
                  ((void *)0) 
# 209 "/home/durga/QCCSDK-QCC74x/components/utils/getopt/utils_getopt.c"
                       || *str == '\0') {
            break;
        }
        str++;
...
void utils_parse_number_adv(const char *str, char sep, uint8_t *buf, int buflen, int base, int *count)
{
    ...
    for (i = 0; i < buflen; i++) {
        buf[i] = (uint8_t)strtol(str, 
# 221 "/home/durga/QCCSDK-QCC74x/components/utils/getopt/utils_getopt.c" 3 4
                                     ((void *)0)
# 221 "/home/durga/QCCSDK-QCC74x/components/utils/getopt/utils_getopt.c"
                                         , base);
        str = strchr(str, sep);
        if (str == 
# 223 "/home/durga/QCCSDK-QCC74x/components/utils/getopt/utils_getopt.c" 3 4
                  ((void *)0) 
# 223 "/home/durga/QCCSDK-QCC74x/components/utils/getopt/utils_getopt.c"
                       || *str == '\0') {
            break;
        }
        str++;
...
void *utils_memdrain8_with_check(void *src, size_t len, uint8_t seq)
{
    ...
    return 
# 317 "/home/durga/QCCSDK-QCC74x/components/utils/getopt/utils_getopt.c" 3 4
          ((void *)0)
# 317 "/home/durga/QCCSDK-QCC74x/components/utils/getopt/utils_getopt.c"
              ;
}
...
void *utils_memdrain16_with_check(void *src, size_t len, uint16_t seq)
{
    ...
    return 
# 335 "/home/durga/QCCSDK-QCC74x/components/utils/getopt/utils_getopt.c" 3 4
          ((void *)0)
# 335 "/home/durga/QCCSDK-QCC74x/components/utils/getopt/utils_getopt.c"
              ;
}
...
void *utils_memdrain32_with_check(void *src, size_t len, uint32_t seq)
{
    ...
    return 
# 353 "/home/durga/QCCSDK-QCC74x/components/utils/getopt/utils_getopt.c" 3 4
          ((void *)0)
# 353 "/home/durga/QCCSDK-QCC74x/components/utils/getopt/utils_getopt.c"
              ;
}
...
void *utils_memdrain64_with_check(void *src, size_t len, uint64_t seq)
{
    ...
    return 
# 371 "/home/durga/QCCSDK-QCC74x/components/utils/getopt/utils_getopt.c" 3 4
          ((void *)0)
# 371 "/home/durga/QCCSDK-QCC74x/components/utils/getopt/utils_getopt.c"
              ;
}
