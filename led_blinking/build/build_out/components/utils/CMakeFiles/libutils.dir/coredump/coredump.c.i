# 1 "/home/durga/QCCSDK-QCC74x/components/utils/coredump/coredump.c"
...
# 2 "/home/durga/QCCSDK-QCC74x/components/utils/coredump/coredump.c" 2
...
# 3 "/home/durga/QCCSDK-QCC74x/components/utils/coredump/coredump.c" 2
...
# 4 "/home/durga/QCCSDK-QCC74x/components/utils/coredump/coredump.c" 2
...
# 5 "/home/durga/QCCSDK-QCC74x/components/utils/coredump/coredump.c" 2



# 1 "/home/durga/QCCSDK-QCC74x/components/utils/coredump/coredump.h" 1


# 1 "/usr/bin/linux_x86_64/lib/gcc/riscv64-unknown-elf/10.4.0/include/stddef.h" 1 3 4
# 4 "/home/durga/QCCSDK-QCC74x/components/utils/coredump/coredump.h" 2
...
extern __attribute__((weak)) uint8_t elf_build_id[20];
...
# 9 "/home/durga/QCCSDK-QCC74x/components/utils/coredump/coredump.c" 2

uint8_t core_build_id[20];
...
static void coredump_print_n_k(uintptr_t addr, uintptr_t lma_addr, uint32_t len, const char *desc)
{
    ...
    for(seg = 0; seg * 1 * 1024 < len; seg++) {
        printed_len = seg*1*1024;
        coredump_print(addr + printed_len, lma_addr + printed_len, len - printed_len >= 1*1024 ? 1*1024: len - printed_len, desc);
    }
}
...
# 93 "/home/durga/QCCSDK-QCC74x/components/utils/coredump/coredump.c"
int coredump_xip_flash_write(uint32_t lma, uint8_t *lma_xip, size_t len)
{
...
# 113 "/home/durga/QCCSDK-QCC74x/components/utils/coredump/coredump.c" 3 4
   _Bool 
# 113 "/home/durga/QCCSDK-QCC74x/components/utils/coredump/coredump.c"
        coredump_flash_disable = 0;
    ...
    int enable_coredump_config = 1;
    int enable_print = enable_coredump_config & 0x1;
    int enable_flash = enable_coredump_config & 0x2;
# 131 "/home/durga/QCCSDK-QCC74x/components/utils/coredump/coredump.c"
    ...
    memcpy(core_build_id, elf_build_id, 20);
