# 1 "/home/durga/QCCSDK-QCC74x/examples/peripherals/gpio/gpio_input_output/main.c"
...
# 2 "/home/durga/QCCSDK-QCC74x/examples/peripherals/gpio/gpio_input_output/main.c" 2
...
# 3 "/home/durga/QCCSDK-QCC74x/examples/peripherals/gpio/gpio_input_output/main.c" 2
...
int main(void)
{
    ...
    printf("gpio output\r\n");
    qcc74x_gpio_init(gpio, 0, (1 << 6) | (1 << (9)) | (1 << (11)) | (0 << (12)));
    qcc74x_gpio_init(gpio, 1, (1 << 5) | (1 << (9)) | (1 << (11)) | (0 << (12)));

    while (1) {
     if((qcc74x_gpio_read(gpio, 1)) == 1)
             {
             qcc74x_gpio_set(gpio, 0);
             }
             else
             {

             qcc74x_gpio_reset(gpio, 0);
             }
# 34 "/home/durga/QCCSDK-QCC74x/examples/peripherals/gpio/gpio_input_output/main.c"
    }
}
