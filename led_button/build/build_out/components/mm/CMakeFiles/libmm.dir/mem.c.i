...
# 25 "/home/durga/QCCSDK-QCC74x/components/mm/mem.c" 2
# 34 "/home/durga/QCCSDK-QCC74x/components/mm/mem.c"
struct mem_heap_s g_kmemheap;
struct mem_heap_s g_pmemheap;
# 55 "/home/durga/QCCSDK-QCC74x/components/mm/mem.c"
void kmem_init(void *heapstart, size_t heapsize)
{
    ;

    qcc74x_mem_init(&g_kmemheap, heapstart, heapsize);
}
# 83 "/home/durga/QCCSDK-QCC74x/components/mm/mem.c"
void *kmalloc(size_t size, int flag)
{
    void *ptr = 
# 85 "/home/durga/QCCSDK-QCC74x/components/mm/mem.c" 3 4
               ((void *)0)
# 85 "/home/durga/QCCSDK-QCC74x/components/mm/mem.c"
                   ;
    struct mem_heap_s *heap = &g_kmemheap;

    ;

    ptr = qcc74x_malloc_align(heap, (flag & (1<<2)) ? 32 : sizeof(void *), size);
...
{
    return kmalloc(xSize, (0<<0));
}
# 113 "/home/durga/QCCSDK-QCC74x/components/mm/mem.c"
void kfree(void *addr)
{
    ;
...
# 139 "/home/durga/QCCSDK-QCC74x/components/mm/mem.c"
void *kcalloc(size_t size, size_t len)
{
    return kmalloc(size * len, (0<<0)|(1<<0));
}
# 154 "/home/durga/QCCSDK-QCC74x/components/mm/mem.c"
void pmem_init(void *heapstart, size_t heapsize)
{
    ;
...
# 175 "/home/durga/QCCSDK-QCC74x/components/mm/mem.c"
void *malloc(size_t size)
{
    ;

    return qcc74x_malloc(&g_kmemheap, size);
}
# 197 "/home/durga/QCCSDK-QCC74x/components/mm/mem.c"
void *realloc(void *old, size_t newlen)
{
    return qcc74x_realloc(&g_kmemheap, old, newlen);
}
# 216 "/home/durga/QCCSDK-QCC74x/components/mm/mem.c"
void *calloc(size_t size, size_t len)
{
    return qcc74x_calloc(&g_kmemheap, size, len);
}
# 234 "/home/durga/QCCSDK-QCC74x/components/mm/mem.c"
void *memalign(size_t align, size_t size)
{
    return qcc74x_malloc_align(&g_kmemheap, align, size);
}
# 248 "/home/durga/QCCSDK-QCC74x/components/mm/mem.c"
void free(void *addr)
{
    ;
...
# 263 "/home/durga/QCCSDK-QCC74x/components/mm/mem.c"
uint32_t kfree_size(void)
{
