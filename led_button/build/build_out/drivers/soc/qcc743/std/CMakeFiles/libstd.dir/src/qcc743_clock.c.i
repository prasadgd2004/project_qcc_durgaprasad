# 1 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_clock.c"
...
# 2 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_clock.c" 2
# 51 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_clock.c"
static inline uint32_t __attribute__((section(".sclock_rlt_code." "./drivers/soc/qcc743/std/src/qcc743_clock.c" "51"))) Clock_Get_WIFI_PLL_Output(uint32_t pllOut)
{
    return pllOut;
}

static uint32_t __attribute__((section(".sclock_rlt_code." "./drivers/soc/qcc743/std/src/qcc743_clock.c" "56"))) Clock_Get_AUPLL_Output(CLOCK_AUPLL_Type clockAupllType)
{
    uint8_t xtalType = 0;
    uint32_t tmpVal = 0;
    uint32_t vcoFreq = 0;
    ...
    tmpVal = ((((*((volatile uint32_t *)(uintptr_t)(((uint32_t)0x20008000) + (0x768)))))&(((1U << (19U)) - 1) << (0U))) >> (0U));
...
static inline uint32_t __attribute__((section(".sclock_rlt_code." "./drivers/soc/qcc743/std/src/qcc743_clock.c" "141"))) Clock_Get_Audio_PLL_Output()
{
    uint32_t tmpVal = 0;

    tmpVal = ((((*((volatile uint32_t *)(uintptr_t)(((uint32_t)0x20008000) + (0x754)))))&(((1U << (7U)) - 1) << (0U))) >> (0U));

    return Clock_Get_AUPLL_Output(CLOCK_AUPLL_DIV1) / tmpVal;
}

static inline uint32_t __attribute__((section(".sclock_rlt_code." "./drivers/soc/qcc743/std/src/qcc743_clock.c" "150"))) Clock_Xtal_Output(void)
{
    uint8_t xtalType = 0;
...
static inline uint32_t __attribute__((section(".sclock_rlt_code." "./drivers/soc/qcc743/std/src/qcc743_clock.c" "178"))) Clock_XClk_Mux_Output(uint8_t sel)
{
    if (sel == 0) {
...
static inline uint32_t __attribute__((section(".sclock_rlt_code." "./drivers/soc/qcc743/std/src/qcc743_clock.c" "191"))) Clock_F32k_Mux_Output(uint8_t sel)
{
    uint32_t tmpVal;
    uint32_t div = 0;

    tmpVal = (*((volatile uint32_t *)(uintptr_t)(((uint32_t)0x20000000) + (0x250))));
    div = (((tmpVal)&(((1U << (11U)) - 1) << (0U))) >> (0U));
    ...
    if (sel == 0 || sel == 2) {
        ...
        if ((((tmpVal)&(((1U << (1U)) - 1) << (12U))) >> (12U)) == 0) {
            return 0;
        } else {
            sel = (((tmpVal)&(((1U << (2U)) - 1) << (28U))) >> (28U));
            if (sel == 0) {
...
static inline uint8_t __attribute__((section(".sclock_rlt_code." "./drivers/soc/qcc743/std/src/qcc743_clock.c" "222"))) Clock_Get_F32k_Sel_Val(void)
{
    uint32_t tmpVal;

    tmpVal = (*((volatile uint32_t *)(uintptr_t)(((uint32_t)0x2000f000) + (0x30))));

    return (((tmpVal)&(((1U << (2U)) - 1) << (3U))) >> (3U));
}

static inline uint32_t __attribute__((section(".sclock_rlt_code." "./drivers/soc/qcc743/std/src/qcc743_clock.c" "231"))) Clock_160M_Clk_Mux_Output(uint8_t sel)
{
    if (sel == 0) {
...
static inline uint8_t __attribute__((section(".sclock_rlt_code." "./drivers/soc/qcc743/std/src/qcc743_clock.c" "250"))) Clock_Get_Muxpll_160M_Sel_Val(void)
{
    uint32_t tmpVal;

    tmpVal = (*((volatile uint32_t *)(uintptr_t)(((uint32_t)0x20000000) + (0x254))));

    return (((tmpVal)&(((1U << (2U)) - 1) << (10U))) >> (10U));
}

static inline uint32_t __attribute__((section(".sclock_rlt_code." "./drivers/soc/qcc743/std/src/qcc743_clock.c" "259"))) Clock_80M_Clk_Mux_Output(uint8_t sel)
{
    if (sel == 0) {
...
static inline uint8_t __attribute__((section(".sclock_rlt_code." "./drivers/soc/qcc743/std/src/qcc743_clock.c" "275"))) Clock_Get_Muxpll_80M_Sel_Val(void)
{
    uint32_t tmpVal;

    tmpVal = (*((volatile uint32_t *)(uintptr_t)(((uint32_t)0x20000000) + (0x254))));

    return (((tmpVal)&(((1U << (2U)) - 1) << (8U))) >> (8U));
}

static inline uint32_t __attribute__((section(".sclock_rlt_code." "./drivers/soc/qcc743/std/src/qcc743_clock.c" "284"))) Clock_MCU_Clk_Mux_Output(uint8_t sel)
{
    if (sel == 0) {
...
static inline uint8_t __attribute__((section(".sclock_rlt_code." "./drivers/soc/qcc743/std/src/qcc743_clock.c" "303"))) Clock_Get_MCU_XClk_Sel_Val(void)
{
    uint32_t tmpVal;

    tmpVal = (*((volatile uint32_t *)(uintptr_t)(((uint32_t)0x2000f000) + (0x30))));
    tmpVal = (((tmpVal)&(((1U << (2U)) - 1) << (0U))) >> (0U));

    return (tmpVal & 0x1);
}

static inline uint8_t __attribute__((section(".sclock_rlt_code." "./drivers/soc/qcc743/std/src/qcc743_clock.c" "313"))) Clock_Get_MCU_Root_Clk_Sel_Val(void)
{
    uint32_t tmpVal;
...
static inline uint32_t __attribute__((section(".sclock_rlt_code." "./drivers/soc/qcc743/std/src/qcc743_clock.c" "323"))) Clock_MCU_Root_Clk_Mux_Output(uint8_t sel)
{
    uint32_t tmpVal;
...
static inline uint8_t __attribute__((section(".sclock_rlt_code." "./drivers/soc/qcc743/std/src/qcc743_clock.c" "340"))) Clock_Get_MCU_HClk_Div_Val(void)
{
    uint32_t tmpVal;
...
static inline uint8_t __attribute__((section(".sclock_rlt_code." "./drivers/soc/qcc743/std/src/qcc743_clock.c" "349"))) Clock_Get_Peri_BClk_Div_Val(void)
{
    uint32_t tmpVal;
...
# 366 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_clock.c"
uint32_t __attribute__((section(".sclock_rlt_code." "./drivers/soc/qcc743/std/src/qcc743_clock.c" "366"))) Clock_System_Clock_Get(QCC74x_System_Clock_Type type)
{
    uint32_t clock = 0;
    uint32_t div = 0;

    switch (type) {
        case QCC74x_SYSTEM_CLOCK_MCU_ROOT_CLK:

            return Clock_MCU_Root_Clk_Mux_Output(Clock_Get_MCU_Root_Clk_Sel_Val());

        case QCC74x_SYSTEM_CLOCK_MCU_CLK:

            clock = Clock_MCU_Root_Clk_Mux_Output(Clock_Get_MCU_Root_Clk_Sel_Val());
            div = Clock_Get_MCU_HClk_Div_Val();
            return clock / (div + 1);

        case QCC74x_SYSTEM_CLOCK_MCU_PBCLK:

            clock = Clock_System_Clock_Get(QCC74x_SYSTEM_CLOCK_MCU_CLK);
            div = Clock_Get_Peri_BClk_Div_Val();
            return clock / (div + 1);

        case QCC74x_SYSTEM_CLOCK_F32K:

            return Clock_F32k_Mux_Output(Clock_Get_F32k_Sel_Val());

        case QCC74x_SYSTEM_CLOCK_XCLK:

            return Clock_XClk_Mux_Output(Clock_Get_MCU_XClk_Sel_Val());

        case QCC74x_SYSTEM_CLOCK_XTAL:
...
static inline uint8_t Clock_Get_UART_Clk_Sel_Val(void)
{
    ...
    tmpVal = (*((volatile uint32_t *)(uintptr_t)(((uint32_t)0x20000000) + (0x150))));

    return (((((tmpVal)&(((1U << (1U)) - 1) << (22U))) >> (22U)) << 1) | (((tmpVal)&(((1U << (1U)) - 1) << (7U))) >> (7U)));
}
...
static inline uint8_t Clock_Get_PKA_Clk_Sel_Val(void)
{
    ...
    tmpVal = (*((volatile uint32_t *)(uintptr_t)(((uint32_t)0x20000000) + (0x548))));

    return (((tmpVal)&(((1U << (1U)) - 1) << (24U))) >> (24U));
}
...
static inline uint8_t Clock_Get_SF_Clk_Sel2_Val(void)
{
    ...
    tmpVal = (*((volatile uint32_t *)(uintptr_t)(((uint32_t)0x20000000) + (0x170))));

    return (((tmpVal)&(((1U << (2U)) - 1) << (14U))) >> (14U));
}
...
static inline uint8_t Clock_Get_I2S_Div_Val(void)
{
    ...
    tmpVal = (*((volatile uint32_t *)(uintptr_t)(((uint32_t)0x20000000) + (0x190))));
...
# 877 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_clock.c"
uint32_t Clock_Audio_ADC_Clock_Get(void)
{
    uint32_t clock = 0;
    uint32_t div = 0;
...
# 895 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_clock.c"
static inline uint32_t Clock_RTC_Clock_Get(void)
{
    return 32768;
}
# 909 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_clock.c"
uint32_t Clock_Peripheral_Clock_Get(QCC74x_Peripheral_Type type)
{
    uint32_t clock = 0;
    uint32_t div = 0;
...
# 1029 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_clock.c"
uint32_t __attribute__((section(".sclock_rlt_code." "./drivers/soc/qcc743/std/src/qcc743_clock.c" "1029"))) SystemCoreClockGet(void)
{
    uint32_t clockVal = 0;

    switch (GLB_Get_Core_Type()) {
        case (0):
            clockVal = Clock_System_Clock_Get(QCC74x_SYSTEM_CLOCK_MCU_CLK);
            break;
        default:
            clockVal = 0;
            break;
...
# 1054 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_clock.c"
QCC74x_Err_Type __attribute__((section(".sclock_rlt_code." "./drivers/soc/qcc743/std/src/qcc743_clock.c" "1054"))) CPU_Set_MTimer_RST(uint8_t rstEn)
{
    uint32_t tmpVal = 0;
    uint32_t address = 0;
    ...
    switch (GLB_Get_Core_Type()) {
        case (0):
            address = ((uint32_t)0x20009000) + (0x14);
            break;
        default:
            address = ((uint32_t)0x20009000) + (0x14);
            break;
    ...
    tmpVal = (*((volatile uint32_t *)(uintptr_t)(address)));
    if (rstEn) {
        tmpVal = ((tmpVal) | (1U << (30U)));
    } else {
        tmpVal = ((tmpVal)&(~(((1U << (1U)) - 1) << (30U))));
    }
    ((*(volatile uint32_t *)(uintptr_t)(address)) = (tmpVal));

    return SUCCESS;
}
# 1091 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_clock.c"
QCC74x_Err_Type __attribute__((section(".sclock_rlt_code." "./drivers/soc/qcc743/std/src/qcc743_clock.c" "1091"))) CPU_Reset_MTimer(void)
{
...
# 1109 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_clock.c"
QCC74x_Err_Type __attribute__((section(".sclock_rlt_code." "./drivers/soc/qcc743/std/src/qcc743_clock.c" "1109"))) CPU_Set_MTimer_CLK(uint8_t enable, QCC74x_MTimer_Source_Clock_Type mTimerSourceClockType, uint16_t div)
{
    uint32_t tmpVal = 0;
    uint32_t address = 0;
    ...
    tmpVal = (*((volatile uint32_t *)(uintptr_t)(address)));
    tmpVal = (((tmpVal)&(~(((1U << (1U)) - 1) << (29U)))) | ((uint32_t)(mTimerSourceClockType) << (29U)));
    ((*(volatile uint32_t *)(uintptr_t)(address)) = (tmpVal));
    ...
    tmpVal = (*((volatile uint32_t *)(uintptr_t)(address)));
    tmpVal = (((tmpVal)&(~(((1U << (10U)) - 1) << (0U)))) | ((uint32_t)(div) << (0U)));
    ((*(volatile uint32_t *)(uintptr_t)(address)) = (tmpVal));
...
# 1162 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_clock.c"
uint32_t __attribute__((section(".sclock_rlt_code." "./drivers/soc/qcc743/std/src/qcc743_clock.c" "1162"))) CPU_Get_MTimer_Source_Clock(void)
{
    uint32_t coreFreq = 0;
    uint32_t tmpVal = 0;

    tmpVal = (*((volatile uint32_t *)(uintptr_t)(((uint32_t)0x20009000) + (0x14))));
    tmpVal = (((tmpVal)&(((1U << (1U)) - 1) << (29U))) >> (29U));


    switch (GLB_Get_Core_Type()) {
        case (0):
            if (tmpVal == QCC74x_MTIMER_SOURCE_CLOCK_MCU_XCLK) {
                coreFreq = Clock_System_Clock_Get(QCC74x_SYSTEM_CLOCK_XCLK);
            } else {
                coreFreq = Clock_System_Clock_Get(QCC74x_SYSTEM_CLOCK_MCU_CLK);
            }
            break;
        default:
            coreFreq = 0;
...
# 1196 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_clock.c"
uint32_t __attribute__((section(".sclock_rlt_code." "./drivers/soc/qcc743/std/src/qcc743_clock.c" "1196"))) CPU_Get_MTimer_Clock(void)
{
    uint32_t coreFreq = 0;
    uint32_t address = 0;
    uint32_t div = 0;
    ...
    div = ((((*((volatile uint32_t *)(uintptr_t)(address))))&(((1U << (10U)) - 1) << (0U))) >> (0U));
    div += 1;
    coreFreq = coreFreq ? coreFreq : (32 * 1000 * 1000);
    coreFreq = coreFreq / div;

    return coreFreq;
}
# 1241 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_clock.c"
uint64_t __attribute__((section(".sclock_rlt_code." "./drivers/soc/qcc743/std/src/qcc743_clock.c" "1241"))) CPU_Get_MTimer_Counter(void)
{
...
# 1268 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_clock.c"
uint64_t __attribute__((section(".sclock_rlt_code." "./drivers/soc/qcc743/std/src/qcc743_clock.c" "1268"))) CPU_Get_CPU_Cycle(void)
{
...
# 1299 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_clock.c"
uint64_t __attribute__((section(".sclock_rlt_code." "./drivers/soc/qcc743/std/src/qcc743_clock.c" "1299"))) CPU_Get_MTimer_US(void)
{
...
# 1323 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_clock.c"
uint64_t __attribute__((section(".sclock_rlt_code." "./drivers/soc/qcc743/std/src/qcc743_clock.c" "1323"))) CPU_Get_MTimer_MS(void)
{
    uint32_t clk = CPU_Get_MTimer_Clock();
    uint64_t mtimer_counter = CPU_Get_MTimer_Counter();
    if (mtimer_counter == 0) {
...
# 1343 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_clock.c"
QCC74x_Err_Type __attribute__((section(".sclock_rlt_code." "./drivers/soc/qcc743/std/src/qcc743_clock.c" "1343"))) CPU_MTimer_Delay_US(uint32_t cnt)
{
...
# 1364 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_clock.c"
QCC74x_Err_Type __attribute__((section(".sclock_rlt_code." "./drivers/soc/qcc743/std/src/qcc743_clock.c" "1364"))) CPU_MTimer_Delay_MS(uint32_t cnt)
{
