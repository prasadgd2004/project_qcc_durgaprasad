# 1 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/startup/interrupt.c"
...
# 2 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/startup/interrupt.c" 2
...
# 3 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/startup/interrupt.c" 2
# 1 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/startup/irq_ctx.h" 1
# 370 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/startup/irq_ctx.h"
    extern void riscv_savefpu(uintptr_t *regs);
    extern void riscv_restorefpu(uintptr_t *regs);
# 4 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/startup/interrupt.c" 2

typedef void (*pFunc)(void);

struct qcc74x_irq_info_s g_irqvector[80];

extern void default_trap_handler(void);
extern void default_interrupt_handler(void);
# 97 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/startup/interrupt.c"
void exception_entry(uintptr_t *regs)
{
    ...
    cause = ({ unsigned long tmp; asm volatile("csrr %0, " "0x342" : "=r"(tmp)); tmp; });
    printf("mcause=%08x\r\n", (int)cause);
    epc = ({ unsigned long tmp; asm volatile("csrr %0, " "0x341" : "=r"(tmp)); tmp; });
    printf("mepc:%08x\r\n", (int)epc);
    tval = ({ unsigned long tmp; asm volatile("csrr %0, " "0x343" : "=r"(tmp)); tmp; });
    printf("mtval:%08x\r\n", (int)tval);
    ...
    if ((cause == 8) || (cause == 11)) {
        epc += 4;
        ({ asm volatile("csrw " "0x341" ", %0" :: "rK"(epc)); });
    } else {
        while (1) {
...
void interrupt_entry(void)
{
    ...
    mcause = ({ unsigned long tmp; asm volatile("csrr %0, " "0x342" : "=r"(tmp)); tmp; });
