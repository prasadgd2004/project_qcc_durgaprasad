# 1 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_sec_dbg.c"
# 1 "/home/durga/QCCSDK-QCC74x/examples/peripherals/gpio/gpio_input_output/build/build_out/drivers/soc/qcc743/std//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_sec_dbg.c"
# 1 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/include/qcc743_sec_dbg.h" 1



# 1 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/include/hardware/sec_dbg_reg.h" 1
...
# 5 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/include/hardware/sec_dbg_reg.h" 2
# 100 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/include/hardware/sec_dbg_reg.h"
struct sec_dbg_reg {

    union {
        struct {
            uint32_t sd_chip_id_low : 32;
        } BF;
        uint32_t WORD;
    } sd_chip_id_low;
    ...
    union {
        struct {
            uint32_t sd_dbg_pwd_busy : 1;
            uint32_t sd_dbg_pwd_trig : 1;
            uint32_t sd_dbg_cci_read_en : 1;
            uint32_t sd_dbg_cci_clk_sel : 1;
            uint32_t sd_dbg_pwd_cnt : 20;
            uint32_t sd_dbg_mode : 4;
            uint32_t sd_dbg_ena : 4;
        } BF;
        uint32_t WORD;
    } sd_status;
...
# 5 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/include/qcc743_sec_dbg.h" 2
...
# 6 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/include/qcc743_sec_dbg.h" 2
# 52 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/include/qcc743_sec_dbg.h"
...
# 2 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_sec_dbg.c" 2
# 53 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_sec_dbg.c"
void Sec_Dbg_Read_Chip_ID(uint8_t id[8])
{
    uint32_t idLow, idHigh;

    idLow = (*((volatile uint32_t *)(uintptr_t)(((uint32_t)0x20003000) + (0x0))));
    { id[0] = idLow & 0xff; id[1] = (idLow >> 8) & 0xff; id[2] = (idLow >> 16) & 0xff; id[3] = (idLow >> 24) & 0xff; };

    idHigh = (*((volatile uint32_t *)(uintptr_t)(((uint32_t)0x20003000) + (0x4))));
    { (id + 4)[0] = idHigh & 0xff; (id + 4)[1] = (idHigh >> 8) & 0xff; (id + 4)[2] = (idHigh >> 16) & 0xff; (id + 4)[3] = (idHigh >> 24) & 0xff; };
}
# 72 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_sec_dbg.c"
uint32_t Sec_Dbg_Read_Dbg_State(void)
{
    uint32_t ret;
    uint32_t mode = 0;
    ...
    mode = ((((*((volatile uint32_t *)(uintptr_t)(((uint32_t)0x20003000) + (0x18)))))&(((1U << (4U)) - 1) << (24U))) >> (24U));
    ena = ((((*((volatile uint32_t *)(uintptr_t)(((uint32_t)0x20003000) + (0x18)))))&(((1U << (4U)) - 1) << (28U))) >> (28U));
...
# 104 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_sec_dbg.c"
uint32_t Sec_Dbg_Read_Dbg_Mode(void)
{
    return ((((*((volatile uint32_t *)(uintptr_t)(((uint32_t)0x20003000) + (0x18)))))&(((1U << (4U)) - 1) << (24U))) >> (24U));
}
# 117 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_sec_dbg.c"
uint32_t Sec_Dbg_Read_Dbg_Enable(void)
{
    return ((((*((volatile uint32_t *)(uintptr_t)(((uint32_t)0x20003000) + (0x18)))))&(((1U << (4U)) - 1) << (28U))) >> (28U));
}
# 130 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_sec_dbg.c"
void Sec_Dbg_Set_Dbg_Pwd(const uint32_t pwd[4])
{
    ((*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x20003000) + (0x8))) = (pwd[0]));
    ((*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x20003000) + (0xC))) = (pwd[1]));
    ((*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x20003000) + (0x10))) = (pwd[2]));
    ((*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x20003000) + (0x14))) = (pwd[3]));
}
# 146 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_sec_dbg.c"
void Sec_Dbg_Set_Dbg_Trigger(void)
{
    uint32_t tmpVal;
    tmpVal = (*((volatile uint32_t *)(uintptr_t)(((uint32_t)0x20003000) + (0x18))));
    tmpVal = ((tmpVal) | (1U << (1U)));
    ((*(volatile uint32_t *)(uintptr_t)(((uint32_t)0x20003000) + (0x18))) = (tmpVal));
}
# 162 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/src/qcc743_sec_dbg.c"
uint32_t Sec_Dbg_Wait_Ready(void)
{
    uint32_t cnt = 1024;
    uint32_t busy;
    ...
    do{
        busy = ((((*((volatile uint32_t *)(uintptr_t)(((uint32_t)0x20003000) + (0x18)))))&(((1U << (1U)) - 1) << (0U))) >> (0U));
    }while((busy) && (cnt--));
