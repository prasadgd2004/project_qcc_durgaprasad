# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_flash.c"
...
# 9 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_flash.c" 2
...
# 10 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_flash.c" 2
# 1 "/home/durga/QCCSDK-QCC74x/drivers/soc/qcc743/std/include/qcc743_ef_cfg.h" 1
# 11 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_flash.c" 2
# 37 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_flash.c"
...
# 38 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_flash.c" 2
...
# 41 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_flash.c" 2
# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/hardware/sf_ctrl_reg.h" 1
# 42 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_flash.c" 2
...
int qcc74x_efuse_write_lock_usb_pid_vid(void);
# 43 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_flash.c" 2
...
static uint32_t __attribute__((section(".tcm_code." "./drivers/lhal/src/qcc74x_flash.c" "271"))) flash_get_size_from_jedecid(uint32_t jedec_id)
{
...
static int flash_get_clock_delay(spi_flash_cfg_type *cfg)
{
    ...
    if (regval & (1<<11U)) {
        cfg->clk_delay = ((regval & (0x7<<(8U))) >> (8U)) + 1;
    } else {
        cfg->clk_delay = 0;
    }
    cfg->clk_invert = 0;

    cfg->clk_invert |= (((regval & (1<<4U)) ? 1 : 0) << 0);

    cfg->clk_invert |= (((regval & (1<<2U)) ? 1 : 0) << 1);

    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x34)));

    cfg->clk_delay |= (((regval & (0x3<<(16U))) >> (16U)) << 4);

    cfg->clk_invert |= (((regval & (0x3<<(8U))) >> (8U)) << 2);

    cfg->clk_invert |= (((regval & (0x3<<(0U))) >> (0U)) << 5);

    return 0;
}


static void __attribute__((section(".tcm_code." "./drivers/lhal/src/qcc74x_flash.c" "323"))) flash_set_qspi_enable(spi_flash_cfg_type *p_flash_cfg)
{
...
static void __attribute__((section(".tcm_code." "./drivers/lhal/src/qcc74x_flash.c" "330"))) flash_set_l1c_wrap(spi_flash_cfg_type *p_flash_cfg)
{
    if ((p_flash_cfg->io_mode & 0x1f) == 4) {
...
static void __attribute__((section(".tcm_code." "./drivers/lhal/src/qcc74x_flash.c" "350"))) qcc74x_flash_set_cmds(spi_flash_cfg_type *p_flash_cfg)
{
...
static int __attribute__((section(".tcm_code." "./drivers/lhal/src/qcc74x_flash.c" "373"))) flash_config_init(spi_flash_cfg_type *p_flash_cfg, uint8_t *jedec_id)
{
    int ret = -1;
    ...
    if (jid == 0x1660EF) {
        p_flash_cfg->io_mode = 4;
        p_flash_cfg->c_read_support = 0x00;
    }
# 408 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_flash.c"
...
static int __attribute__((section(".tcm_code." "./drivers/lhal/src/qcc74x_flash.c" "429"))) flash2_init(void)
{
    int stat = -1;
    ...
    if (flash2_enable > 0) {
        qcc74x_sf_cfg_sbus2_flash_init(0x34, &sf_bank2_cfg);
        qcc74x_sf_ctrl_sbus2_replace(1);
        ret = qcc74x_sf_cfg_flash_identify_ext(0, 0x34, 0, &g_flash2_cfg, 0, 1);
        if ((ret & 0x80000000) == 0) {
            return -1;
        }
        ...
        qcc74x_sf_ctrl_cmds_set(&cmds_cfg, 1);
        stat = qcc74x_sflash_xip_read_enable(&g_flash2_cfg, (g_flash2_cfg.io_mode & 0xf), 0, 1);
        if (0 != stat) {
            return -1;
        }
...
int __attribute__((section(".tcm_code." "./drivers/lhal/src/qcc74x_flash.c" "496"))) qcc74x_flash_init(void)
{
    int ret = -1;
    uint32_t jedec_id = 0;
# 510 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_flash.c"
    qcc74x_efuse_get_device_info(&device_info);
# 548 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_flash.c"
...
void __attribute__((section(".tcm_code." "./drivers/lhal/src/qcc74x_flash.c" "614"))) qcc74x_flash_get_cfg(uint8_t **cfg_addr, uint32_t *len)
{
    *cfg_addr = (uint8_t *)&g_flash_cfg;
    *len = sizeof(spi_flash_cfg_type);
}

void __attribute__((section(".tcm_code." "./drivers/lhal/src/qcc74x_flash.c" "620"))) qcc74x_flash_set_iomode(uint8_t iomode)
{
    uintptr_t flag = 0;
    uint8_t is_aes_enable = 0;
    uint32_t offset = 0;
...
__attribute__((section(".tcm_code." "./drivers/lhal/src/qcc74x_flash.c" "652"))) uint32_t qcc74x_flash_get_image_offset(void)
{
    return qcc74x_sf_ctrl_get_flash_image_offset(0, 0);
}
# 664 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_flash.c"
int __attribute__((section(".tcm_code." "./drivers/lhal/src/qcc74x_flash.c" "664"))) qcc74x_flash_erase(uint32_t startaddr, uint32_t len)
{
    int stat = -1;
    uintptr_t flag;
    ...
    if ((startaddr + len) > (flash1_size + flash2_size)) {
        return -
# 671 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_flash.c" 3
               12
# 671 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_flash.c"
                     ;
...
# 714 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_flash.c"
    return stat;
}
# 725 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_flash.c"
int __attribute__((section(".tcm_code." "./drivers/lhal/src/qcc74x_flash.c" "725"))) qcc74x_flash_write(uint32_t addr, uint8_t *data, uint32_t len)
{
    int stat = -1;
    uintptr_t flag;
    ...
    if ((addr + len) > (flash1_size + flash2_size)) {
        return -
# 732 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_flash.c" 3
               12
# 732 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_flash.c"
                     ;
        ...
        qcc74x_sf_ctrl_sbus2_replace(1);
        stat = qcc74x_sflash_program(&g_flash2_cfg, 1, addr, data, len);
        qcc74x_sf_ctrl_sbus2_revoke_replace();
    } else {
        flag = qcc74x_irq_save();
        ...
        qcc74x_sf_ctrl_sbus2_replace(1);
        stat = qcc74x_sflash_program(&g_flash2_cfg, 1, flash1_size, data + (flash1_size - addr), addr + len - flash1_size);
        qcc74x_sf_ctrl_sbus2_revoke_replace();
    }
# 775 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_flash.c"
    return stat;
}
# 786 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_flash.c"
int __attribute__((section(".tcm_code." "./drivers/lhal/src/qcc74x_flash.c" "786"))) qcc74x_flash_read(uint32_t addr, uint8_t *data, uint32_t len)
{
    int stat = -1;
    uintptr_t flag;
    ...
    if ((addr + len) > (flash1_size + flash2_size)) {
        return -
# 793 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_flash.c" 3
               12
# 793 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_flash.c"
                     ;
    } else if ((addr + len) <= flash1_size) {
        flag = qcc74x_irq_save();
        ...
        qcc74x_sf_ctrl_sbus2_replace(1);
        stat = qcc74x_sflash_read(&g_flash2_cfg, 1, 0, addr, data, len);
        qcc74x_sf_ctrl_sbus2_revoke_replace();
    } else {
        flag = qcc74x_irq_save();
        ...
        qcc74x_sf_ctrl_sbus2_replace(1);
        stat = qcc74x_sflash_read(&g_flash2_cfg, 1, 0, flash1_size, data + (flash1_size - addr), addr + len - flash1_size);
        qcc74x_sf_ctrl_sbus2_revoke_replace();
    }
# 836 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_flash.c"
    return stat;
}
# 846 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_flash.c"
int __attribute__((section(".tcm_code." "./drivers/lhal/src/qcc74x_flash.c" "846"))) qcc74x_flash_get_unique_id(uint8_t *data, uint8_t id_len)
{
    int stat = -1;
    uintptr_t flag;
...
int __attribute__((section(".tcm_code." "./drivers/lhal/src/qcc74x_flash.c" "858"))) qcc74x_flash_set_cache(uint8_t cont_read, uint8_t cache_enable, uint8_t cache_way_disable, uint32_t flash_offset)
{
    uint8_t is_aes_enable = 0;
    uint32_t tmp[1];
    int stat;
...
# 900 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_flash.c"
...
void __attribute__((section(".tcm_code." "./drivers/lhal/src/qcc74x_flash.c" "909"))) qcc74x_flash_aes_init(struct qcc74x_flash_aes_config_s *config)
{
    uint8_t hw_key_enable = 0;

    if (config->key == 
# 913 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_flash.c" 3 4
                      ((void *)0)
# 913 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_flash.c"
                          ) {
        hw_key_enable = 1;
    }
...
void __attribute__((section(".tcm_code." "./drivers/lhal/src/qcc74x_flash.c" "922"))) qcc74x_flash_aes_enable(void)
{
    qcc74x_sf_ctrl_aes_enable_be();
    qcc74x_sf_ctrl_aes_enable();
}

void __attribute__((section(".tcm_code." "./drivers/lhal/src/qcc74x_flash.c" "928"))) qcc74x_flash_aes_disable(void)
{
    qcc74x_sf_ctrl_aes_disable();
}

void __attribute__((section(".tcm_code." "./drivers/lhal/src/qcc74x_flash.c" "933"))) qcc74x_flash_jump_encrypted_app(uint8_t index, uint32_t flash_addr, uint32_t len)
{
    void (*entry)(void);

    qcc74x_sf_ctrl_aes_set_region_offset(index, flash_addr);

    qcc74x_sf_ctrl_aes_set_region(index, 1 , 1 ,
                                flash_addr,
                                flash_addr + len - 1,
                                0 );
