# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_rtc.c"
...
# 5 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_rtc.h" 2
...
# 2 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_rtc.c" 2
# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/hardware/rtc_reg.h" 1
# 3 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_rtc.c" 2
# 12 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_rtc.c"
void qcc74x_rtc_disable(struct qcc74x_device_s *dev)
{
...
void qcc74x_rtc_set_time(struct qcc74x_device_s *dev, uint64_t time)
{
    ...
    rtc_cnt = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x10))) & 0xff;
    rtc_cnt <<= 32;
    rtc_cnt |= (*(volatile uint32_t *)(uintptr_t)(reg_base + (0xC)));
    ...
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x4)) = ((uint32_t)rtc_cnt));
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x8)) = ((uint32_t)(rtc_cnt >> 32) & 0xff));
...
uint64_t qcc74x_rtc_get_time(struct qcc74x_device_s *dev)
{
    ...
    time_l = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0xC)));
    time_h = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x10))) & 0xff;
...
static struct qcc74x_tm *__gmtime_r(const time_t *timer, struct qcc74x_tm *result)
{
    time_t epoch;
    time_t jdn;
    int year;
    ...
    jdn = epoch / ((time_t)24 * ((time_t)60 * ((time_t)60)));
    epoch -= ((time_t)24 * ((time_t)60 * ((time_t)60))) * jdn;

    hour = epoch / ((time_t)60 * ((time_t)60));
    epoch -= ((time_t)60 * ((time_t)60)) * hour;
...
static time_t __mktime(struct qcc74x_tm *tp)
{
    time_t ret;
    time_t jdn;
...
uint64_t qcc74x_rtc_get_delta_counter(uint64_t ref_cnt)
{
    ...
    cnt = qcc74x_rtc_get_time(
# 350 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_rtc.c" 3 4
                             ((void *)0)
# 350 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_rtc.c"
                                 );
    ref_cnt &= (0x000000FFFFFFFFFFllu);

    if (cnt < ref_cnt) {
        cnt += (0x000000FFFFFFFFFFllu) + 1;
    }

    return cnt - ref_cnt;
}

uint64_t qcc74x_rtc_get_delta_time_ms(uint64_t ref_cnt)
{
    uint64_t cnt;

    cnt = qcc74x_rtc_get_delta_counter(ref_cnt);

    return ((uint64_t)(cnt) * 1000 / 32768);
}

static volatile struct qcc74x_tm g_rtc_tm;
static volatile uint64_t s_rtc_ref_cnt = 0;

void qcc74x_rtc_set_utc_time(const struct qcc74x_tm *time)
{
    arch_memcpy((void *)&g_rtc_tm, time, sizeof(struct qcc74x_tm));
    s_rtc_ref_cnt = qcc74x_rtc_get_time(
# 375 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_rtc.c" 3 4
                                       ((void *)0)
# 375 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_rtc.c"
                                           );
}
