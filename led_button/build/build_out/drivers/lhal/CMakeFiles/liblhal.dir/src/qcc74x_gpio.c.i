# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_gpio.c"
...
# 2 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_gpio.c" 2
# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/hardware/gpio_reg.h" 1
# 3 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_gpio.c" 2

struct qcc74x_gpio_irq_callback {
...
# 21 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_gpio.c"
extern void qcc74x_gpio_pad_check(uint8_t pin);
...
void qcc74x_gpio_init(struct qcc74x_device_s *dev, uint8_t pin, uint32_t cfgset)
{
    ...
    function = (cfgset & (0x1f << (0))) >> (0);
    mode = (cfgset & (0xf << (5)));
    drive = (cfgset & (3 << (12))) >> (12);
...
# 174 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_gpio.c"
    cfg_address = reg_base + (0x8C4) + (pin << 2);
    cfg = 0;
    cfg |= (1<<22U);
    ...
    (*(volatile uint32_t *)(uintptr_t)(cfg_address) = (cfg));
...
void qcc74x_gpio_deinit(struct qcc74x_device_s *dev, uint8_t pin)
{
    ...
    qcc74x_gpio_init(dev, pin, (1 << 5) | (0 << (9)));
...
void qcc74x_gpio_pin0_31_output(struct qcc74x_device_s *dev, uint32_t value)
{
    ...
    (*(volatile uint32_t *)(uintptr_t)(dev->reg_base + (0xAE4)) = (value));
...
void qcc74x_gpio_pin32_63_output(struct qcc74x_device_s *dev, uint32_t value)
{
    ...
    (*(volatile uint32_t *)(uintptr_t)(dev->reg_base + (0xAE8)) = (value));
...
void qcc74x_gpio_set(struct qcc74x_device_s *dev, uint8_t pin)
{
# 279 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_gpio.c"
    qcc74x_gpio_pad_check(pin);

    (*(volatile uint32_t *)(uintptr_t)(dev->reg_base + (0xAEC) + ((pin >> 5) << 2)) = (1 << (pin & 0x1f)));
...
void qcc74x_gpio_pin0_31_set(struct qcc74x_device_s *dev, uint32_t value)
{
# 296 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_gpio.c"
    uint32_t pin;
    for (pin = 0; pin < 32; pin++) {
        if (value & (1 << pin)) {
            qcc74x_gpio_pad_check(pin);
    ...
    (*(volatile uint32_t *)(uintptr_t)(dev->reg_base + (0xAEC)) = (value));
...
void qcc74x_gpio_pin32_63_set(struct qcc74x_device_s *dev, uint32_t value)
{
    ...
    for (pin = 0; pin < 32; pin++) {
        if (value & (1 << pin)) {
            qcc74x_gpio_pad_check(pin + 32);
        }
    }

    (*(volatile uint32_t *)(uintptr_t)(dev->reg_base + (0xAF0)) = (value));
...
void qcc74x_gpio_reset(struct qcc74x_device_s *dev, uint8_t pin)
{
# 339 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_gpio.c"
    qcc74x_gpio_pad_check(pin);

    (*(volatile uint32_t *)(uintptr_t)(dev->reg_base + (0xAF4) + ((pin >> 5) << 2)) = (1 << (pin & 0x1f)));
...
void qcc74x_gpio_pin0_31_reset(struct qcc74x_device_s *dev, uint32_t value)
{
# 356 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_gpio.c"
    uint32_t pin;
    for (pin = 0; pin < 32; pin++) {
        if (value & (1 << pin)) {
            qcc74x_gpio_pad_check(pin);
    ...
    (*(volatile uint32_t *)(uintptr_t)(dev->reg_base + (0xAF4)) = (value));
...
void qcc74x_gpio_pin32_63_reset(struct qcc74x_device_s *dev, uint32_t value)
{
    ...
    (*(volatile uint32_t *)(uintptr_t)(dev->reg_base + (0xAF8)) = (value));

}



# 387 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_gpio.c" 3 4
_Bool 
# 387 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_gpio.c"
    qcc74x_gpio_read(struct qcc74x_device_s *dev, uint8_t pin)
{
    ...
    return ((*(volatile uint32_t *)(uintptr_t)(dev->reg_base + (0x8C4) + (pin << 2))) & (1<<28U));
...
uint32_t qcc74x_gpio_pin0_31_read(struct qcc74x_device_s *dev)
{
    ...
    return ((*(volatile uint32_t *)(uintptr_t)(dev->reg_base + (0xAC4))));
...
uint32_t qcc74x_gpio_pin32_63_read(struct qcc74x_device_s *dev)
{
    ...
    return ((*(volatile uint32_t *)(uintptr_t)(dev->reg_base + (0xAC8))));
...
void qcc74x_gpio_int_init(struct qcc74x_device_s *dev, uint8_t pin, uint8_t trig_mode)
{
    ...
    qcc74x_gpio_int_mask(dev, pin, 
# 438 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_gpio.c" 3 4
                                  1
# 438 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_gpio.c"
                                      );
    qcc74x_gpio_int_clear(dev, pin);
# 452 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_gpio.c"
    cfg_address = reg_base + (0x8C4) + (pin << 2);
    regval = (*(volatile uint32_t *)(uintptr_t)(cfg_address));
    regval &= ~(0xf<<(16U));
    regval |= (trig_mode << (16U));

    (*(volatile uint32_t *)(uintptr_t)(cfg_address) = (regval));

}

void qcc74x_gpio_int_mask(struct qcc74x_device_s *dev, uint8_t pin, 
# 461 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_gpio.c" 3 4
                                                                   _Bool 
# 461 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_gpio.c"
                                                                        mask)
{
    ...
    reg_base = dev->reg_base;
# 481 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_gpio.c"
    cfg_address = reg_base + (0x8C4) + (pin << 2);
...
# 494 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_gpio.c" 3 4
_Bool 
# 494 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_gpio.c"
    qcc74x_gpio_get_intstatus(struct qcc74x_device_s *dev, uint8_t pin)
{
    ...
    return ((*(volatile uint32_t *)(uintptr_t)(dev->reg_base + (0x8C4) + (pin << 2))) & (1<<21U));
...
uint32_t qcc74x_gpio_get_intstatus_pin0_31(struct qcc74x_device_s *dev)
{
    ...
    for (index = 0; index < pin_count; index++) {
        if (((*(volatile uint32_t *)(uintptr_t)(dev->reg_base + (0x8C4) + (index << 2))) & (1<<21U))) {
            status |= (1 << index);
        }
    }
    return status;
...
uint32_t qcc74x_gpio_get_intstatus_pin32_63(struct qcc74x_device_s *dev)
{
    ...
    for (index = 0; index < pin_count; index++) {
        if (((*(volatile uint32_t *)(uintptr_t)(dev->reg_base + (0x8C4) + ((index + 32) << 2))) & (1<<21U))) {
            status |= (1 << index);
        }
    }
    return status;
...
void qcc74x_gpio_int_clear(struct qcc74x_device_s *dev, uint8_t pin)
{
    ...
    reg_base = dev->reg_base;
# 576 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_gpio.c"
    cfg_address = reg_base + (0x8C4) + (pin << 2);
...
void qcc74x_gpio_int_clear_pin0_31(struct qcc74x_device_s *dev, uint32_t pins)
{
    ...
    reg_base = dev->reg_base;
# 606 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_gpio.c"
...
void qcc74x_gpio_int_clear_pin32_63(struct qcc74x_device_s *dev, uint32_t pins)
{
    ...
    for (int pin = 0; pin < 32; pin++) {
        if (pins & (1 << pin)) {
            cfg_address = reg_base + (0x8C4) + ((pin + 32) << 2);
            regval = (*(volatile uint32_t *)(uintptr_t)(cfg_address));
            regval |= (1<<20U);
            (*(volatile uint32_t *)(uintptr_t)(cfg_address) = (regval));
            regval &= ~(1<<20U);
...
void qcc74x_gpio_uart_init(struct qcc74x_device_s *dev, uint8_t pin, uint8_t uart_func)
{
    ...
    qcc74x_gpio_pad_check(pin);
# 704 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_gpio.c"
    uint32_t regval2;
    sig = pin % 12;
    ...
    if (sig < 8) {
        ...
        regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x154)));
        regval &= (~(0x0f << sig_pos));
        ...
        regval2 = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x158)));
        ...
        (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x154)) = (regval));
        (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x158)) = (regval2));
    } else {
        sig_pos = (sig - 8) << 2;

        regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x158)));
        regval &= (~(0x0f << sig_pos));
        regval |= (uart_func << sig_pos);
        ...
        regval2 = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x154)));
        ...
        (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x158)) = (regval));
        (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x154)) = (regval2));
    }

    qcc74x_gpio_init(dev, pin, (7 << (0)) | (1 << 8) | (1 << (9)) | (1 << (11)) | (1 << (12)));
...
int qcc74x_gpio_feature_control(struct qcc74x_device_s *dev, int cmd, size_t arg)
{
    ...
    switch (cmd) {
        case (0x01):
# 789 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_gpio.c"
            regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x8C4) + (pin << 2))) & (0x1f<<(8U));
            regval >>= (8U);

            return regval;
        default:
            ret = -
# 794 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_gpio.c" 3
                  1
# 794 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_gpio.c"
                       ;
            break;
    }
    return ret;
...
struct qcc74x_device_s *g_gpio_int = 
# 801 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_gpio.c" 3 4
                                    ((void *)0)
# 801 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_gpio.c"
                                        ;
...
void gpio_all_isr(int irq, void *arg)
{
    ...
    if (
# 807 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_gpio.c" 3 4
       ((void *)0) 
# 807 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_gpio.c"
            == g_gpio_int) {
        snprintf(log_buf, sizeof(log_buf), "GPIO interrupt not init\r\n");
        qcc74x_lhal_assert_func("./drivers/lhal/src/qcc74x_gpio.c", 809, __func__, log_buf);
    }
    for (uint8_t i = 0; i < sizeof(g_gpio_irq_callback) / sizeof(struct qcc74x_gpio_irq_callback); i++) {
        if (qcc74x_gpio_get_intstatus(g_gpio_int, i)) {
            if (g_gpio_irq_callback[i].handler) {
                ...
                qcc74x_lhal_assert_func("./drivers/lhal/src/qcc74x_gpio.c", 818, __func__, log_buf);
            }
        }
    }
}
...
void qcc74x_gpio_irq_attach(uint8_t pin, void (*callback)(uint8_t pin))
{
    g_gpio_int = qcc74x_device_get_by_name("gpio");
    qcc74x_gpio_int_mask(g_gpio_int, pin, 
# 827 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_gpio.c" 3 4
                                         1
# 827 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_gpio.c"
                                             );
    g_gpio_irq_callback[pin].handler = callback;
    qcc74x_gpio_int_mask(g_gpio_int, pin, 
# 829 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_gpio.c" 3 4
                                         0
# 829 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_gpio.c"
                                              );
    qcc74x_irq_attach(g_gpio_int->irq_num, gpio_all_isr, 
# 830 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_gpio.c" 3 4
                                                        ((void *)0)
# 830 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_gpio.c"
                                                            );
}
...
void qcc74x_gpio_irq_detach(uint8_t pin)
{
    g_gpio_int = qcc74x_device_get_by_name("gpio");
    qcc74x_gpio_int_mask(g_gpio_int, pin, 
# 836 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_gpio.c" 3 4
                                         1
# 836 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_gpio.c"
                                             );
    g_gpio_irq_callback[pin].handler = 
# 837 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_gpio.c" 3 4
                                      ((void *)0)
# 837 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_gpio.c"
                                          ;
}
