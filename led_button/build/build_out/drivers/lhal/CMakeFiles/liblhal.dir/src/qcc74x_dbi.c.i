# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_dbi.c"
# 1 "/home/durga/QCCSDK-QCC74x/examples/peripherals/gpio/gpio_input_output/build/build_out/drivers/lhal//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_dbi.c"
# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_dbi.h" 1
...
# 5 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_dbi.h" 2
# 168 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_dbi.h"
struct qcc74x_dbi_config_s {
    uint8_t dbi_mode;
...
# 192 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_dbi.h"
void qcc74x_dbi_init(struct qcc74x_device_s *dev, const struct qcc74x_dbi_config_s *config);
...
void qcc74x_dbi_deinit(struct qcc74x_device_s *dev);
# 209 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_dbi.h"
void qcc74x_dbi_qspi_set_addr(struct qcc74x_device_s *dev, uint8_t addr_byte_size, uint32_t addr_val);
# 222 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_dbi.h"
int qcc74x_dbi_send_cmd_data(struct qcc74x_device_s *dev, uint8_t cmd, uint8_t data_len, uint8_t *data_buff);
# 233 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_dbi.h"
int qcc74x_dbi_send_cmd_read_data(struct qcc74x_device_s *dev, uint8_t cmd, uint8_t data_len, uint8_t *data_buff);
# 244 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_dbi.h"
int qcc74x_dbi_send_cmd_pixel(struct qcc74x_device_s *dev, uint8_t cmd, uint32_t pixel_cnt, void *pixel_buff);
...
void qcc74x_dbi_link_txdma(struct qcc74x_device_s *dev, 
# 252 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_dbi.h" 3 4
                                                       _Bool 
# 252 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_dbi.h"
                                                            enable);
...
void qcc74x_dbi_txint_mask(struct qcc74x_device_s *dev, 
# 260 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_dbi.h" 3 4
                                                       _Bool 
# 260 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_dbi.h"
                                                            mask);
...
void qcc74x_dbi_tcint_mask(struct qcc74x_device_s *dev, 
# 268 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_dbi.h" 3 4
                                                       _Bool 
# 268 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_dbi.h"
                                                            mask);
...
void qcc74x_dbi_errint_mask(struct qcc74x_device_s *dev, 
# 276 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_dbi.h" 3 4
                                                        _Bool 
# 276 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_dbi.h"
                                                             mask);
...
void qcc74x_dbi_int_clear(struct qcc74x_device_s *dev, uint32_t int_clear);
# 302 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_dbi.h"
int qcc74x_dbi_feature_control(struct qcc74x_device_s *dev, int cmd, size_t arg);
# 2 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_dbi.c" 2
...
# 3 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_dbi.c" 2
# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/hardware/dbi_reg.h" 1
# 4 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_dbi.c" 2
# 30 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_dbi.c"
void qcc74x_dbi_init(struct qcc74x_device_s *dev, const struct qcc74x_dbi_config_s *config)
{
    ((void)0U);
    ((void)0U);
    ...
    div = (qcc74x_clk_get_peripheral_clock(36, dev->idx) * 10 / config->clk_freq_hz + 5) / 10;
    div_0 = (div + 1) / 2;
    ...
    if (config->pixel_output_format == 0) {
        regval &= ~(1 << 31U);
    } else {
        regval |= (1 << 31U);
    }
    ...
    regval &= ~(0x7 << (29U));
    regval |= config->pixel_input_format << (29U);
    ...
    regval &= ~(0x7 << (16U));
    regval |= (config->tx_fifo_threshold << (16U)) & (0x7 << (16U));
    ...
    regval = 0;
    regval |= (0 << (0U)) & (0x1ff << (0U));
    regval |= (0x180 << (10U)) & (0x1ff << (10U));
    regval |= (0x180 << (20U)) & (0x1ff << (20U));
    regval |= (1 << 31U);
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x60)) = (regval));

    regval = 0;
    regval |= (0 << (0U)) & (0x1ff << (0U));
    regval |= (0 << (10U)) & (0x1ff << (10U));
    regval |= (0 << (20U)) & (0x1ff << (20U));
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x64)) = (regval));

    regval = 0;
    regval |= (0x200 << (0U)) & (0xfff << (0U));
    regval |= (0 << (12U)) & (0xfff << (12U));
    regval |= ((0x2ce & 0x0ff) << (24U)) & (0xff << (24U));
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x68)) = (regval));

    regval = 0;
    regval |= (((0x2ce & 0xf00) >> 8) << (0U)) & (0xf << (0U));
    regval |= (0x200 << (4U)) & (0xfff << (4U));
    regval |= (0xf50 << (16U)) & (0xfff << (16U));
    regval |= ((0xe92 & 0x00f) << (28U)) & (0xf << (28U));
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x6C)) = (regval));

    regval = 0;
    regval |= (((0xe92 & 0xff0) >> 4) << (0U)) & (0xff << (0U));
    regval |= (0x200 << (8U)) & (0xfff << (8U));
    regval |= (0x38b << (20U)) & (0xfff << (20U));
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x70)) = (regval));

    regval = 0;
    regval |= (0 << (0U)) & (0xfff << (0U));
...
void qcc74x_dbi_qspi_set_addr(struct qcc74x_device_s *dev, uint8_t addr_byte_size, uint32_t addr_val)
{
    ...
    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x4)));
    regval &= ~(0x3 << (4U));
    regval |= (addr_byte_size << (4U)) & (0x3 << (4U));
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x4)) = (regval));


    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x14)) = (addr_val));

}


__attribute__((unused)) static void qcc74x_dbi_fill_fifo(struct qcc74x_device_s *dev, uint32_t words_cnt, uint32_t *data_buff)
{
    uint32_t reg_base;
    uint32_t regval;
    uint32_t fifo_cnt;
    ...
    for (; words_cnt > 0;) {
        ...
        for (; fifo_cnt > 0; fifo_cnt--, data_buff++) {
            (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x88)) = (*data_buff));
        }
    }
}

__attribute__((unused)) static uint32_t qcc74x_dbi_get_words_cnt_form_pixel(struct qcc74x_device_s *dev, uint32_t pixle_cnt)
{
    uint32_t reg_base;
    uint32_t regval;
    uint32_t words_cnt;
    ...
    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x80)));
    pixel_input_format = (regval & (0x7 << (29U))) >> (29U);
...
int qcc74x_dbi_send_cmd_data(struct qcc74x_device_s *dev, uint8_t cmd, uint8_t data_len, uint8_t *data_buff)
{
    ...
    if (data_len && data_buff == 
# 347 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_dbi.c" 3 4
                                ((void *)0)
# 347 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_dbi.c"
                                    ) {
        return 0;
    }
    ...
    if (data_len) {
        if (data_len <= 8 * 4) {
            ...
            qcc74x_dbi_fill_fifo(dev, 8, (uint32_t *)data_buff);
            data_len -= 8 * 4;
        }
    }
...
int qcc74x_dbi_send_cmd_read_data(struct qcc74x_device_s *dev, uint8_t cmd, uint8_t data_len, uint8_t *data_buff)
{
    ...
    if (data_buff == 
# 498 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_dbi.c" 3 4
                    ((void *)0)
# 498 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_dbi.c"
                        ) {
        return 0;
    }
...
int qcc74x_dbi_send_cmd_pixel(struct qcc74x_device_s *dev, uint8_t cmd, uint32_t pixel_cnt, void *pixel_buff)
{
    ...
    if (pixel_cnt) {
        regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x8)));
        regval &= ~(0xffffff << (0U));
        regval |= ((pixel_cnt - 1) << (0U)) & (0xffffff << (0U));
        (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x8)) = (regval));
    }
    ...
    if (pixel_buff == 
# 586 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_dbi.c" 3 4
                     ((void *)0)
# 586 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_dbi.c"
                         ) {
        return 0;
    }


    qcc74x_dbi_fill_fifo(dev, qcc74x_dbi_get_words_cnt_form_pixel(dev, pixel_cnt), (uint32_t *)pixel_buff);
...
void qcc74x_dbi_link_txdma(struct qcc74x_device_s *dev, 
# 606 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_dbi.c" 3 4
                                                       _Bool 
# 606 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_dbi.c"
                                                            enable)
{
...
void qcc74x_dbi_txint_mask(struct qcc74x_device_s *dev, 
# 626 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_dbi.c" 3 4
                                                       _Bool 
# 626 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_dbi.c"
                                                            mask)
{
...
void qcc74x_dbi_tcint_mask(struct qcc74x_device_s *dev, 
# 646 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_dbi.c" 3 4
                                                       _Bool 
# 646 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_dbi.c"
                                                            mask)
{
...
void qcc74x_dbi_errint_mask(struct qcc74x_device_s *dev, 
# 666 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_dbi.c" 3 4
                                                        _Bool 
# 666 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_dbi.c"
                                                             mask)
{
...
int qcc74x_dbi_feature_control(struct qcc74x_device_s *dev, int cmd, size_t arg)
{
    ...
    switch (cmd) {
        ...
        case (0x06):
            ...
            ret = qcc74x_dbi_get_words_cnt_form_pixel(dev, arg) * 4;
            break;
        ...
        default:
            ret = -
# 856 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_dbi.c" 3
                  1
# 856 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_dbi.c"
                       ;
            break;
    }
