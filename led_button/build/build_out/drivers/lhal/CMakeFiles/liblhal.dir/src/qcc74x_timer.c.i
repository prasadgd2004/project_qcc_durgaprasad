# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_timer.c"
# 1 "/home/durga/QCCSDK-QCC74x/examples/peripherals/gpio/gpio_input_output/build/build_out/drivers/lhal//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_timer.c"
# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_timer.h" 1
...
# 5 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_timer.h" 2
# 147 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_timer.h"
...
# 193 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_timer.h"
struct qcc74x_timer_capture_config_s {
    uint8_t pin;
    uint8_t polarity;
};
# 209 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_timer.h"
...
# 247 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_timer.h"
void qcc74x_timer_set_compvalue(struct qcc74x_device_s *dev, uint8_t cmp_no, uint32_t val);
# 256 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_timer.h"
...
# 273 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_timer.h"
void qcc74x_timer_compint_mask(struct qcc74x_device_s *dev, uint8_t cmp_no, 
# 273 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_timer.h" 3 4
                                                                           _Bool 
# 273 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_timer.h"
                                                                                mask);
# 282 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_timer.h"

# 282 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_timer.h" 3 4
_Bool 
# 282 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_timer.h"
    qcc74x_timer_get_compint_status(struct qcc74x_device_s *dev, uint8_t cmp_no);
...
# 300 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_timer.h"
int qcc74x_timer_feature_control(struct qcc74x_device_s *dev, int cmd, size_t arg);
# 350 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_timer.h"
void qcc74x_timer_capture_init(struct qcc74x_device_s *dev, const struct qcc74x_timer_capture_config_s *config);
# 2 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_timer.c" 2
...
# 3 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_timer.c" 2
# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/hardware/timer_reg.h" 1
# 4 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_timer.c" 2
...
# 8 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_timer.c" 2
...
void qcc74x_timer_init(struct qcc74x_device_s *dev, const struct qcc74x_timer_config_s *config)
{
    ...
    if (!((config->comp0_val) >= 2) ||
        !((config->comp1_val) >= 2) ||
        !((config->comp2_val) >= 2)) {
        qcc74x_lhal_assert_func("./drivers/lhal/src/qcc74x_timer.c", 21, __func__, "comp value is error");
    }
    ...
    qcc74x_timer_compint_clear(dev, 0);
    qcc74x_timer_compint_clear(dev, 1);
    qcc74x_timer_compint_clear(dev, 2);


    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x0)));
    if (dev->idx == 0) {
        regval &= ~(0xf << (0U));
        regval |= (config->clock_source << (0U));
    } else {
        regval &= ~(0xf << (4U));
        regval |= (config->clock_source << (4U));
    }
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x0)) = (regval));


    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0xBC)));
    regval &= ~(0xff << ((8U) + 8 * dev->idx));
    regval |= (config->clock_div << ((8U) + 8 * dev->idx));
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0xBC)) = (regval));


    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x88)));
    if (config->counter_mode == 0) {
        regval &= ~(1 << (1 + dev->idx));
    } else {
        regval |= (1 << (1 + dev->idx));
    }
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x88)) = (regval));


    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x5C) + 4 * dev->idx));
    regval &= ~(0x3 << (0U));
    if (config->trigger_comp_id != 3) {
        regval |= ((config->trigger_comp_id + 1) << (0U));
    }
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x5C) + 4 * dev->idx) = (regval));

    if (config->counter_mode == 0) {
        qcc74x_timer_set_preloadvalue(dev, config->preload_val);
    }

    if (config->trigger_comp_id < 1) {
        qcc74x_timer_compint_mask(dev, 0, 
# 81 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_timer.c" 3 4
                                                       0
# 81 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_timer.c"
                                                            );
        qcc74x_timer_compint_mask(dev, 1, 
# 82 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_timer.c" 3 4
                                                       1
# 82 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_timer.c"
                                                           );
        qcc74x_timer_compint_mask(dev, 2, 
# 83 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_timer.c" 3 4
                                                       1
# 83 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_timer.c"
                                                           );
        qcc74x_timer_set_compvalue(dev, 0, config->comp0_val - 2);
        qcc74x_timer_set_compvalue(dev, 1, 0xffffffff);
        qcc74x_timer_set_compvalue(dev, 2, 0xffffffff);
    } else if (config->trigger_comp_id < 2) {
        qcc74x_timer_compint_mask(dev, 0, 
# 88 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_timer.c" 3 4
                                                       0
# 88 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_timer.c"
                                                            );
        qcc74x_timer_compint_mask(dev, 1, 
# 89 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_timer.c" 3 4
                                                       0
# 89 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_timer.c"
                                                            );
        qcc74x_timer_compint_mask(dev, 2, 
# 90 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_timer.c" 3 4
                                                       1
# 90 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_timer.c"
                                                           );
        qcc74x_timer_set_compvalue(dev, 0, config->comp0_val - 2);
        qcc74x_timer_set_compvalue(dev, 1, config->comp1_val - 2);
        qcc74x_timer_set_compvalue(dev, 2, 0xffffffff);
    } else if (config->trigger_comp_id < 3) {
        qcc74x_timer_compint_mask(dev, 0, 
# 95 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_timer.c" 3 4
                                                       0
# 95 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_timer.c"
                                                            );
        qcc74x_timer_compint_mask(dev, 1, 
# 96 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_timer.c" 3 4
                                                       0
# 96 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_timer.c"
                                                            );
        qcc74x_timer_compint_mask(dev, 2, 
# 97 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_timer.c" 3 4
                                                       0
# 97 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_timer.c"
                                                            );
        qcc74x_timer_set_compvalue(dev, 0, config->comp0_val - 2);
        qcc74x_timer_set_compvalue(dev, 1, config->comp1_val - 2);
        qcc74x_timer_set_compvalue(dev, 2, config->comp2_val - 2);
    } else {
        qcc74x_timer_compint_mask(dev, 0, 
# 102 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_timer.c" 3 4
                                                       1
# 102 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_timer.c"
                                                           );
        qcc74x_timer_compint_mask(dev, 1, 
# 103 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_timer.c" 3 4
                                                       1
# 103 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_timer.c"
                                                           );
        qcc74x_timer_compint_mask(dev, 2, 
# 104 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_timer.c" 3 4
                                                       1
# 104 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_timer.c"
                                                           );
        qcc74x_timer_set_compvalue(dev, 0, 0xffffffff);
        qcc74x_timer_set_compvalue(dev, 1, 0xffffffff);
        qcc74x_timer_set_compvalue(dev, 2, 0xffffffff);
    }
...
void qcc74x_timer_set_preloadvalue(struct qcc74x_device_s *dev, uint32_t val)
{
    ...
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x50) + 4 * dev->idx) = (val));
...
void qcc74x_timer_set_compvalue(struct qcc74x_device_s *dev, uint8_t cmp_no, uint32_t val)
{
    ...
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x10) + 0x0c * dev->idx + 4 * cmp_no) = (val));
...
uint32_t qcc74x_timer_get_compvalue(struct qcc74x_device_s *dev, uint8_t cmp_no)
{
    ...
    return (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x10) + 0x0c * dev->idx + 4 * cmp_no));
...
uint32_t qcc74x_timer_get_countervalue(struct qcc74x_device_s *dev)
{
    ...
    return (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x2C) + 4 * dev->idx));

}

void qcc74x_timer_compint_mask(struct qcc74x_device_s *dev, uint8_t cmp_no, 
# 212 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_timer.c" 3 4
                                                                           _Bool 
# 212 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_timer.c"
                                                                                mask)
{
    ...
    reg_base = dev->reg_base;
    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x44) + 4 * dev->idx));
    if (mask) {
        regval &= ~(1 << cmp_no);
    } else {
        regval |= (1 << cmp_no);
    }
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x44) + 4 * dev->idx) = (regval));

}


# 231 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_timer.c" 3 4
_Bool 
# 231 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_timer.c"
    qcc74x_timer_get_compint_status(struct qcc74x_device_s *dev, uint8_t cmp_no)
{
    ...
    reg_base = dev->reg_base;
    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x38) + 4 * dev->idx));

    if (regval & (1 << cmp_no)) {
        return 
# 243 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_timer.c" 3 4
              1
# 243 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_timer.c"
                  ;
    } else {
        return 
# 245 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_timer.c" 3 4
              0
# 245 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_timer.c"
                   ;
    }
...
void qcc74x_timer_compint_clear(struct qcc74x_device_s *dev, uint8_t cmp_no)
{
    ...
    reg_base = dev->reg_base;
    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x78) + 4 * dev->idx));
    regval |= (1 << cmp_no);
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x78) + 4 * dev->idx) = (regval));
...
int qcc74x_timer_feature_control(struct qcc74x_device_s *dev, int cmd, size_t arg)
{
    ...
    switch (cmd) {
# 410 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_timer.c"
        default:
            ret = -
# 411 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_timer.c" 3
                  1
# 411 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_timer.c"
                       ;
            break;
    }
...
# 570 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_timer.c"
void qcc74x_timer_capture_init(struct qcc74x_device_s *dev, const struct qcc74x_timer_capture_config_s *config)
{
    ...
    qcc74x_gpio_init(gpio, config->pin, (31 << (0)) | (1 << 8) | (0 << (9)) | (1 << (11)) | (1 << (12)));
