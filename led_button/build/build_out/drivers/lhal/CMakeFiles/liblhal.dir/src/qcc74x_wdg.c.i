# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_wdg.c"
# 1 "/home/durga/QCCSDK-QCC74x/examples/peripherals/gpio/gpio_input_output/build/build_out/drivers/lhal//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_wdg.c"
# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_wdg.h" 1
...
# 5 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_wdg.h" 2
# 52 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_wdg.h"
...
# 69 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_wdg.h"
...
# 2 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_wdg.c" 2
...
# 3 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_wdg.c" 2
# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/hardware/timer_reg.h" 1
# 4 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_wdg.c" 2
...
void qcc74x_wdg_init(struct qcc74x_device_s *dev, const struct qcc74x_wdg_config_s *config)
{
    ...
    (*(volatile uint16_t *)(uintptr_t)(reg_base + (0x9C)) = (0xBABA));
    (*(volatile uint16_t *)(uintptr_t)(reg_base + (0xA0)) = (0xEB10));

    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x64)));
    regval &= ~(1 << 0U);
    if (config->mode == 0) {
        regval &= ~(1 << 1U);
    } else {
    ...
    regval &= ~(0xf << (8U));
    regval |= (config->clock_source << (8U));
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x0)) = (regval));


    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0xBC)));
    regval &= ~(0xff << (24U));
    regval |= (config->clock_div << (24U));
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0xBC)) = (regval));

    (*(volatile uint16_t *)(uintptr_t)(reg_base + (0x9C)) = (0xBABA));
    (*(volatile uint16_t *)(uintptr_t)(reg_base + (0xA0)) = (0xEB10));
    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x98)));
    regval |= (1 << 0U);
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x98)) = (regval));

    (*(volatile uint16_t *)(uintptr_t)(reg_base + (0x9C)) = (0xBABA));
    (*(volatile uint16_t *)(uintptr_t)(reg_base + (0xA0)) = (0xEB10));
    (*(volatile uint16_t *)(uintptr_t)(reg_base + (0x68)) = (config->comp_val));
...
uint16_t qcc74x_wdg_get_countervalue(struct qcc74x_device_s *dev)
{
    ...
    return (*(volatile uint16_t *)(uintptr_t)(reg_base + (0x6C)));
...
void qcc74x_wdg_set_countervalue(struct qcc74x_device_s *dev, uint16_t value)
{
    ...
    (*(volatile uint16_t *)(uintptr_t)(reg_base + (0x9C)) = (0xBABA));
    (*(volatile uint16_t *)(uintptr_t)(reg_base + (0xA0)) = (0xEB10));
    (*(volatile uint16_t *)(uintptr_t)(reg_base + (0x68)) = (value));
