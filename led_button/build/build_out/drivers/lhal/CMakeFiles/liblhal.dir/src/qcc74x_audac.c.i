# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_audac.c"
# 1 "/home/durga/QCCSDK-QCC74x/examples/peripherals/gpio/gpio_input_output/build/build_out/drivers/lhal//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_audac.c"
# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_audac.h" 1
...
# 5 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_audac.h" 2
# 177 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_audac.h"
struct qcc74x_audac_init_config_s {
...
# 196 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_audac.h"
struct qcc74x_audac_volume_config_s {
    
# 197 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_audac.h" 3 4
   _Bool 
# 197 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_audac.h"
        mute_ramp_en;
...
int qcc74x_audac_init(struct qcc74x_device_s *dev, const struct qcc74x_audac_init_config_s *config);

int qcc74x_audac_volume_init(struct qcc74x_device_s *dev, const struct qcc74x_audac_volume_config_s *vol_cfg);

int qcc74x_audac_link_rxdma(struct qcc74x_device_s *dev, 
# 213 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_audac.h" 3 4
                                                        _Bool 
# 213 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_audac.h"
                                                             enable);
...
int qcc74x_audac_feature_control(struct qcc74x_device_s *dev, int cmd, size_t arg);
# 2 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_audac.c" 2
# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/hardware/audac_reg.h" 1
# 3 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_audac.c" 2
# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/hardware/dac_reg.h" 1
# 4 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_audac.c" 2
...
int qcc74x_audac_init(struct qcc74x_device_s *dev, const struct qcc74x_audac_init_config_s *config)
{
    ...
    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x000)));
    regval |= (1 << 27U);
    regval |= (1 << 1U);
    regval |= (1 << 0U);
    ...
    if (config->output_mode != 0) {
        regval |= (config->sampling_rate + 8) << (28U);
    } else {
        regval |= config->sampling_rate << (28U);
    }
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x000)) = (regval));
    ...
    regval &= ~(0x3 << (0U));
    if (config->source_channels_num == 0x03) {
        regval |= config->mixer_mode << (0U);
    }
    ...
    regval &= ~(0x3 << (24U));
    regval |= config->data_format << (24U);


    regval &= ~(0x1f << (16U));
    regval |= (config->fifo_threshold << (16U)) & (0x1f << (16U));
    regval &= ~(0x3 << (14U));
    ...
    regval &= ~(1 << 0U);
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x8C)) = (regval));
    ...
    if (config->output_mode != 0) {
        ...
        regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x120)));
        regval |= ((1 << 0U) | (1 << 1U));
        regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x120)));
        regval &= ~(1 << 8U);
        ...
        (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x120)) = (regval));

        if (config->output_mode & 1) {

            regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x124)));
            regval |= ((1 << 0U) | (1 << 1U));
            (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x124)) = (regval));
        }

        if (config->output_mode & 2) {

            regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x128)));
            regval |= ((1 << 0U) | (1 << 1U));
            (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x128)) = (regval));
        }
    }
...
int qcc74x_audac_volume_init(struct qcc74x_device_s *dev, const struct qcc74x_audac_volume_config_s *vol_cfg)
{
    ...
    if (vol_cfg->mute_ramp_en) {
        ...
        regval |= (1 << 30U);
        regval &= ~(0xf << (26U));
        regval |= vol_cfg->mute_down_ramp_rate << (26U);
        regval &= ~(0xf << (22U));
        regval |= vol_cfg->mute_up_ramp_rate << (22U);
    ...
    regval &= ~(0x3 << (10U));
    if (vol_cfg->volume_update_mode == 1) {

        regval |= 2 << (10U);
        regval &= ~(0xf << (2U));
        regval |= vol_cfg->volume_ramp_rate << (2U);
    } else if (vol_cfg->volume_update_mode == 2) {

        regval |= 1 << (10U);
        regval &= ~(0xf << (6U));
        regval |= vol_cfg->volume_ramp_rate << (6U);
    }
...
int qcc74x_audac_link_rxdma(struct qcc74x_device_s *dev, 
# 176 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_audac.c" 3 4
                                                        _Bool 
# 176 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_audac.c"
                                                             enable)
{
    uint32_t reg_base;
    uint32_t regval;
...
int qcc74x_audac_int_mask(struct qcc74x_device_s *dev, uint32_t int_sts)
{
    uint32_t reg_base;
    uint32_t regval;
...
int qcc74x_audac_feature_control(struct qcc74x_device_s *dev, int cmd, size_t arg)
{
    ...
    switch (cmd) {
        case (0x01):
            ...
            regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x8C)));
            regval &= ~(0x3 << (8U));
            regval |= g_audac_channel_mode << (8U);
            (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x8C)) = (regval));
        ...
        case (0x02):
            ...
            if (g_audac_channel_mode == 0) {
                g_audac_channel_mode = (regval & (0x3 << (8U))) >> (8U);
            }
            regval &= ~(0x3 << (8U));
            (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x8C)) = (regval));
            break;
        ...
        case (0x04):
            ...
            regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x8)));
            regval &= ~(0x1ff << (13U));
            regval |= (volume_val << (13U)) & (0x1ff << (13U));
            (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x8)) = (regval));
            break;
