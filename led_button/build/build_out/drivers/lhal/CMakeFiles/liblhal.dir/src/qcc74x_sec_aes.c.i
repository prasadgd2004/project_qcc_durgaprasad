# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_sec_aes.c"
# 1 "/home/durga/QCCSDK-QCC74x/examples/peripherals/gpio/gpio_input_output/build/build_out/drivers/lhal//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_sec_aes.c"
# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_sec_aes.h" 1
...
# 5 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_sec_aes.h" 2
# 39 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_sec_aes.h"
struct qcc74x_aes_link_s {
    uint32_t : 3;
    uint32_t aes_key : 2;
...
# 118 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_sec_aes.h"
void qcc74x_aes_init(struct qcc74x_device_s *dev);
...
void qcc74x_aes_deinit(struct qcc74x_device_s *dev);
# 134 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_sec_aes.h"
void qcc74x_aes_select_hwkey(struct qcc74x_device_s *dev, uint8_t keysel0, uint8_t keysel1);
...
void qcc74x_aes_set_hwkey_source(struct qcc74x_device_s *dev, uint8_t source);
...
void qcc74x_aes_set_mode(struct qcc74x_device_s *dev, uint8_t mode);
# 159 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_sec_aes.h"
void qcc74x_aes_setkey(struct qcc74x_device_s *dev, const uint8_t *key, uint16_t keybits);
# 171 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_sec_aes.h"
int qcc74x_aes_encrypt(struct qcc74x_device_s *dev,
                     const uint8_t *input,
                     const uint8_t *iv,
                     uint8_t *output,
                     uint32_t len);
# 187 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_sec_aes.h"
int qcc74x_aes_decrypt(struct qcc74x_device_s *dev,
                     const uint8_t *input,
                     const uint8_t *iv,
                     uint8_t *output,
                     uint32_t len);
...
void qcc74x_aes_link_init(struct qcc74x_device_s *dev);
...
void qcc74x_aes_link_deinit(struct qcc74x_device_s *dev);
# 217 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_sec_aes.h"
int qcc74x_aes_link_update(struct qcc74x_device_s *dev,
                         uint32_t link_addr,
                         const uint8_t *input,
                         uint8_t *output,
                         uint32_t len);
...
void qcc74x_group0_request_aes_access(struct qcc74x_device_s *dev);
...
void qcc74x_group0_release_aes_access(struct qcc74x_device_s *dev);
# 2 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_sec_aes.c" 2
# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/hardware/sec_eng_reg.h" 1
# 3 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_sec_aes.c" 2
...
void qcc74x_aes_init(struct qcc74x_device_s *dev)
{
    ...
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x148)) = (0x1f));
...
void qcc74x_aes_select_hwkey(struct qcc74x_device_s *dev, uint8_t keysel0, uint8_t keysel1)
{
    ...
    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x140)));
    regval &= ~(0x3 << (0U));
    regval |= (keysel0 << (0U));
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x140)) = (regval));

    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x144)));
    regval &= ~(0x3 << (0U));
    regval |= (keysel1 << (0U));
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x144)) = (regval));
...
void qcc74x_aes_setkey(struct qcc74x_device_s *dev, const uint8_t *key, uint16_t keybits)
{
    ...
    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x100)));
    mode = (regval & (0x3 << (12U))) >> (12U);

    regval &= ~(0x3 << (3U));
    regval &= ~(1 << 7U);
    if (key == 
# 110 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_sec_aes.c" 3 4
              ((void *)0)
# 110 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_sec_aes.c"
                  ) {
        regval |= (1 << 7U);
    }
    ...
    if (key) {
        (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x120)) = (((temp_key[3] << 24) | (temp_key[2] << 16) | (temp_key[1] << 8) | (temp_key[0]))));
        temp_key += 4;
        (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x124)) = (((temp_key[3] << 24) | (temp_key[2] << 16) | (temp_key[1] << 8) | (temp_key[0]))));
        temp_key += 4;
        (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x128)) = (((temp_key[3] << 24) | (temp_key[2] << 16) | (temp_key[1] << 8) | (temp_key[0]))));
        temp_key += 4;
        (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x12C)) = (((temp_key[3] << 24) | (temp_key[2] << 16) | (temp_key[1] << 8) | (temp_key[0]))));
        temp_key += 4;

        if (keybits == 192) {
            (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x130)) = (((temp_key[3] << 24) | (temp_key[2] << 16) | (temp_key[1] << 8) | (temp_key[0]))));
            temp_key += 4;
            (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x134)) = (((temp_key[3] << 24) | (temp_key[2] << 16) | (temp_key[1] << 8) | (temp_key[0]))));
            temp_key += 4;
        } else if ((keybits == 256) || (mode == 3)) {
            (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x130)) = (((temp_key[3] << 24) | (temp_key[2] << 16) | (temp_key[1] << 8) | (temp_key[0]))));
            temp_key += 4;
            (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x134)) = (((temp_key[3] << 24) | (temp_key[2] << 16) | (temp_key[1] << 8) | (temp_key[0]))));
            temp_key += 4;
            (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x138)) = (((temp_key[3] << 24) | (temp_key[2] << 16) | (temp_key[1] << 8) | (temp_key[0]))));
            temp_key += 4;
            (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x13C)) = (((temp_key[3] << 24) | (temp_key[2] << 16) | (temp_key[1] << 8) | (temp_key[0]))));
            temp_key += 4;
        } else {
        }
    }
                     ...
                     uint32_t len)
{
    ...
    if (len % 16) {
        return -
# 173 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_sec_aes.c" 3
               22
# 173 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_sec_aes.c"
                     ;
    }
    ...
    if (temp_iv) {
        if (mode == 3) {
            (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x11C)) = (((temp_iv[0] << 24) | (temp_iv[1] << 16) | (temp_iv[2] << 8) | (temp_iv[3]))));
            temp_iv += 4;
            (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x118)) = (((temp_iv[0] << 24) | (temp_iv[1] << 16) | (temp_iv[2] << 8) | (temp_iv[3]))));
            temp_iv += 4;
            (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x114)) = (((temp_iv[0] << 24) | (temp_iv[1] << 16) | (temp_iv[2] << 8) | (temp_iv[3]))));
            temp_iv += 4;
            (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x110)) = (((temp_iv[0] << 24) | (temp_iv[1] << 16) | (temp_iv[2] << 8) | (temp_iv[3]))));
            temp_iv += 4;
        } else {
            (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x110)) = (((temp_iv[3] << 24) | (temp_iv[2] << 16) | (temp_iv[1] << 8) | (temp_iv[0]))));
            temp_iv += 4;
            (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x114)) = (((temp_iv[3] << 24) | (temp_iv[2] << 16) | (temp_iv[1] << 8) | (temp_iv[0]))));
            temp_iv += 4;
            (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x118)) = (((temp_iv[3] << 24) | (temp_iv[2] << 16) | (temp_iv[1] << 8) | (temp_iv[0]))));
            temp_iv += 4;
            (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x11C)) = (((temp_iv[3] << 24) | (temp_iv[2] << 16) | (temp_iv[1] << 8) | (temp_iv[0]))));
            temp_iv += 4;
        }
    }


    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x104)) = ((uint32_t)(uintptr_t)input));
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x108)) = ((uint32_t)(uintptr_t)output));
    ...
    while ((*(volatile uint32_t *)(uintptr_t)(reg_base + (0x100))) & (1 << 0U)) {
        if ((qcc74x_mtimer_get_time_ms() - start_time) > 100) {
            return -
# 224 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_sec_aes.c" 3
                   116
# 224 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_sec_aes.c"
                            ;
        }
    }
    return 0;
                     ...
                     uint32_t len)
{
    ...
    if (len % 16) {
        return -
# 249 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_sec_aes.c" 3
               22
# 249 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_sec_aes.c"
                     ;
    }
    ...
    while ((*(volatile uint32_t *)(uintptr_t)(reg_base + (0x100))) & (1 << 0U)) {
        if ((qcc74x_mtimer_get_time_ms() - start_time) > 100) {
            return -
# 300 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_sec_aes.c" 3
                   116
# 300 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_sec_aes.c"
                            ;
        }
    }
    return 0;
                         ...
                         uint32_t len)
{
    ...
    if ((len % 16) || ((link_addr & 0x03))) {
        return -
# 363 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_sec_aes.c" 3
               22
# 363 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_sec_aes.c"
                     ;
    }
    ...
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x150)) = (link_addr));
    ...
    *((uint16_t *)(uintptr_t)link_addr + 1) = len / 16;
    ...
    while ((*(volatile uint32_t *)(uintptr_t)(reg_base + (0x100))) & (1 << 0U)) {
        if ((qcc74x_mtimer_get_time_ms() - start_time) > 100) {
            return -
# 390 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_sec_aes.c" 3
                   116
# 390 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_sec_aes.c"
                            ;
        }
    }
...
void qcc74x_group0_request_aes_access(struct qcc74x_device_s *dev)
{
    ...
    if (((regval >> 2) & 0x03) == 0x03) {
        (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x1FC)) = (0x02));
...
void qcc74x_group0_release_aes_access(struct qcc74x_device_s *dev)
{
    ...
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x1FC)) = (0x06));
...
void qcc74x_aes_set_hwkey_source(struct qcc74x_device_s *dev, uint8_t source)
{
    ...
    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x14C)));
    regval |= (source << 0);
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x14C)) = (regval));
