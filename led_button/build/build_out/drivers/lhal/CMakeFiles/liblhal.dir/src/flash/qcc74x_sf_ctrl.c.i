# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
# 1 "/home/durga/QCCSDK-QCC74x/examples/peripherals/gpio/gpio_input_output/build/build_out/drivers/lhal//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
...
# 2 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c" 2
# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/hardware/sf_ctrl_reg.h" 1
# 3 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c" 2
...
# 5 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c" 2
# 58 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
__attribute__((always_inline)) static inline uint32_t qcc74x_sf_ctrl_bswap32(uint32_t value)
{
...
# 78 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
__attribute__((weak))
void __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "79"))) qcc74x_sf_ctrl_enable(const struct sf_ctrl_cfg_type *cfg)
{
    ...
    if (cfg == 
# 88 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c" 3 4
              ((void *)0)
# 88 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
                  ) {
        return;
    }

    reg_base = ((uint32_t)0x2000b000);
    time_out = (5 * 320 * 1000);
    ...
    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x0)));
    ...
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x0)) = (regval));
# 140 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x4)));
    regval |= (1<<31U);
    regval |= (1<<29U);
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x4)) = (regval));

    qcc74x_sf_ctrl_set_owner(cfg->owner);

}
# 160 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
__attribute__((weak))
void __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "161"))) qcc74x_sf_ctrl_set_io_delay(uint8_t pad, uint8_t do_delay, uint8_t di_delay, uint8_t oe_delay)
{
    ...
    if (pad == 0) {
        offset = ((uint32_t)0x2000b000) + 0x30;
    } else if (pad == 1) {
        offset = ((uint32_t)0x2000b000) + 0x48;
    } else {
        offset = ((uint32_t)0x2000b000) + 0x5C;
    }


    regval = (*(volatile uint32_t *)(uintptr_t)(offset + (0x4)));
    regval &= ~(0x3<<(16U));
    regval |= (do_delay << (16U));
    regval &= ~(0x3<<(8U));
    regval |= (di_delay << (8U));
    regval &= ~(0x3<<(0U));
    regval |= (oe_delay << (0U));
    (*(volatile uint32_t *)(uintptr_t)(offset + (0x4)) = (regval));

    regval = (*(volatile uint32_t *)(uintptr_t)(offset + (0x8)));
    regval &= ~(0x3<<(16U));
    regval |= (do_delay << (16U));
    regval &= ~(0x3<<(8U));
    regval |= (di_delay << (8U));
    regval &= ~(0x3<<(0U));
    regval |= (oe_delay << (0U));
    (*(volatile uint32_t *)(uintptr_t)(offset + (0x8)) = (regval));

    regval = (*(volatile uint32_t *)(uintptr_t)(offset + (0xc)));
    regval &= ~(0x3<<(16U));
    regval |= (do_delay << (16U));
    regval &= ~(0x3<<(8U));
    regval |= (di_delay << (8U));
    regval &= ~(0x3<<(0U));
    regval |= (oe_delay << (0U));
    (*(volatile uint32_t *)(uintptr_t)(offset + (0xc)) = (regval));

    regval = (*(volatile uint32_t *)(uintptr_t)(offset + (0x10)));
    regval &= ~(0x3<<(16U));
    regval |= (do_delay << (16U));
    regval &= ~(0x3<<(8U));
    regval |= (di_delay << (8U));
    regval &= ~(0x3<<(0U));
    regval |= (oe_delay << (0U));
    (*(volatile uint32_t *)(uintptr_t)(offset + (0x10)) = (regval));

}
# 227 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
__attribute__((weak))
void __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "228"))) qcc74x_sf_ctrl_get_io_delay(uint8_t pad, uint8_t *do_delay, uint8_t *di_delay, uint8_t *oe_delay)
{
    ...
    regval = (*(volatile uint32_t *)(uintptr_t)(offset + (0x4)));
    *do_delay = (regval & (0x3<<(16U))) >> (16U);
    *di_delay = (regval & (0x3<<(8U))) >> (8U);
    *oe_delay = (regval & (0x3<<(0U))) >> (0U);

}
# 262 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
__attribute__((weak))
void __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "263"))) qcc74x_sf_ctrl_set_cs_clk_delay(uint8_t pad, uint8_t cs_delay, uint8_t clk_delay)
{
    ...
    regval = (*(volatile uint32_t *)(uintptr_t)(offset + (0x0)));
    regval &= ~(0x3<<(0U));
    regval |= (cs_delay << (0U));
    regval &= ~(0x3<<(2U));
    regval |= (cs_delay << (2U));
    regval &= ~(0x3<<(8U));
    regval |= (clk_delay << (8U));
    (*(volatile uint32_t *)(uintptr_t)(offset + (0x0)) = (regval));

}
# 301 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
__attribute__((weak))
void __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "302"))) qcc74x_sf_ctrl_get_cs_clk_delay(uint8_t pad, uint8_t *cs_delay, uint8_t *clk_delay)
{
    ...
    regval = (*(volatile uint32_t *)(uintptr_t)(offset + (0x0)));
    *cs_delay = (regval & (0x3<<(0U))) >> (0U);


    *clk_delay = (regval & (0x3<<(8U))) >> (8U);

}
# 335 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
__attribute__((weak))
void __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "336"))) qcc74x_sf_ctrl_set_flash_io_cs_clk_delay(struct qcc74x_sf_ctrl_io_cs_clk_delay_cfg cfg)
{




    qcc74x_sf_ctrl_set_io_delay(0, cfg.do_delay, cfg.di_delay, cfg.oe_delay);


    qcc74x_sf_ctrl_set_cs_clk_delay(0, cfg.cs_delay, cfg.cs_clk_delay);

}
# 357 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
__attribute__((weak))
void __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "358"))) qcc74x_sf_ctrl_get_flash_io_cs_clk_delay(struct qcc74x_sf_ctrl_io_cs_clk_delay_cfg *cfg)
{



    arch_memset(cfg, 0, sizeof(struct qcc74x_sf_ctrl_io_cs_clk_delay_cfg));


    qcc74x_sf_ctrl_get_io_delay(0, &cfg->do_delay, &cfg->di_delay, &cfg->oe_delay);


    qcc74x_sf_ctrl_get_cs_clk_delay(0, &cfg->cs_delay, &cfg->cs_clk_delay);

}
# 384 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
__attribute__((weak))
void __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "385"))) qcc74x_sf_ctrl_set_dqs_delay(uint8_t pad, uint8_t dodelay, uint8_t didelay, uint8_t oedelay)
{
...
# 421 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
__attribute__((weak))
void __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "422"))) qcc74x_sf_ctrl_bank2_enable(const struct sf_ctrl_bank2_cfg *bank2_cfg)
{
    ...
    if (bank2_cfg == 
# 430 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c" 3 4
                    ((void *)0)
# 430 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
                        ) {
        return;
    }
    ...
    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x9C)));
    ...
    if (bank2_cfg->bank2_delay_src) {
        ...
        if (bank2_cfg->bank2_clk_delay > 0) {
            regval |= (1<<11U);
            regval &= ~(0x7<<(8U));
            regval |= ((bank2_cfg->bank2_clk_delay - 1) << (8U));
        } else {
            regval &= ~(1<<11U);
        }
    } else {
    ...
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x9C)) = (regval));


    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0xC0)));
    if (bank2_cfg->bank2_rx_clk_invert_sel) {
        regval |= (1<<2U);
    } else {
        regval &= ~(1<<2U);
    ...
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0xC0)) = (regval));


    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x70)));
    regval |= (1<<30U);
    regval |= (1<<29U);
    regval &= ~(0x3<<(0U));
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x70)) = (regval));

}
# 499 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
__attribute__((weak))
void __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "500"))) qcc74x_sf_ctrl_sbus2_hold_sram(void)
{
    ...
    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0xC4)));
    regval |= (1<<28U);
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0xC4)) = (regval));

}
# 525 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
__attribute__((weak))
void __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "526"))) qcc74x_sf_ctrl_sbus2_release_sram(void)
{
...
# 551 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
__attribute__((weak))
uint8_t __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "552"))) qcc74x_sf_ctrl_is_sbus2_enable(void)
{
...
# 583 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
__attribute__((weak))
void __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "584"))) qcc74x_sf_ctrl_sbus2_replace(uint8_t pad)
{
...
# 629 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
__attribute__((weak))
void __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "630"))) qcc74x_sf_ctrl_sbus2_revoke_replace(void)
{
...
# 665 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
__attribute__((weak))
void __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "666"))) qcc74x_sf_ctrl_sbus2_set_delay(uint8_t clk_delay, uint8_t rx_clk_invert)
{
...
# 704 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
__attribute__((weak))
void __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "705"))) qcc74x_sf_ctrl_remap_set(uint8_t remap, uint8_t lock)
{
...
# 740 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
__attribute__((weak))
void __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "741"))) qcc74x_sf_ctrl_32bits_addr_en(uint8_t en32_bits_addr)
{
...
# 838 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
__attribute__((weak))
uint8_t __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "839"))) qcc74x_sf_ctrl_get_clock_delay(void)
{
    ...
    return ((regval & (0x7<<(8U))) >> (8U)) + 1;

}
# 866 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
__attribute__((weak))
void __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "867"))) qcc74x_sf_ctrl_set_clock_delay(uint8_t delay)
{
...
# 897 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
__attribute__((weak))
uint8_t __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "898"))) qcc74x_sf_ctrl_get_wrap_queue_value(void)
{
    ...
    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x74)));
    return (regval & (1<<12U)) ? 1 : 0;

}
# 923 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
__attribute__((weak))
void __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "924"))) qcc74x_sf_ctrl_cmds_set(struct sf_ctrl_cmds_cfg *cmds_cfg, uint8_t bank)
{
    ...
    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x74)));
    regval &= ~(0x7<<(29U));
    regval |= ((cmds_cfg->ack_latency) << (29U));
    ...
    if (bank == 1) {
        ...
        regval &= ~(0x3<<(10U));
        regval |= ((cmds_cfg->cmds_wrap_mode) << (10U));
        regval &= ~(0xf<<(0U));
        regval |= ((cmds_cfg->cmds_wrap_len) << (0U));
    } else {
        if (cmds_cfg->cmds_en) {
            regval |= (1<<17U);
        } else {
        ...
        regval &= ~(0x3<<(18U));
        regval |= ((cmds_cfg->cmds_wrap_mode) << (18U));
        regval &= ~(0xf<<(13U));
        regval |= ((cmds_cfg->cmds_wrap_len) << (13U));
    }
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x74)) = (regval));

}
# 1097 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
__attribute__((weak))
void __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "1098"))) qcc74x_sf_ctrl_select_pad(uint8_t sel)
{
    ...
    } else if ((sel >= 0x14 && sel <= 0x17) || (sel >= 0x34 && sel <= 0x37)) {

        regval |= (1<<30U);
        regval |= (1<<29U);
        regval &= ~(0x3<<(0U));
    }
# 1172 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x70)) = (regval));

}
# 1184 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
__attribute__((weak))
void __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "1185"))) qcc74x_sf_ctrl_sbus_select_bank(uint8_t bank)
{
...
# 1213 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
__attribute__((weak))
void __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "1214"))) qcc74x_sf_ctrl_set_owner(uint8_t owner)
{
...
# 1260 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
__attribute__((weak))
uint8_t __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "1261"))) qcc74x_sf_ctrl_get_owner(void)
{
    ...
    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x4)));
    owner = (regval & (1<<28U)) >> 28;
    return owner;

}
# 1295 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
__attribute__((weak))
void __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "1296"))) qcc74x_sf_ctrl_set_owner_flag(uint8_t owner)
{
    ...
    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x44)));
    regval &= ~0xFF0000FF;
    regval |= owner;
    regval |= flag_enable;
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x44)) = (regval));

}
# 1323 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
__attribute__((weak))
uint8_t __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "1324"))) qcc74x_sf_ctrl_get_owner_flag(void)
{
...
# 1351 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
__attribute__((weak))
void __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "1352"))) qcc74x_sf_ctrl_disable(void)
{
...
# 1376 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
__attribute__((weak))
void __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "1377"))) qcc74x_sf_ctrl_aes_enable_be(void)
{
...
# 1404 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
__attribute__((weak))
void __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "1405"))) qcc74x_sf_ctrl_aes_enable_le(void)
{
...
# 1437 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
__attribute__((weak))
# 1490 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
void __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "1490"))) qcc74x_sf_ctrl_aes_set_region(uint8_t region, uint8_t enable, uint8_t hw_key,
                                                  uint32_t start_addr, uint32_t end_addr, uint8_t locked)
{



    uint32_t region_reg_base = (((uint32_t)0x2000b000) + 0x200 + (region)*0x80);
    uint32_t regval = 0;

    if (!hw_key) {
        region_reg_base = (((uint32_t)0x2000b000) + 0x200 + (region)*0x80);
    }

    regval = (*(volatile uint32_t *)(uintptr_t)(region_reg_base + (0x34)));

    regval &= ~(0x7ffff<<(0U));
    regval |= ((end_addr / 1024) << (0U));
    (*(volatile uint32_t *)(uintptr_t)(region_reg_base + (0x34)) = (regval));

    regval = (*(volatile uint32_t *)(uintptr_t)(region_reg_base + (0x30)));
    if (hw_key) {
        regval |= (1<<29U);
    } else {
        regval &= ~(1<<29U);
    ...
    regval &= ~(0x7ffff<<(0U));
    regval |= ((start_addr / 1024) << (0U));
    (*(volatile uint32_t *)(uintptr_t)(region_reg_base + (0x30)) = (regval));

}
# 1542 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
__attribute__((weak))
void __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "1543"))) qcc74x_sf_ctrl_aes_set_key(uint8_t region, uint8_t *key, uint8_t key_type)
{
    ...
    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x28)));
    regval &= ~(0x3<<(1U));
    regval |= ((key_type) << (1U));
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x28)) = (regval));

    if (
# 1564 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c" 3 4
       ((void *)0) 
# 1564 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
            != key) {
        if (key_type == 0) {
            i = 4;
        } else if (key_type == 1) {
        ...
        regval = (0x1c);
        while (i--) {
            (*(volatile uint32_t *)(uintptr_t)(region_reg_base + regval) = (qcc74x_sf_ctrl_bswap32(((key[3] << 24) | (key[2] << 16) | (key[1] << 8) | (key[0])))));
            key += 4;
            regval -= 4;
        }
    }
...
# 1593 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
__attribute__((weak))
void __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "1594"))) qcc74x_sf_ctrl_aes_set_key_be(uint8_t region, uint8_t *key, uint8_t key_type)
{
    ...
    if (
# 1615 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c" 3 4
       ((void *)0) 
# 1615 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
            != key) {
        if (key_type == 0) {
            i = 4;
        } else if (key_type == 1) {
        ...
        regval = (0x0);
        while (i--) {
            (*(volatile uint32_t *)(uintptr_t)(region_reg_base + regval) = (((key[3] << 24) | (key[2] << 16) | (key[1] << 8) | (key[0]))));
            key += 4;
            regval += 4;
        }
    }
...
# 1644 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
__attribute__((weak))
void __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "1645"))) qcc74x_sf_ctrl_aes_set_iv(uint8_t region, uint8_t *iv, uint32_t addr_offset)
{
    ...
    if (iv != 
# 1658 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c" 3 4
             ((void *)0)
# 1658 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
                 ) {
        regval = (0x2c);

        while (i--) {
            (*(volatile uint32_t *)(uintptr_t)(region_reg_base + regval) = (qcc74x_sf_ctrl_bswap32(((iv[3] << 24) | (iv[2] << 16) | (iv[1] << 8) | (iv[0])))));
            iv += 4;
            regval -= 4;
        }

        (*(volatile uint32_t *)(uintptr_t)(region_reg_base + (0x20)) = (addr_offset));
        iv += 4;
    }

}
# 1683 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
__attribute__((weak))
void __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "1684"))) qcc74x_sf_ctrl_aes_set_iv_be(uint8_t region, uint8_t *iv, uint32_t addr_offset)
{
    ...
    if (iv != 
# 1697 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c" 3 4
             ((void *)0)
# 1697 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
                 ) {
        regval = (0x20);

        while (i--) {
            (*(volatile uint32_t *)(uintptr_t)(region_reg_base + regval) = (((iv[3] << 24) | (iv[2] << 16) | (iv[1] << 8) | (iv[0]))));
            iv += 4;
            regval += 4;
        }

        (*(volatile uint32_t *)(uintptr_t)(region_reg_base + (0x2c)) = (qcc74x_sf_ctrl_bswap32(addr_offset)));
        iv += 4;
    }

}
# 1721 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
__attribute__((weak))
void __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "1722"))) qcc74x_sf_ctrl_aes_set_region_offset(uint8_t region, uint32_t addr_offset)
{
...
# 1748 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
__attribute__((weak))
void __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "1749"))) qcc74x_sf_ctrl_aes_xts_set_key(uint8_t region, uint8_t *key, uint8_t key_type)
{
    ...
    if (
# 1766 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c" 3 4
       ((void *)0) 
# 1766 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
            != key) {
        i = 8;
        regval = (0x1c);
...
# 1789 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
__attribute__((weak))
void __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "1790"))) qcc74x_sf_ctrl_aes_xts_set_key_be(uint8_t region, uint8_t *key, uint8_t key_type)
{
    ...
    if (
# 1807 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c" 3 4
       ((void *)0) 
# 1807 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
            != key) {
        i = 8;
        regval = (0x0);
...
# 1830 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
__attribute__((weak))
void __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "1831"))) qcc74x_sf_ctrl_aes_xts_set_iv(uint8_t region, uint8_t *iv, uint32_t addr_offset)
{
    ...
    if (iv != 
# 1840 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c" 3 4
             ((void *)0)
# 1840 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
                 ) {
        regval = (0x24);
...
# 1865 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
__attribute__((weak))
void __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "1866"))) qcc74x_sf_ctrl_aes_xts_set_iv_be(uint8_t region, uint8_t *iv, uint32_t addr_offset)
{
    ...
    if (iv != 
# 1875 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c" 3 4
             ((void *)0)
# 1875 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
                 ) {
        regval = (0x28);
...
# 1899 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
__attribute__((weak))
void __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "1900"))) qcc74x_sf_ctrl_aes_set_mode(uint8_t mode)
{
...
# 1928 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
__attribute__((weak))
void __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "1929"))) qcc74x_sf_ctrl_aes_enable(void)
{
...
# 1953 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
__attribute__((weak))
void __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "1954"))) qcc74x_sf_ctrl_aes_disable(void)
{
...
# 1978 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
__attribute__((weak))
uint8_t __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "1979"))) qcc74x_sf_ctrl_is_aes_enable(void)
{
...
# 2008 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
__attribute__((weak))
void __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "2009"))) qcc74x_sf_ctrl_set_flash_image_offset(uint32_t addr_offset, uint8_t group, uint8_t bank)
{
    ...
    if (bank == 0) {
        if (group) {
            (*(volatile uint32_t *)(uintptr_t)(reg_base + (0xA4)) = (addr_offset));
        } else {
            (*(volatile uint32_t *)(uintptr_t)(reg_base + (0xA0)) = (addr_offset));
        }
    }

    else {
        if (group) {
            (*(volatile uint32_t *)(uintptr_t)(reg_base + (0xAC)) = (addr_offset));
        } else {
            (*(volatile uint32_t *)(uintptr_t)(reg_base + (0xA8)) = (addr_offset));
        }
    }
...
# 2050 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
__attribute__((weak))
uint32_t __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "2051"))) qcc74x_sf_ctrl_get_flash_image_offset(uint8_t group, uint8_t bank)
{
    ...
    if (group) {
        if (bank == 0) {
            regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0xA4)));
        } else {
            regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0xAC)));
        }
    } else {
        if (bank == 0) {
            regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0xA0)));
        } else {
            regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0xA8)));
        }
    }
...
# 2091 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
__attribute__((weak))
void __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "2092"))) qcc74x_sf_ctrl_lock_flash_image_offset(uint8_t lock)
{
...
# 2142 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
void __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "2142"))) qcc74x_sf_ctrl_select_clock(uint8_t sahb_sram_sel)
{
...
# 2160 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
__attribute__((weak))
void __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "2161"))) qcc74x_sf_ctrl_sendcmd(struct sf_ctrl_cmd_cfg_type *cfg)
{
    ...
    if (qcc74x_sf_ctrl_is_sbus2_enable() == 0) {
        regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x4)));
        if (regval & (1<<28U)) {
            return;
        }

        cmd_offset = reg_base + 0x8;
    } else {
        cmd_offset = reg_base + 0xC8;
    }
# 2202 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
    regval = (*(volatile uint32_t *)(uintptr_t)(cmd_offset + (0x0)));
    regval &= ~(1<<1U);
    (*(volatile uint32_t *)(uintptr_t)(cmd_offset + (0x0)) = (regval));


    (*(volatile uint32_t *)(uintptr_t)(cmd_offset + (0x4)) = (cfg->cmd_buf[0]));
    (*(volatile uint32_t *)(uintptr_t)(cmd_offset + (0x8)) = (cfg->cmd_buf[1]));
    ...
    if (0 == cfg->addr_mode) {
        if (0 == cfg->data_mode) {
            regval |= (0 << (28U));
        } else if (1 == cfg->data_mode) {
            regval |= (1 << (28U));
        } else if (2 == cfg->data_mode) {
            regval |= (2 << (28U));
        }
    } else if (1 == cfg->addr_mode) {
        regval |= (3 << (28U));
    } else if (2 == cfg->addr_mode) {
        regval |= (4 << (28U));
    }
...
# 2302 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
__attribute__((weak))
void __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "2303"))) qcc74x_sf_ctrl_disable_wrap_access(uint8_t disable)
{
...
# 2332 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
__attribute__((weak))
void __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "2333"))) qcc74x_sf_ctrl_xip_set(struct sf_ctrl_cmd_cfg_type *cfg, uint8_t cmd_valid)
{
    ...
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x18)) = (cfg->cmd_buf[0]));
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x1C)) = (cfg->cmd_buf[1]));

    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x14)));
    ...
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x14)) = (regval));

}
# 2538 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
__attribute__((weak))



void __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "2542"))) qcc74x_sf_ctrl_xip2_set(struct sf_ctrl_cmd_cfg_type *cfg, uint8_t cmd_valid)

{
    ...
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x94)) = (cfg->cmd_buf[0]));
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x98)) = (cfg->cmd_buf[1]));

    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x90)));
    ...
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x90)) = (regval));

}
# 2645 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
__attribute__((weak))
uint8_t __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "2646"))) qcc74x_sf_ctrl_get_busy_state(void)
{
    ...
    if (qcc74x_sf_ctrl_is_sbus2_enable() == 0) {
        cmd_offset = ((uint32_t)0x2000b000) + 0x8;
    } else {
        cmd_offset = ((uint32_t)0x2000b000) + 0xC8;
    }
...
# 2682 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
void __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "2682"))) qcc74x_sf_ctrl_aes_get_iv_be(uint8_t region, uint8_t *iv)
{
    ...
    if (iv != 
# 2694 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c" 3 4
             ((void *)0)
# 2694 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
                 ) {
        iv_w[0] = (*(volatile uint32_t *)(uintptr_t)(region_reg_base + (0x20)));
        iv_w[1] = (*(volatile uint32_t *)(uintptr_t)(region_reg_base + (0x24)));
        iv_w[2] = (*(volatile uint32_t *)(uintptr_t)(region_reg_base + (0x28)));
        iv_w[3] = (*(volatile uint32_t *)(uintptr_t)(region_reg_base + (0x2c)));
        arch_memcpy(iv, (uint8_t *)&iv_w, sizeof(iv_w));
    }

}
# 2713 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
void __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "2713"))) qcc74x_sf_ctrl_aes_get_iv_le(uint8_t region, uint8_t *iv)
{
    ...
    if (iv != 
# 2725 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c" 3 4
             ((void *)0)
# 2725 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
                 ) {
        iv_w[3] = qcc74x_sf_ctrl_bswap32((*(volatile uint32_t *)(uintptr_t)(region_reg_base + (0x20))));
        iv_w[2] = qcc74x_sf_ctrl_bswap32((*(volatile uint32_t *)(uintptr_t)(region_reg_base + (0x24))));
        iv_w[1] = qcc74x_sf_ctrl_bswap32((*(volatile uint32_t *)(uintptr_t)(region_reg_base + (0x28))));
        iv_w[0] = qcc74x_sf_ctrl_bswap32((*(volatile uint32_t *)(uintptr_t)(region_reg_base + (0x2c))));
        arch_memcpy(iv, (uint8_t *)&iv_w, sizeof(iv_w));
    }

}
# 2743 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
int32_t __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "2743"))) qcc74x_sf_ctrl_aes_set_decrypt_region_be(struct qcc74x_sf_ctrl_decrypt_type *parm)
{
    ...
    uint8_t *p_iv = 
# 2749 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c" 3 4
                   ((void *)0)
# 2749 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
                       ;


    if ((
# 2752 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c" 3 4
        ((void *)0) 
# 2752 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
             == parm) || ((parm->addr + parm->len) > (64 * 1024 * 1024))) {
        return -1;
    }

    if (parm->len) {
        if (
# 2757 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c" 3 4
           ((void *)0) 
# 2757 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
                == parm->iv) {

            qcc74x_sf_ctrl_aes_get_iv_be(0, temp_iv);
            p_iv = temp_iv;
        } else {
            p_iv = parm->iv;
        }
        ...
        if (1 == parm->mode) {
            ...
            qcc74x_sf_ctrl_aes_set_mode(1);
            qcc74x_sf_ctrl_aes_xts_set_key_be(parm->aes_region, parm->key, parm->type);
            qcc74x_sf_ctrl_aes_xts_set_iv_be(parm->aes_region, p_iv, parm->addr);
        } else {


            qcc74x_sf_ctrl_disable_wrap_access(1);
            qcc74x_sf_ctrl_aes_set_mode(0);
            qcc74x_sf_ctrl_aes_set_key_be(parm->aes_region, parm->key, parm->type);
            qcc74x_sf_ctrl_aes_set_iv_be(parm->aes_region, p_iv, parm->addr);

        }

        qcc74x_sf_ctrl_aes_set_region(parm->aes_region, 1 , 
# 2784 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c" 3 4
                                                                                 ((void *)0) 
# 2784 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
                                                                                      == parm->key ,
                                    parm->addr, parm->addr + parm->len - 1, parm->lock );
...
# 2802 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
int32_t __attribute__((section(".tcm_code." "./drivers/lhal/src/flash/qcc74x_sf_ctrl.c" "2802"))) qcc74x_sf_ctrl_aes_set_decrypt_region_le(struct qcc74x_sf_ctrl_decrypt_type *parm)
{
    ...
    uint8_t temp_iv[16] = { 0 };
    uint8_t *p_iv = 
# 2808 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c" 3 4
                   ((void *)0)
# 2808 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
                       ;


    if ((
# 2811 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c" 3 4
        ((void *)0) 
# 2811 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
             == parm) || ((parm->addr + parm->len) > (64 * 1024 * 1024))) {
        return -1;
    }
    ...
    if (parm->len) {
        if (
# 2816 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c" 3 4
           ((void *)0) 
# 2816 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
                == parm->iv) {

            qcc74x_sf_ctrl_aes_get_iv_le(0, temp_iv);
            p_iv = temp_iv;
        } else {
            p_iv = parm->iv;
        }
        ...
        if (1 == parm->mode) {
            ...
            qcc74x_sf_ctrl_disable_wrap_access(0);
            qcc74x_sf_ctrl_aes_set_mode(1);
            qcc74x_sf_ctrl_aes_xts_set_key(parm->aes_region, parm->key, parm->type);
            qcc74x_sf_ctrl_aes_xts_set_iv(parm->aes_region, p_iv, parm->addr);
        } else {


            qcc74x_sf_ctrl_disable_wrap_access(1);
            qcc74x_sf_ctrl_aes_set_mode(0);
            qcc74x_sf_ctrl_aes_set_key(parm->aes_region, parm->key, parm->type);
            qcc74x_sf_ctrl_aes_set_iv(parm->aes_region, p_iv, parm->addr);

        }

        qcc74x_sf_ctrl_aes_set_region(parm->aes_region, 1 , 
# 2843 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c" 3 4
                                                                                 ((void *)0) 
# 2843 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/flash/qcc74x_sf_ctrl.c"
                                                                                      == parm->key ,
                                    parm->addr, parm->addr + parm->len - 1, parm->lock );
