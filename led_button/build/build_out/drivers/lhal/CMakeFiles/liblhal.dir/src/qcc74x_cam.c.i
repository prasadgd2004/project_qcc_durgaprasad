# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_cam.c"
# 1 "/home/durga/QCCSDK-QCC74x/examples/peripherals/gpio/gpio_input_output/build/build_out/drivers/lhal//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_cam.c"
# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_cam.h" 1
...
# 5 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_cam.h" 2
# 212 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_cam.h"
struct qcc74x_cam_config_s {
...
# 218 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_cam.h" 3 4
   _Bool 
# 218 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_cam.h"
        with_mjpeg;
...
# 240 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_cam.h"
void qcc74x_cam_init(struct qcc74x_device_s *dev, const struct qcc74x_cam_config_s *config);
...
void qcc74x_cam_start(struct qcc74x_device_s *dev);
...
void qcc74x_cam_stop(struct qcc74x_device_s *dev);
# 263 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_cam.h"
void qcc74x_cam_int_mask(struct qcc74x_device_s *dev, uint32_t int_type, 
# 263 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_cam.h" 3 4
                                                                        _Bool 
# 263 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_cam.h"
                                                                             mask);
...
void qcc74x_cam_int_clear(struct qcc74x_device_s *dev, uint32_t int_type);
# 280 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_cam.h"
void qcc74x_cam_crop_vsync(struct qcc74x_device_s *dev, uint16_t start_line, uint16_t end_line);
# 289 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_cam.h"
void qcc74x_cam_crop_hsync(struct qcc74x_device_s *dev, uint16_t start_pixel, uint16_t end_pixel);
...
# 313 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_cam.h"
uint32_t qcc74x_cam_get_frame_info(struct qcc74x_device_s *dev, uint8_t **pic);
...
uint32_t qcc74x_cam_get_intstatus(struct qcc74x_device_s *dev);
# 331 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_cam.h"
int qcc74x_cam_feature_control(struct qcc74x_device_s *dev, int cmd, size_t arg);
# 2 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_cam.c" 2
# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/hardware/cam_reg.h" 1
# 3 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_cam.c" 2

# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/hardware/cam_front_reg.h" 1
# 5 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_cam.c" 2
...
# 6 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_cam.c" 2
# 18 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_cam.c"
void qcc74x_cam_init(struct qcc74x_device_s *dev, const struct qcc74x_cam_config_s *config)
{
    ((void)0U);
    ((void)0U);
    ...
    uint32_t threshold;
# 59 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_cam.c"
    reg_base = dev->reg_base;
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x4)) = (config->output_bufaddr));
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x38)) = (config->resolution_y << 16 | config->resolution_x));

    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0xF0)) = (data_mode));
    ...
    (*(volatile uint32_t *)(uintptr_t)(0x20050000 + (0x8)) = (0));
# 99 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_cam.c"
        regval = qcc74x_clk_get_system_clock(2) / 1000000;
        if (regval == 0) {
            regval = 80;
        }
        ...
        regval = (*(volatile uint32_t *)(uintptr_t)(0x20050000 + (0x0)));
        regval &= ~(0x7ff<<(16U));
        regval |= threshold << (16U);
        (*(volatile uint32_t *)(uintptr_t)(0x20050000 + (0x0)) = (regval));
    ...
    regval &= ~((1<<12U) | (1<<13U) | (0x7<<(16U)) | (1<<19U) | (1<<22U) | (1<<23U));

    switch (config->input_format) {
        case 0:
# 181 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_cam.c"
        case 1:
            if (config->output_format == 0 || config->output_format == 1) {
                ...
                data_mode = 4;
                frame_size = resolution_x * resolution_y;
            } else if (config->output_format == 4) {



                regval |= (1<<19U) | (1<<22U) | (1<<23U);

                data_mode = 4;
                frame_size = resolution_x * resolution_y / 2;

                (*(volatile uint32_t *)(uintptr_t)(0x20050000 + (0x8)) = (1));
        ...
        case 2:
# 256 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_cam.c"
        case 3:
            if (config->output_format == 0 || config->output_format == 1) {
                data_mode = 0;
                frame_size = resolution_x * resolution_y * 2;
        ...
        case 4:
            if (config->output_format == 0 || config->output_format == 2) {
                data_mode = 0;
                frame_size = resolution_x * resolution_y;
            }
            break;
        ...
        case 6:
            if (config->output_format == 0 || config->output_format == 5) {
                data_mode = 0;
                frame_size = resolution_x * resolution_y * 2;
            }
            break;
        ...
        case 8:
            if (config->output_format == 0 || config->output_format == 6) {
                data_mode = 1;
                frame_size = resolution_x * resolution_y * 3;

            } else if (config->output_format == 7) {
                data_mode = 2;
                frame_size = resolution_x * resolution_y * 2;
                (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x20)) = (5 << (8U)));
            } else if (config->output_format == 8) {
                data_mode = 2;
                frame_size = resolution_x * resolution_y * 2;
                (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x20)) = (0));
            } else if (config->output_format == 9) {
    ...
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x10)) = (frame_size));

    regval |= data_mode << (16U);

    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x0)) = (regval));


    regval = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x0)));
    regval = (regval & (0x7<<(4U))) >> (4U);
    switch (regval) {
        case 0:
...
# 440 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_cam.c"
    regval = (*(volatile uint32_t *)(uintptr_t)(0x20050000 + (0x0)));
    regval |= (1<<0U);
    (*(volatile uint32_t *)(uintptr_t)(0x20050000 + (0x0)) = (regval));
...
void qcc74x_cam_int_mask(struct qcc74x_device_s *dev, uint32_t int_type, 
# 478 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_cam.c" 3 4
                                                                        _Bool 
# 478 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_cam.c"
                                                                             mask)
{
...
void qcc74x_cam_int_clear(struct qcc74x_device_s *dev, uint32_t int_type)
{
    ...
    (*(volatile uint32_t *)(uintptr_t)(dev->reg_base + (0x14)) = (int_type));
...
void qcc74x_cam_crop_vsync(struct qcc74x_device_s *dev, uint16_t start_line, uint16_t end_line)
{
    ...
    (*(volatile uint32_t *)(uintptr_t)(dev->reg_base + (0x34)) = (start_line << 16 | end_line));

}

void qcc74x_cam_crop_hsync(struct qcc74x_device_s *dev, uint16_t start_pixel, uint16_t end_pixel)
{
# 534 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_cam.c"
    (*(volatile uint32_t *)(uintptr_t)(dev->reg_base + (0x30)) = (start_pixel << 16 | end_pixel));
...
void qcc74x_cam_pop_one_frame(struct qcc74x_device_s *dev)
{
    ...
    (*(volatile uint32_t *)(uintptr_t)(dev->reg_base + (0x14)) = (1));
...
uint32_t qcc74x_cam_get_frame_info(struct qcc74x_device_s *dev, uint8_t **pic)
{
    ...
    reg_base = dev->reg_base;
    *pic = (uint8_t *)(uintptr_t)(*(volatile uint32_t *)(uintptr_t)(reg_base + (0x40)));
    ...
    return ((*(volatile uint32_t *)(uintptr_t)(reg_base + (0x10))));
...
uint32_t qcc74x_cam_get_intstatus(struct qcc74x_device_s *dev)
{
    ...
    return ((*(volatile uint32_t *)(uintptr_t)(dev->reg_base + (0xC))));
...
int qcc74x_cam_feature_control(struct qcc74x_device_s *dev, int cmd, size_t arg)
{
    ...
    switch (cmd) {
        ...
        case 4:
            ...
            regval &= ~(0xff<<(0U));
            regval |= arg & (0xff<<(0U));
            (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x20)) = (regval));
            break;


        case 5:

            *(uint16_t *)arg = (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x60))) & 0xffff;
            break;
        ...
        case 8:
            ...
            regval = (*(volatile uint32_t *)(uintptr_t)(0x20050000 + (0x14)));
            regval |= (1<<0U);
            (*(volatile uint32_t *)(uintptr_t)(0x20050000 + (0x14)) = (regval));
            break;
        ...
        case 11:
# 739 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_cam.c"
            regval = (*(volatile uint32_t *)(uintptr_t)(0x20050000 + (0x0)));
            if (arg) {
                regval |= (1<<3U);
            } else {
        ...
        case 12: {
            ...
            (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x1C)) = (config->frame_count));
            (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x18)) = (config->frame_valid));
        } break;
# 765 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_cam.c"
        default:
            ret = -
# 766 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_cam.c" 3
                  1
# 766 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_cam.c"
                       ;
            break;
    }
    return ret;
