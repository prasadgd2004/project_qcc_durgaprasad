# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_sdio2.c"
# 1 "/home/durga/QCCSDK-QCC74x/examples/peripherals/gpio/gpio_input_output/build/build_out/drivers/lhal//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_sdio2.c"
# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_sdio2.h" 1
...
# 5 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_sdio2.h" 2
# 95 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_sdio2.h"
typedef struct
{
    uint16_t buff_len;
    uint16_t data_len;
...
# 2 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_sdio2.c" 2
# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/hardware/sdio2_reg.h" 1
# 3 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_sdio2.c" 2
# 12 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_sdio2.c"
static void qcc74x_sdio2_reset_isr(int irq, void *arg);


static void qcc74x_sdio2_isr(int irq, void *arg);

struct qcc74x_sdio2_queue_ctrl_s {
    uint32_t sdio_dnld_port_head;
    uint32_t sdio_dnld_port_tail;
    qcc74x_sdio2_trans_desc_t sdio_dnld_port_table[16];

    uint32_t sdio_upld_port_head;
    uint32_t sdio_upld_port_tail;
    qcc74x_sdio2_trans_desc_t sdio_upld_port_table[16];
};


static void *sdio2_irq_arg = 
# 28 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_sdio2.c" 3 4
                            ((void *)0)
# 28 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_sdio2.c"
                                ;
static qcc74x_sdio2_irq_cb_t sdio2_irq_event_cb = 
# 29 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_sdio2.c" 3 4
                                                 ((void *)0)
# 29 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_sdio2.c"
                                                     ;


static volatile struct qcc74x_sdio2_queue_ctrl_s sdio2_ctrl = { 0 };
...
int qcc74x_sdio2_init(struct qcc74x_device_s *dev, uint32_t dnld_size_max)
{
    ...
    if (dnld_size_max) {
        if (dnld_size_max > 0xff * (64)) {

            return -1;
        } else {
            dnld_max = dnld_size_max - (dnld_size_max % (64));
        }
    } else {
        dnld_max = (2 * 1024);
    }
    ...
    (*(volatile uint16_t *)(uintptr_t)(reg_base + (0x0104)) = (0));
    (*(volatile uint16_t *)(uintptr_t)(reg_base + (0x0106)) = (0));


    regval = (*(volatile uint8_t *)(uintptr_t)(reg_base + (0x016C)));
    regval |= (0x01 << 4);
    (*(volatile uint8_t *)(uintptr_t)(reg_base + (0x016C)) = (regval));


    (*(volatile uint8_t *)(uintptr_t)(reg_base + (0x0134)) = ((1 << 0) | (1 << 1) | (1 << 2)));


    regval = (*(volatile uint8_t *)(uintptr_t)(reg_base + (0x0162)));
    regval |= (1 << 5);
    ...
    (*(volatile uint8_t *)(uintptr_t)(reg_base + (0x0162)) = (regval));


    (*(volatile uint8_t *)(uintptr_t)(reg_base + (0x0161)) = ((dnld_max / (64))));

    qcc74x_irq_attach(dev->irq_num, qcc74x_sdio2_isr, dev);
    qcc74x_irq_enable(dev->irq_num);


    qcc74x_irq_attach((19), qcc74x_sdio2_reset_isr, dev);
    qcc74x_irq_enable((19));
...
int qcc74x_sdio2_trig_host_int(struct qcc74x_device_s *dev, uint32_t event)
{
    ...
    (*(volatile uint8_t *)(uintptr_t)(reg_base + (0x0130)) = (event));
...
int qcc74x_sdio2_dnld_port_push(struct qcc74x_device_s *dev, qcc74x_sdio2_trans_desc_t *trans_desc)
{
    ...
    if (trans_desc->buff_len < qcc74x_sdio2_feature_control(dev, (4), 0)) {

        return -2;
    }


    if (sdio2_ctrl.sdio_dnld_port_tail - sdio2_ctrl.sdio_dnld_port_head >= 16) {

        return -1;
    }
    port_tail = sdio2_ctrl.sdio_dnld_port_tail & (16 - 1);
    ...
    (*(volatile uint8_t *)(uintptr_t)(reg_base + (0x0149)) = (port_tail));
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x0144)) = ((uint32_t)(uintptr_t)(trans_desc->buff)));


    (*(volatile uint16_t *)(uintptr_t)(reg_base + (0x0106)) = (1 << port_tail));


    sdio2_ctrl.sdio_dnld_port_tail += 1;


    qcc74x_sdio2_trig_host_int(dev, (1 << 0));
...
int qcc74x_sdio2_upld_port_push(struct qcc74x_device_s *dev, qcc74x_sdio2_trans_desc_t *trans_desc)
{
    ...
    if (trans_desc->data_len > (512)) {

        uint16_t block_size = (uint16_t)qcc74x_sdio2_feature_control(dev, (3), 0);
    ...
    if (sdio2_ctrl.sdio_upld_port_tail - sdio2_ctrl.sdio_upld_port_head >= 16) {

        return -2;
    }
    port_tail = sdio2_ctrl.sdio_upld_port_tail & (16 - 1);

    sdio2_ctrl.sdio_upld_port_table[port_tail] = *trans_desc;


    uint16_t blk_size, upld_elem;
    blk_size = (uint16_t)qcc74x_sdio2_feature_control(dev, (3), 0);
    if (!blk_size || trans_desc->data_len % blk_size) {

        if (trans_desc->data_len < 64) {
            upld_elem = (trans_desc->data_len << 2) | 0x00;
        } else {
            upld_elem = (trans_desc->data_len << 2) | 0x01;
        }
    } else {

        if (trans_desc->data_len / blk_size < 64) {
            upld_elem = ((trans_desc->data_len / blk_size) << 2) | 0x02;
        } else {
            upld_elem = ((trans_desc->data_len / blk_size) << 2) | 0x03;
        }
    }
    ...
    (*(volatile uint16_t *)(uintptr_t)(reg_base + ((0x0108) + port_tail * 2)) = (upld_elem));


    (*(volatile uint8_t *)(uintptr_t)(reg_base + (0x0148)) = (port_tail));
    (*(volatile uint32_t *)(uintptr_t)(reg_base + (0x0140)) = ((uint32_t)(uintptr_t)(trans_desc->buff)));


    (*(volatile uint16_t *)(uintptr_t)(reg_base + (0x0104)) = (1 << port_tail));


    sdio2_ctrl.sdio_upld_port_tail += 1;


    qcc74x_sdio2_trig_host_int(dev, (1 << 1));
...
{
    int ret = 0;
    arch_memset(trans_desc, 0, sizeof(qcc74x_sdio2_trans_desc_t));


    uintptr_t flag = qcc74x_irq_save();
    if (sdio2_ctrl.sdio_dnld_port_tail - sdio2_ctrl.sdio_dnld_port_head > 0) {
        *trans_desc = sdio2_ctrl.sdio_dnld_port_table[sdio2_ctrl.sdio_dnld_port_head & (16 - 1)];
...
int qcc74x_sdio2_upld_port_pop(struct qcc74x_device_s *dev, qcc74x_sdio2_trans_desc_t *trans_desc)
{
    ...
    if (sdio2_ctrl.sdio_upld_port_tail - sdio2_ctrl.sdio_upld_port_head > 0) {
        *trans_desc = sdio2_ctrl.sdio_upld_port_table[sdio2_ctrl.sdio_upld_port_head & (16 - 1)];
...
int qcc74x_sdio2_feature_control(struct qcc74x_device_s *dev, int cmd, uintptr_t arg)
{
    ...
    switch (cmd) {
        case (1):
            ...
            regval = (*(volatile uint8_t *)(uintptr_t)(dev->reg_base + (0x0007)));
            if (regval & 0x02) {
                ret = 4;
            } else {
                ret = 1;
        ...
        case (2):
            ...
            regval = (*(volatile uint8_t *)(uintptr_t)(dev->reg_base + (0x0160)));
            if (regval) {
                ret = 1;
            } else {
                ret = 0;
        ...
        case (3):
            ...
            regval = (*(volatile uint8_t *)(uintptr_t)(reg_base + (0x0028)));
            regval |= (((*(volatile uint8_t *)(uintptr_t)(reg_base + (0x0029))) & 0x01) << 8);
            if (regval) {
                ret = regval;
            } else {
                ret = 512;
        ...
        case (4):
            ...
            regval = (*(volatile uint8_t *)(uintptr_t)(dev->reg_base + (0x0161)));
            if (regval) {
                ret = regval * (64);
            } else {
                ret = -1;
        ...
        case (7):
            ret = 16 - (sdio2_ctrl.sdio_dnld_port_tail - sdio2_ctrl.sdio_dnld_port_head);
            break;
        ...
        case (9):
            ret = 16 - (sdio2_ctrl.sdio_upld_port_tail - sdio2_ctrl.sdio_upld_port_head);
            break;
...
static void qcc74x_sdio2_isr(int irq, void *arg)
{
    ...
    regval = (*(volatile uint8_t *)(uintptr_t)(reg_base + (0x0138)));
    crcerror = (*(volatile uint8_t *)(uintptr_t)(reg_base + (0x0128)));

    if ((regval & (1 << 1))) {
        ;


        (*(volatile uint8_t *)(uintptr_t)(reg_base + (0x0138)) = (~(1 << 1)));


        uint16_t upld_bitmap = (*(volatile uint16_t *)(uintptr_t)(reg_base + (0x0104)));
        ...
        for (uint8_t i = 0; i < 16; i++) {
            if (sdio2_ctrl.sdio_upld_port_head == sdio2_ctrl.sdio_upld_port_tail) {
                ...
                break;
            } else if (upld_bitmap & (1 << ((uint32_t)sdio2_ctrl.sdio_upld_port_head & (16 - 1)))) {

                break;
            } else {

                qcc74x_sdio2_trans_desc_t upld_trans_desc = sdio2_ctrl.sdio_upld_port_table[sdio2_ctrl.sdio_upld_port_head & (16 - 1)];

                sdio2_ctrl.sdio_upld_port_head += 1;


                if (sdio2_irq_event_cb != 
# 401 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_sdio2.c" 3 4
                                         ((void *)0)
# 401 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_sdio2.c"
                                             ) {
                    sdio2_irq_event_cb(sdio2_irq_arg, (3), &upld_trans_desc);
    ...
    if ((regval & (1 << 0)) &&
        ...
        (*(volatile uint8_t *)(uintptr_t)(reg_base + (0x0138)) = (~(1 << 0)));


        uint16_t dnld_bitmap = (*(volatile uint16_t *)(uintptr_t)(reg_base + (0x0106)));
        ...
        for (uint8_t i = 0; i < 16; i++) {
            if (sdio2_ctrl.sdio_dnld_port_head == sdio2_ctrl.sdio_dnld_port_tail) {
                ...
                break;
            } else if (dnld_bitmap & (1 << ((uint32_t)sdio2_ctrl.sdio_dnld_port_head & (16 - 1)))) {

                break;
            } else {

                qcc74x_sdio2_trans_desc_t trans_desc = sdio2_ctrl.sdio_dnld_port_table[sdio2_ctrl.sdio_dnld_port_head & (16 - 1)];
                trans_desc.data_len = (*(volatile uint8_t *)(uintptr_t)(dev->reg_base + (0x0161))) * (64);

                sdio2_ctrl.sdio_dnld_port_head += 1;


                if (sdio2_irq_event_cb != 
# 436 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_sdio2.c" 3 4
                                         ((void *)0)
# 436 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_sdio2.c"
                                             ) {
                    sdio2_irq_event_cb(sdio2_irq_arg, (2), &trans_desc);
                }
            }
        }
    }
    ...
    if (crcerror & (1 << 2)) {
        ...
        if (sdio2_irq_event_cb != 
# 446 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_sdio2.c" 3 4
                                 ((void *)0)
# 446 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_sdio2.c"
                                     ) {
            sdio2_irq_event_cb(sdio2_irq_arg, (4), 
# 447 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_sdio2.c" 3 4
                                                                      ((void *)0)
# 447 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_sdio2.c"
                                                                          );
        }
    }
    ...
    if ((regval & (1 << 2))) {
        ...
        (*(volatile uint8_t *)(uintptr_t)(reg_base + (0x0138)) = (~(1 << 2)));

        if (sdio2_irq_event_cb != 
# 456 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_sdio2.c" 3 4
                                 ((void *)0)
# 456 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_sdio2.c"
                                     ) {
            sdio2_irq_event_cb(sdio2_irq_arg, (5), 
# 457 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_sdio2.c" 3 4
                                                                        ((void *)0)
# 457 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_sdio2.c"
                                                                            );
        }
    }
}
...
static void qcc74x_sdio2_reset_isr(int irq, void *arg)
{
    qcc74x_irq_clear_pending((19));

    if (sdio2_irq_event_cb != 
# 468 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_sdio2.c" 3 4
                             ((void *)0)
# 468 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_sdio2.c"
                                 ) {
        sdio2_irq_event_cb(sdio2_irq_arg, (1), 
# 469 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_sdio2.c" 3 4
                                                                     ((void *)0)
# 469 "/home/durga/QCCSDK-QCC74x/drivers/lhal/src/qcc74x_sdio2.c"
                                                                         );
    }
}
