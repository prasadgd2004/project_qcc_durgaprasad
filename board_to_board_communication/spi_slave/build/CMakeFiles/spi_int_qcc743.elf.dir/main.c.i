# 1 "/home/durga/QCCSDK-QCC74x/examples/peripherals/spi/spi_master/main.c"
...
# 2 "/home/durga/QCCSDK-QCC74x/examples/peripherals/spi/spi_master/main.c" 2
...
# 3 "/home/durga/QCCSDK-QCC74x/examples/peripherals/spi/spi_master/main.c" 2
...
# 4 "/home/durga/QCCSDK-QCC74x/examples/peripherals/spi/spi_master/main.c" 2
...
# 5 "/home/durga/QCCSDK-QCC74x/examples/peripherals/spi/spi_master/main.c" 2
# 1 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_spi.h" 1
# 181 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_spi.h"
...
# 202 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_spi.h"
...
void qcc74x_spi_link_txdma(struct qcc74x_device_s *dev, 
# 217 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_spi.h" 3 4
                                                       _Bool 
# 217 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_spi.h"
                                                            enable);
...
void qcc74x_spi_link_rxdma(struct qcc74x_device_s *dev, 
# 225 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_spi.h" 3 4
                                                       _Bool 
# 225 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_spi.h"
                                                            enable);
# 234 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_spi.h"
uint32_t qcc74x_spi_poll_send(struct qcc74x_device_s *dev, uint32_t data);
# 245 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_spi.h"
...
# 253 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_spi.h" 3 4
_Bool 
# 253 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_spi.h"
    qcc74x_spi_isbusy(struct qcc74x_device_s *dev);
...
void qcc74x_spi_txint_mask(struct qcc74x_device_s *dev, 
# 261 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_spi.h" 3 4
                                                       _Bool 
# 261 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_spi.h"
                                                            mask);
...
void qcc74x_spi_rxint_mask(struct qcc74x_device_s *dev, 
# 269 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_spi.h" 3 4
                                                       _Bool 
# 269 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_spi.h"
                                                            mask);
...
void qcc74x_spi_tcint_mask(struct qcc74x_device_s *dev, 
# 277 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_spi.h" 3 4
                                                       _Bool 
# 277 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_spi.h"
                                                            mask);
...
void qcc74x_spi_errint_mask(struct qcc74x_device_s *dev, 
# 285 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_spi.h" 3 4
                                                        _Bool 
# 285 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_spi.h"
                                                             mask);
...
# 311 "/home/durga/QCCSDK-QCC74x/drivers/lhal/include/qcc74x_spi.h"
int qcc74x_spi_feature_control(struct qcc74x_device_s *dev, int cmd, size_t arg);
# 6 "/home/durga/QCCSDK-QCC74x/examples/peripherals/spi/spi_master/main.c" 2
...
# 7 "/home/durga/QCCSDK-QCC74x/examples/peripherals/spi/spi_master/main.c" 2
# 23 "/home/durga/QCCSDK-QCC74x/examples/peripherals/spi/spi_master/main.c"
...
void system_init(void) {
    ...
    qcc74x_gpio_init(gpio, 13, (1 << (0)) | (1 << 8) | (1 << (9)) | (1 << (11)) | (1 << (12)));
    qcc74x_gpio_init(gpio, 14, (1 << (0)) | (1 << 8) | (1 << (9)) | (1 << (11)) | (1 << (12)));
    qcc74x_gpio_init(gpio, 15, (1 << (0)) | (1 << 8) | (1 << (9)) | (1 << (11)) | (1 << (12)));
    qcc74x_gpio_init(gpio, 12, (1 << 6) | (1 << (9)) | (1 << (11)) | (1 << (12)));
    qcc74x_gpio_set(gpio, 12);


    qcc74x_gpio_init(gpio, 10, (5 << (0)) | (1 << 8) | (1 << (9)) | (1 << (11)) | (1 << (12)));
    qcc74x_gpio_init(gpio, 11, (5 << (0)) | (1 << 8) | (1 << (9)) | (1 << (11)) | (1 << (12)));


    qcc74x_gpio_init(gpio, 3, (1 << 6) | (1 << (9)) | (1 << (11)) | (1 << (12)));
    qcc74x_gpio_set(gpio, 3);


    qcc74x_gpio_init(gpio, 2, (1 << 7) | (1 << (11)) | (0 << (12)));
}

void spi_init(void) {
    struct qcc74x_spi_config_s spi_cfg = {
        .freq = 500000, .role = 0, .mode = 3,
        .data_width = 1, .bit_order = 0, .byte_order = 0,
...
void adc_init_mq135(void) {
    ...
    struct qcc74x_adc_config_s cfg = {
        .clk_div = 7, .scan_conv_mode = 
# 69 "/home/durga/QCCSDK-QCC74x/examples/peripherals/spi/spi_master/main.c" 3 4
                                                    0
# 69 "/home/durga/QCCSDK-QCC74x/examples/peripherals/spi/spi_master/main.c"
...
# 69 "/home/durga/QCCSDK-QCC74x/examples/peripherals/spi/spi_master/main.c"
                                                                                        ,
        .differential_mode = 
# 70 "/home/durga/QCCSDK-QCC74x/examples/peripherals/spi/spi_master/main.c" 3 4
                            0
# 70 "/home/durga/QCCSDK-QCC74x/examples/peripherals/spi/spi_master/main.c"
                                 , .resolution = 4, .vref = 0
    };
    struct qcc74x_adc_channel_s chan = { .pos_chan = 2, .neg_chan = 23 };
...
void ds1307_force_start(void) {
    uint8_t data[4];
    data[0] = 0x00;
    data[1] = dec_to_bcd(0) & 0x7F;
    data[2] = dec_to_bcd(30);
    data[3] = dec_to_bcd(15);
...
int dht11_read(uint8_t *temp, uint8_t *hum) {
    ...
    timeout = 500; while (qcc74x_gpio_read(gpio, 3) && timeout--) delay_us(1);
    if (!timeout) return -1;
    timeout = 500; while (!qcc74x_gpio_read(gpio, 3) && timeout--) delay_us(1);
    if (!timeout) return -1;
    timeout = 500; while (qcc74x_gpio_read(gpio, 3) && timeout--) delay_us(1);
    ...
    for (int i = 0; i < 40; i++) {
        timeout = 500; while (!qcc74x_gpio_read(gpio, 3) && timeout--) delay_us(1);
        delay_us(50);
        if (qcc74x_gpio_read(gpio, 3)) data[i / 8] |= (1 << (7 - (i % 8)));
        timeout = 500; while (qcc74x_gpio_read(gpio, 3) && timeout--) delay_us(1);
    }
...
int main(void) {
    ...
    while (1) {
        ...
        msg[0].addr = 0x68; msg[0].flags = 0x0040; msg[0].buffer = &reg; msg[0].length = 1;
        msg[1].addr = 0x68; msg[1].flags = 0x0001; msg[1].buffer = i2c_buf; msg[1].length = 3;
